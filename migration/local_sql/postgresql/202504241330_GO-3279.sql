...
VALUES
	((
		 ...
		 FROM
			 AD_Menu
	 ), 0, 0, 'Y', '2025-04-24 13:35:38.720000', 100, '2025-04-24 13:43:33.928000', 'Financial', 100,
	 'Understand the clinic''s financial position, revenue streams, and liabilities', 'Y', 'Y', 'N', NULL, NULL, NULL,
	 NULL, NULL, NULL, NULL, 'U', 'N', '669051b6-195c-420d-9b35-b62b4fc44c32', NULL, NULL, NULL);
...
SELECT
	...
	0,
	'Y',
	'2025-04-24 12:33:14.317798',
	100,
	'2025-04-24 12:33:14.317798',
	100,
	p.ad_menu_id,
	0,
	'7c9e58a5-978e-4cf1-b36a-b6b5d4d2aad1'
FROM
	ad_menu m
		JOIN ad_menu p
		ON p.ad_menu_uu = '35ce7d6a-cf7d-4962-a748-75e27d0121bf'
WHERE
	m.ad_menu_uu = '669051b6-195c-420d-9b35-b62b4fc44c32';
...
SET
	...
	parent_id = (
		...
		FROM
			ad_menu
		WHERE
			ad_menu_uu = '669051b6-195c-420d-9b35-b62b4fc44c32'
	)
WHERE
	node_id = (
		SELECT
...
VALUES
	((
		 ...
		 FROM
			 AD_Menu
	 ), 0, 0, 'Y', '2025-04-24 13:36:26.786000', 100, '2025-04-24 13:42:42.785000', 'Clinical', 100,
	 'Monitor patient trends, clinical workload, and service delivery', 'Y', 'Y', 'N', NULL, NULL, NULL, NULL, NULL, NULL,
	 NULL, 'U', 'N', 'bcf31f7a-9532-42d2-9bd6-35ebc79f973e', NULL, NULL, NULL);
...
SELECT
	...
	p.ad_menu_id,
	1,
	'c0d75dce-cbed-43aa-8fb4-2f85e8537c7d'
FROM
	ad_menu m
		JOIN ad_menu p
		ON p.ad_menu_uu = '35ce7d6a-cf7d-4962-a748-75e27d0121bf'
WHERE
	m.ad_menu_uu = 'bcf31f7a-9532-42d2-9bd6-35ebc79f973e';
...
SET
	...
	parent_id = (
		...
		FROM
			ad_menu
		WHERE
			ad_menu_uu = 'bcf31f7a-9532-42d2-9bd6-35ebc79f973e'
	)
WHERE
	node_id = (
		SELECT
				...
				WHERE
					...
					AND ad_process_id = (
						...
						FROM
							ad_process
						WHERE
							ad_process_uu = '83378587-d80f-4c79-874b-5cdc64893b77'
					)
			)
	);
...
VALUES
	((
		 ...
		 FROM
			 AD_Menu
	 ), 0, 0, 'Y', '2025-04-24 13:36:47.035000', 100, '2025-04-24 13:39:06.306000', 'Inventory', 100,
	 'View what''s going on with your stocks', 'Y', 'Y', 'N', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'U', 'N',
	 '90d2983e-64b0-4b5f-86ee-4512c45bf893', NULL, NULL, NULL);
...
SELECT
	...
	p.ad_menu_id,
	2,
	'3ff26c75-1ac2-4a15-bdc0-5e25a4a34f1c'
FROM
	ad_menu m
		JOIN ad_menu p
		ON p.ad_menu_uu = '35ce7d6a-cf7d-4962-a748-75e27d0121bf'
WHERE
	m.ad_menu_uu = '90d2983e-64b0-4b5f-86ee-4512c45bf893';
...
WHERE
	ad_menu_id IN (
		...
		FROM
			ad_menu
		WHERE
			ad_menu_uu IN ('d7aba725-d107-4e52-b918-0e0bc4c20c27', '8c73cc35-045a-4d35-9574-224004c9683b')
	);
DELETE
FROM
	ad_menu
...
-- Remove a space at the end of this report name
UPDATE ad_menu
SET
