...
ALTER TABLE BH_Client_Concept_Extra
	ADD CONSTRAINT ADClient_BHClientConceptExtra FOREIGN KEY (AD_Client_ID) REFERENCES ad_client (ad_client_id) DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE BH_Client_Concept_Extra
	ADD CONSTRAINT ADOrg_BHClientConceptExtra FOREIGN KEY (AD_Org_ID) REFERENCES ad_org (ad_org_id) DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE BH_Client_Concept_Extra
	ADD CONSTRAINT BHConceptExtra_BHClientConcept FOREIGN KEY (BH_Concept_Extra_ID) REFERENCES bh_concept_extra (bh_concept_extra_id) DEFERRABLE INITIALLY DEFERRED;
...
-- Now add the iDempiere stuff for elements, table, and columns
INSERT INTO
...
VALUES
	((
		 ...
		 FROM
			 ad_element
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.867000', 100, '2025-04-09 09:33:13.867000', 100, 'BH_Client_Concept_Extra_ID',
	 'U', 'Client Concept Extra', 'Client Concept Extra', NULL, NULL, NULL, NULL, NULL, NULL,
	 '09f021d5-fb0a-4d5f-96ef-8b6113d45c43', NULL);
INSERT INTO
	ad_element (ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, columnname,
	            entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help,
	            ad_element_uu, placeholder)
VALUES
	((
		 ...
		 FROM
			 ad_element
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.927000', 100, '2025-04-09 09:33:13.927000', 100, 'BH_Client_Concept_Extra_UU',
	 'U', 'BH_Client_Concept_Extra_UU', 'BH_Client_Concept_Extra_UU', NULL, NULL, NULL, NULL, NULL, NULL,
	 '0394c1ba-8694-4ef4-82fc-65c1da533763', NULL);
...
VALUES
	((
		 ...
		 FROM
			 ad_table
	 ), 0, 0, 'Y', '2025-04-09 09:33:04.138000', 100, '2025-04-09 10:15:06.579000', 100, 'Client Concept Extra', NULL,
	 NULL, 'BH_Client_Concept_Extra', 'N', '3', 'U', NULL, NULL, 0, 'N', 'Y', 'N', 'N', 'Y', 'L', NULL, 'N', 'Y',
	 'e0672b9e-8490-4234-9648-ca62d370491e', 'N', 'N', 'N', 'N', 'N', 'N', 'N');
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.735000', '2025-04-09 09:34:26.237000', 100, 100, 'Tenant',
	 'Tenant for this installation.', 'A Tenant is a company or a legal entity. You cannot share data between Tenants.',
	 1, 'U', 'AD_Client_ID', (
		 SELECT ad_table_id FROM ad_table WHERE ad_table_uu = 'e0672b9e-8490-4234-9648-ca62d370491e'
	 ), 19, NULL, 129, 22, '@#AD_Client_ID@', 'N', 'N', 'Y', 'N', NULL, 'N', NULL, 'N', 'N', NULL, NULL, NULL, NULL, 'N',
	 102, NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, '130e01f3-cf10-4fa6-a808-420ac96d164b', 'N', NULL, 'N', 'N',
	 NULL, 'ADClient_BHClientConceptExtra', 'N', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
INSERT INTO
	ad_column (ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description,
	           help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id,
	           fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.807000', '2025-04-09 09:34:26.252000', 100, 100, 'Organization',
	 'Organizational entity within tenant',
	 'An organization is a unit of your tenant or legal entity - examples are store, department. You can share data between organizations.',
	 1, 'U', 'AD_Org_ID', (
		 SELECT ad_table_id FROM ad_table WHERE ad_table_uu = 'e0672b9e-8490-4234-9648-ca62d370491e'
	 ), 19, NULL, 104, 22, '@#AD_Org_ID@', 'N', 'N', 'Y', 'N', NULL, 'N', NULL, 'N', 'N', NULL, NULL, NULL, NULL, 'N',
	 113, NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, 'd65defe9-978c-4685-b5bd-30fde18efcc8', 'N', NULL, 'N', 'N',
	 NULL, 'ADOrg_BHClientConceptExtra', 'N', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
INSERT INTO
	ad_column (ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description,
	           help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id,
	           fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.844000', '2025-04-09 09:33:13.844000', 100, 100, 'Client Concept Extra', NULL,
	 NULL, 1, 'U', 'BH_Client_Concept_Extra_ID', (
		 SELECT ad_table_id FROM ad_table WHERE ad_table_uu = 'e0672b9e-8490-4234-9648-ca62d370491e'
	 ), 13, NULL, NULL, 22, NULL, 'Y', 'N', 'Y', 'N', NULL, 'N', NULL, 'N', 'N', NULL, NULL, NULL, NULL, 'N', (
		 SELECT ad_element_id FROM ad_element WHERE ad_element_uu = '09f021d5-fb0a-4d5f-96ef-8b6113d45c43'
	 ), NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, '85f81c90-dfbb-4d4d-adf4-393d9ed17099', 'N', NULL, 'N', 'N',
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.905000', '2025-04-09 09:33:13.905000', 100, 100, 'BH_Client_Concept_Extra_UU',
	 NULL, NULL, 1, 'U', 'BH_Client_Concept_Extra_UU', (
		 SELECT ad_table_id FROM ad_table WHERE ad_table_uu = 'e0672b9e-8490-4234-9648-ca62d370491e'
	 ), 200231, NULL, NULL, 36, NULL, 'N', 'N', 'N', 'Y', NULL, 'N', NULL, 'N', 'N', NULL, NULL, NULL, NULL, 'N', (
		 SELECT ad_element_id FROM ad_element WHERE ad_element_uu = '0394c1ba-8694-4ef4-82fc-65c1da533763'
	 ), NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, 'b8782106-abbb-4fe2-b158-0eeb0675a38b', 'N', NULL, 'N', 'N',
	 NULL, NULL, 'N', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
INSERT INTO
	ad_column (ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description,
	           help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.950000', '2025-04-09 09:33:13.950000', 100, 100, 'Created',
	 ...
	 NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, 'e0ee4b37-378e-4e95-9282-8b20efe44114', 'N', NULL, 'N', 'N', NULL,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:13.985000', '2025-04-09 09:33:13.985000', 100, 100, 'Created By',
	 ...
	 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, '21edf411-fb6c-4459-84e1-2051e84f0f67', 'N', NULL, 'N', 'N', NULL, NULL,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:14.015000', '2025-04-09 09:33:14.015000', 100, 100, 'Description',
	 ...
	 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, 'eb403bb8-c392-4991-8116-0a42758de1be', 'Y', 10, 'N', 'N', NULL, NULL,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:14.046000', '2025-04-09 09:33:14.046000', 100, 100, 'Active',
...
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',
	 ...
	 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, 'd59e9d3c-667d-4f21-b591-bf6619171c29', 'N', NULL, 'N', 'N', NULL, NULL,
	 'N', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
INSERT INTO
	ad_column (ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description,
	           help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:14.110000', '2025-04-09 09:33:14.110000', 100, 100, 'Updated',
	 ...
	 NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, '2b2f5246-7fbe-4a61-b62a-3aacbb357bcc', 'N', NULL, 'N', 'N', NULL,
	 NULL, 'N', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
INSERT INTO
	ad_column (ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description,
	           help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:14.140000', '2025-04-09 09:33:14.140000', 100, 100, 'Updated By',
	 ...
	 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, 'a3f739cc-d8d9-4c67-905a-3e0a0a4dd905', 'N', NULL, 'N', 'N', NULL, NULL,
	 'D', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
INSERT INTO
	ad_column (ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description,
	           help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:33:53.779000', '2025-04-09 09:34:26.266000', 100, 100, 'Concept Extra', NULL, NULL, 0,
	 'U', 'BH_Concept_Extra_ID', (
		 SELECT ad_table_id FROM ad_table WHERE ad_table_uu = 'e0672b9e-8490-4234-9648-ca62d370491e'
	 ), 19, NULL, NULL, 100, NULL, 'N', 'N', 'Y', 'N', NULL, 'N', 0, 'N', 'N', NULL, NULL, NULL, NULL, 'N', (
		 SELECT ad_element_id FROM ad_element WHERE ad_element_uu = 'b86d7ed3-db6c-412d-8868-7e8b29fcdbd2'
	 ), NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, '6cc15487-3e23-4644-adf6-6cc9edde076d', 'Y', 0, 'N', 'N', NULL,
...
VALUES
	((
		 ...
		 FROM
			 ad_column
	 ), 0, 0, 'Y', '2025-04-09 09:34:10.483000', '2025-04-09 09:34:10.483000', 100, 100, 'BH_Value', 'BH_Value', NULL, 0,
	 'U', 'BH_Value', (
		 SELECT ad_table_id FROM ad_table WHERE ad_table_uu = 'e0672b9e-8490-4234-9648-ca62d370491e'
	 ...
	 ), NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, '49e12a30-acb3-4266-a5df-ea116dea4395', 'Y', 0, 'N', 'N', NULL,
	 NULL, 'N', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
...
VALUES
	((
		 ...
		 FROM ad_sequence
	 ), 0, 0, 'Y', '2025-04-09 09:33:04.200000', 100, '2025-04-09 09:33:04.200000', 100, 'BH_Client_Concept_Extra',
	 'Table BH_Client_Concept_Extra', NULL, 'Y', 1, 1000000, 1000000, 200000, 'N', 'Y', NULL, NULL, 'N', NULL, NULL,
	 '8b8ca705-9d31-44f6-a34c-bbcdbef09aa0', 'N', 'N', NULL);

-- Register the script
SELECT
	register_migration_script('202504090936_GO-3261.sql')
FROM
	dual;
