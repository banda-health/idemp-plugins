...
WHERE
		...
		WHERE
				columnname IN (
				               'BH_MPesaPhnTrx_Num', 'bh_nhif_claim_number', 'bh_nhif_member_id', 'bh_nhif_member_name',
				               'bh_nhif_relationship', 'bh_nhif_valid', 'bh_nhif_linda_mama', 'BH_NHIF_Type', 'BH_Processing',
				               'BH_IsServiceDebt', 'bh_invoicetype', 'bh_processing', 'bh_isexpense', 'bh_docaction',
				               'bh_docaction_2')
			AND ad_table_id IN (
				SELECT
					ad_table_id
...
WHERE
		columnname IN (
		               'BH_MPesaPhnTrx_Num', 'bh_nhif_claim_number', 'bh_nhif_member_id', 'bh_nhif_member_name',
		               'bh_nhif_relationship', 'bh_nhif_valid', 'bh_nhif_linda_mama', 'BH_NHIF_Type', 'BH_Processing',
		               'BH_IsServiceDebt', 'bh_invoicetype', 'bh_processing', 'bh_isexpense', 'bh_docaction_2');
...
(
	...
	BH_ChargeInfoDataType  VARCHAR(2)   DEFAULT 'T'                                          NOT NULL,
...
VALUES
	((
	 ...
	 NULL, 0, 'U', 'BH_ChargeInfoDataType', (
		 SELECT ad_table_id FROM ad_table WHERE ad_table_uu = '9d22b46b-7f36-4a71-a316-2746cae40cb3'
	 ), 17, (
...
INSERT INTO
	tmp_c_bp_group (ad_client_id, m_pricelist_id)
SELECT
	tctww.ad_client_id,
	pl.m_pricelist_id
FROM
...
INSERT INTO
	c_bp_group (c_bp_group_id, ad_client_id, ad_org_id, createdby, updatedby, value, name, description, ad_printcolor_id,
	            prioritybase, m_pricelist_id, creditwatchpercent, pricematchtolerance, c_bp_group_uu)
SELECT
	c_bp_group_id,
	ad_client_id,
	ad_org_id,
...
TRUNCATE tmp_c_validcombination;
INSERT INTO
	tmp_c_bp_group (ad_client_id, value, name, description, m_pricelist_id, bh_subtype)
SELECT
	tctww.ad_client_id,
...
INSERT INTO
	c_bpartner (c_bpartner_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, value, name,
	            ...
	            shelflifeminpct, flatdiscount, totalopenbalance, c_bpartner_uu, bh_needadditionalvisitinfo)
SELECT
	c_bpartner_id,
	ad_client_id,
	ad_org_id,
...
-- Add locations for each of these BPs (they're apparently all in Kenya for all clients...)
INSERT INTO
...
INSERT INTO
	BH_Payer_Info_Field_Suggestion (AD_Client_ID, AD_Org_ID, BH_ChargeInfoDataType, BH_FillFromPatient,
...
-- Remove default charges everywhere
...
SELECT
	register_migration_script('202307181357_GO-1335.sql')
FROM
	dual;
