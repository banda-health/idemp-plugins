...
-- Add BPartner_Tags to BPartner window
INSERT INTO ad_tab (ad_tab_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby,
                              name, description, help, ad_table_id, ad_window_id, seqno, tablevel, issinglerow,
                              isinfotab, istranslationtab, isreadonly, ad_column_id, hastree, whereclause,
                              orderbyclause, commitwarning, ad_process_id, processing, ad_image_id, importfields,
                              ...
                              ad_ctxhelp_id, treedisplayedon, maxqueryrecords, islookuponlyselection,
                              isallowadvancedlookup, ad_tabtype, ishighvolume, deleteconfirmationlogic)
VALUES ((SELECT MAX(ad_tab_id + 1) from ad_tab), 0, 0, 'Y', '2025-05-09 11:20:48.171000', 100,
        '2025-05-09 11:20:48.171000', 100, 'Patient Tag', null,
        null, (select ad_table_id from ad_table where ad_table_uu = 'efe5be1e-bc23-4e21-9807-81e67b3be56a'), 123, 140,
        1, 'Y', 'N', 'N', 'N',
        (select ad_column_id from ad_column where ad_column_uu = '90960ec6-5ca4-4cca-b238-01193a7f2309'), 'N', null,
        null, null, null, 'N', null, 'N', null,
        null, 'N', 'U', null, null, null, 'Y', 'N', null, '8d4f3a3a-5fc2-4570-baff-ff2a1a4b1dc0', null, 'B', 0, 'N',
        'Y', null, null, null);

INSERT INTO ad_field (ad_field_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, name,
                      description, help, iscentrallymaintained, ad_tab_id, ad_column_id, ad_fieldgroup_id, isdisplayed,
                      displaylogic, displaylength, isreadonly, seqno, sortno, issameline, isheading, isfieldonly,
                      isencrypted, entitytype, obscuretype, ad_reference_id, ismandatory, included_tab_id, defaultvalue,
                      ad_reference_value_id, ad_val_rule_id, infofactoryclass, ad_field_uu, isallowcopy, seqnogrid,
                      isdisplayedgrid, xposition, numlines, columnspan, isquickentry, isupdateable, isalwaysupdateable,
                      mandatorylogic, readonlylogic, istoolbarbutton, isadvancedfield, isdefaultfocus, vformat,
                      ad_labelstyle_id, ad_fieldstyle_id, placeholder, isquickform, bh_abbreviation, isselectioncolumn,
                      ad_val_rule_lookup_id, columnsql, ad_chart_id, alwaysupdatablelogic, ishtml)
VALUES ((SELECT MAX(ad_field_id + 1) from ad_field), 0, 0, 'Y', '2025-05-09 11:21:01.794000', 100, '2025-05-09 11:21:01.794000', 100, 'Active',
        'The record is active in the system', e'There are two methods of making records unavailable in the system: One is to delete the record, the other is to de-activate the record. A de-activated record is not available for selection, but available for reports.
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',
        'Y', (select ad_tab_id from ad_tab where ad_tab_uu='8d4f3a3a-5fc2-4570-baff-ff2a1a4b1dc0'), (select ad_column_id from ad_column where ad_column_uu ='227de5ed-08d5-42b7-9b9c-feade3131990' ), null, 'Y', null, 1, 'N', 50, null, 'N', 'N', 'N', 'N', 'U', null, null, null, null, null,
        null, null, null, 'e6563b30-b065-4a77-8e77-b5e17f9556d5', null, 30, 'Y', 2, 1, 2, 'N', null, null, null, null,
        null, 'N', 'N', null, null, null, null, 'N', null, null, null, null, null, null, null);
INSERT INTO ad_field (ad_field_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, name,
                      description, help, iscentrallymaintained, ad_tab_id, ad_column_id, ad_fieldgroup_id, isdisplayed,
                      displaylogic, displaylength, isreadonly, seqno, sortno, issameline, isheading, isfieldonly,
                      ...
                      ad_labelstyle_id, ad_fieldstyle_id, placeholder, isquickform, bh_abbreviation, isselectioncolumn,
                      ad_val_rule_lookup_id, columnsql, ad_chart_id, alwaysupdatablelogic, ishtml)
VALUES ((SELECT MAX(ad_field_id + 1) from ad_field), 0, 0, 'Y', '2025-05-09 11:21:01.784000', 100, '2025-05-09 11:21:01.784000', 100, 'BH_BPartner_Tags_UU',
        null, null, 'Y', (select ad_tab_id from ad_tab where ad_tab_uu='8d4f3a3a-5fc2-4570-baff-ff2a1a4b1dc0'), (select ad_column_id from ad_column where ad_column_uu ='e41c363b-5047-40ef-8784-1fbb14845e7d' ), null, 'N', null, 36, 'N', null, null, 'N', 'N', 'N', 'N', 'U', null, null,
        null, null, null, null, null, null, '0fa1aa30-6b30-42d0-a684-9731912f16ba', null, null, 'N', 1, 1, 2, 'N', null,
        null, null, null, null, 'N', 'N', null, null, null, null, 'N', null, null, null, null, null, null, null);
INSERT INTO ad_field (ad_field_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, name,
                      description, help, iscentrallymaintained, ad_tab_id, ad_column_id, ad_fieldgroup_id, isdisplayed,
                      displaylogic, displaylength, isreadonly, seqno, sortno, issameline, isheading, isfieldonly,
                      isencrypted, entitytype, obscuretype, ad_reference_id, ismandatory, included_tab_id, defaultvalue,
                      ...
                      ad_labelstyle_id, ad_fieldstyle_id, placeholder, isquickform, bh_abbreviation, isselectioncolumn,
                      ad_val_rule_lookup_id, columnsql, ad_chart_id, alwaysupdatablelogic, ishtml)
VALUES ((SELECT MAX(ad_field_id + 1) from ad_field), 0, 0, 'Y', '2025-05-09 11:21:01.773000', 100, '2025-05-09 11:21:01.773000', 100, 'Business Partner',
        'Identifies a Business Partner',
        'A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson',
        'Y', (select ad_tab_id from ad_tab where ad_tab_uu='8d4f3a3a-5fc2-4570-baff-ff2a1a4b1dc0'), (select ad_column_id from ad_column where ad_column_uu ='90960ec6-5ca4-4cca-b238-01193a7f2309' ), null, 'Y', null, 22, 'N', 40, null, 'N', 'N', 'N', 'N', 'U', null, null, null, null,
        null, null, null, null, 'e94fe267-4c56-46df-baec-3ba7ec6457ac', null, 20, 'Y', 1, 1, 2, 'N', null, null, null,
        null, null, 'N', 'N', null, null, null, null, 'N', null, null, null, null, null, null, null);
INSERT INTO ad_field (ad_field_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, name,
                      description, help, iscentrallymaintained, ad_tab_id, ad_column_id, ad_fieldgroup_id, isdisplayed,
                      displaylogic, displaylength, isreadonly, seqno, sortno, issameline, isheading, isfieldonly,
                      ...
                      ad_labelstyle_id, ad_fieldstyle_id, placeholder, isquickform, bh_abbreviation, isselectioncolumn,
                      ad_val_rule_lookup_id, columnsql, ad_chart_id, alwaysupdatablelogic, ishtml)
VALUES ((SELECT MAX(ad_field_id + 1) from ad_field), 0, 0, 'Y', '2025-05-09 11:21:01.766000', 100, '2025-05-09 11:21:01.766000', 100, 'BH Tags', null, null,
        'Y', (select ad_tab_id from ad_tab where ad_tab_uu='8d4f3a3a-5fc2-4570-baff-ff2a1a4b1dc0'), (select ad_column_id from ad_column where ad_column_uu ='a04e8bb3-6c40-4a18-8f2f-5d652b09d8bd' ), null, 'Y', null, 22, 'N', 30, null, 'N', 'N', 'N', 'N', 'U', null, null, null, null,
        null, null, null, null, '89ff7369-54be-46ba-8efc-62f36a3512b5', null, 10, 'Y', 1, 1, 2, 'N', null, null, null,
        null, null, 'N', 'N', null, null, null, null, 'N', null, null, null, null, null, null, null);
INSERT INTO ad_field (ad_field_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, name,
                      description, help, iscentrallymaintained, ad_tab_id, ad_column_id, ad_fieldgroup_id, isdisplayed,
                      displaylogic, displaylength, isreadonly, seqno, sortno, issameline, isheading, isfieldonly,
                      ...
                      ad_labelstyle_id, ad_fieldstyle_id, placeholder, isquickform, bh_abbreviation, isselectioncolumn,
                      ad_val_rule_lookup_id, columnsql, ad_chart_id, alwaysupdatablelogic, ishtml)
VALUES ((SELECT MAX(ad_field_id + 1) from ad_field), 0, 0, 'Y', '2025-05-09 11:21:01.754000', 100, '2025-05-09 11:21:01.754000', 100, 'Organization',
        'Organizational entity within tenant',
        'An organization is a unit of your tenant or legal entity - examples are store, department. You can share data between organizations.',
        'Y', (select ad_tab_id from ad_tab where ad_tab_uu='8d4f3a3a-5fc2-4570-baff-ff2a1a4b1dc0'), (select ad_column_id from ad_column where ad_column_uu ='2bf462ab-cc92-44df-8f2f-1b48031b8f17' ), null, 'Y', null, 22, 'N', 20, null, 'N', 'N', 'N', 'N', 'U', null, null, null, null,
        null, null, null, null, '0215c215-16a5-41d5-875c-b69a0b23d3d9', 'Y', null, 'N', 4, 1, 2, 'N', null, null, null,
        null, null, 'N', 'N', null, null, null, null, 'N', null, null, null, null, null, null, null);
INSERT INTO ad_field (ad_field_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, name,
                      description, help, iscentrallymaintained, ad_tab_id, ad_column_id, ad_fieldgroup_id, isdisplayed,
                      displaylogic, displaylength, isreadonly, seqno, sortno, issameline, isheading, isfieldonly,
                      ...
                      ad_labelstyle_id, ad_fieldstyle_id, placeholder, isquickform, bh_abbreviation, isselectioncolumn,
                      ad_val_rule_lookup_id, columnsql, ad_chart_id, alwaysupdatablelogic, ishtml)
VALUES ((SELECT MAX(ad_field_id + 1) from ad_field), 0, 0, 'Y', '2025-05-09 11:21:01.740000', 100, '2025-05-09 11:21:01.740000', 100, 'Tenant',
        'Tenant for this installation.',
        'A Tenant is a company or a legal entity. You cannot share data between Tenants.', 'Y', (select ad_tab_id from ad_tab where ad_tab_uu='8d4f3a3a-5fc2-4570-baff-ff2a1a4b1dc0'), (select ad_column_id from ad_column where ad_column_uu ='1ceda655-ff0c-4487-bf31-53e777acde18' ), null,
        'Y', null, 22, 'N', 10, null, 'N', 'N', 'N', 'N', 'U', null, null, null, null, null, null, null, null,
        'e788b03c-fde3-4eee-855f-833889d01aa1', null, null, 'N', 1, 1, 2, 'N', null, null, null, null, null, 'N', 'N',
        null, null, null, null, 'N', null, null, null, null, null, null, null);
