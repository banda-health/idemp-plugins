-- Re-calculate inventory based on what's in m_transaction for certain clients
-- (we'll update for all clients later if this is successful)
...
SELECT
	register_migration_script('202302091301_GO-2589.sql')
FROM
	dual;
