 ...
 */
public class StorageOnHandRepository extends BaseRepository<MStorageOnHand> {
	/**
...
//		processRepository = new ProcessRepository();
	...
	@Override
	public MStorageOnHand mapInputModelToModel(MStorageOnHand entity) {
...
//				storageOnHand.getM_AttributeSetInstance_ID(), entity.getQuantityOnHand());
		return getBaseQuery(MStorageOnHand.Table_Name + "." +
	...
	public String getDefaultJoinClause() {
		return " JOIN " + MAttributeSetInstance.Table_Name + " ON " + MAttributeSetInstance.Table_Name + "." +
				...
				MStorageOnHand.COLUMNNAME_M_AttributeSetInstance_ID + " " +
				attributeSetInstanceRepository.getDefaultJoinClause() + " JOIN " + MProduct_BH.Table_Name +
