...
public class InventoryRecord extends BaseEntity {
	...
	public InventoryRecord(int productId, int warehouseId, String productName, String expiration, int quantity, int shelfLife,
	...
	public InventoryRecord(MInventoryLine_BH instance) {
