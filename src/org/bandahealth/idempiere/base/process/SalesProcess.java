...
//		autoGeneratedPayment.processIt(DocAction.ACTION_Reverse_Correct);
		log.warning("C_Payment_ID = " + autoGeneratedPayment.getC_Payment_ID() + "DocStatus = "
				+ autoGeneratedPayment.getDocStatus() + ", DocAction = " + autoGeneratedPayment.getDocStatus());
		...
		for (MPayment_BH orderPayment : orderPayments) {
			...
			log.warning("C_Payment_ID = " + orderPayment.getC_Payment_ID() + "DocStatus = "
					+ orderPayment.getDocStatus() + ", DocAction = " + orderPayment.getDocStatus());
			orderPayment.processIt(DocAction.ACTION_Complete);
			orderPayment.saveEx(get_TrxName());
			log.warning("C_Payment_ID = " + orderPayment.getC_Payment_ID() + "DocStatus = "
					+ orderPayment.getDocStatus() + ", DocAction = " + orderPayment.getDocStatus());
		}
