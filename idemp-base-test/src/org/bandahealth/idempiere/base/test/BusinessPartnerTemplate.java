...
public class BusinessPartnerTemplate extends BaseModelTemplate<MBPartner_BH> {
	...
	public BusinessPartnerTemplate(String transactionName, Properties context, int orgId, String patientId, boolean isPatient,
