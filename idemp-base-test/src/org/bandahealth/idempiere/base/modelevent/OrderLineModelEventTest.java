...
import org.bandahealth.idempiere.base.BusinessPartnerTemplate;
...
public class OrderLineModelEventTest extends AdempiereTestCase {
	...
	protected void setUp() throws Exception {
		...
		int bPartner = new BusinessPartnerTemplate(getTrxName(), getCtx(), Env.getAD_Org_ID(getCtx()), null, false,
