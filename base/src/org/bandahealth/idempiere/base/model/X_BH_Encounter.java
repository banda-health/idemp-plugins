...
public class X_BH_Encounter extends PO implements I_BH_Encounter, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20230711L;
	...
	/** Set Encounter Type.
		@param BH_Encounter_Type_ID Encounter Type	  */
	public void setBH_Encounter_Type_ID (int BH_Encounter_Type_ID)
	{
		if (BH_Encounter_Type_ID < 1) 
			set_Value (COLUMNNAME_BH_Encounter_Type_ID, null);
		else 
			set_Value (COLUMNNAME_BH_Encounter_Type_ID, Integer.valueOf(BH_Encounter_Type_ID));
	}

	/** Get Encounter Type.
		@return Encounter Type	  */
	public int getBH_Encounter_Type_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_BH_Encounter_Type_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
