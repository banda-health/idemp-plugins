...
public class X_BH_PaymentRef_BankAcct extends PO implements I_BH_PaymentRef_BankAcct, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_BH_PaymentRef_BankAcct (Properties ctx, int BH_PaymentRef_BankAcct_ID, String trxName, String ... virtualColumns)
    {
    ...
    /** Standard Constructor */
    public X_BH_PaymentRef_BankAcct (Properties ctx, String BH_PaymentRef_BankAcct_UU, String trxName)
    {
      super (ctx, BH_PaymentRef_BankAcct_UU, trxName);
      /** if (BH_PaymentRef_BankAcct_UU == null)
        {
			setBH_PaymentRef_BankAcct_ID (0);
			setBH_PaymentRef_ID (0);
			setName (null);
    ...
    /** Standard Constructor */
    public X_BH_PaymentRef_BankAcct (Properties ctx, String BH_PaymentRef_BankAcct_UU, String trxName, String ... virtualColumns)
    {
	...
	*/
	...
	{
		return (I_BH_PaymentRef)MTable.get(getCtx(), I_BH_PaymentRef.Table_ID)
