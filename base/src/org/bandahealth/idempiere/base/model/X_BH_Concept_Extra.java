...
public class X_BH_Concept_Extra extends PO implements I_BH_Concept_Extra, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_BH_Concept_Extra (Properties ctx, int BH_Concept_Extra_ID, String trxName, String ... virtualColumns)
    {
    ...
    /** Standard Constructor */
    public X_BH_Concept_Extra (Properties ctx, String BH_Concept_Extra_UU, String trxName)
    {
      super (ctx, BH_Concept_Extra_UU, trxName);
      /** if (BH_Concept_Extra_UU == null)
        {
        } */
    }

    /** Standard Constructor */
    public X_BH_Concept_Extra (Properties ctx, String BH_Concept_Extra_UU, String trxName, String ... virtualColumns)
    {
