...
public class X_BH_Voided_Reason extends PO implements I_BH_Voided_Reason, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_BH_Voided_Reason (Properties ctx, int BH_Voided_Reason_ID, String trxName, String ... virtualColumns)
    {
    ...
    /** Standard Constructor */
    public X_BH_Voided_Reason (Properties ctx, String BH_Voided_Reason_UU, String trxName)
    {
      super (ctx, BH_Voided_Reason_UU, trxName);
      /** if (BH_Voided_Reason_UU == null)
        {
			setBH_Voided_Reason_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_BH_Voided_Reason (Properties ctx, String BH_Voided_Reason_UU, String trxName, String ... virtualColumns)
    {
