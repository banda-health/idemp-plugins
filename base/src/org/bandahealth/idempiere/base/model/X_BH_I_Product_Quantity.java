...
// Product
    ...
    /** Standard Constructor */
    public X_BH_I_Product_Quantity (Properties ctx, int BH_I_Product_Quantity_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, BH_I_Product_Quantity_ID, trxName, virtualColumns);
      /** if (BH_I_Product_Quantity_ID == 0)
        {
			setBH_BuyPrice (Env.ZERO);
// 0
...
// Product
    ...
    /** Standard Constructor */
    public X_BH_I_Product_Quantity (Properties ctx, String BH_I_Product_Quantity_UU, String trxName)
    {
      super (ctx, BH_I_Product_Quantity_UU, trxName);
      /** if (BH_I_Product_Quantity_UU == null)
        {
			setBH_BuyPrice (Env.ZERO);
// 0
			setBH_HasExpiration (false);
...
// Product
    ...
    /** Standard Constructor */
    public X_BH_I_Product_Quantity (Properties ctx, String BH_I_Product_Quantity_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, BH_I_Product_Quantity_UU, trxName, virtualColumns);
      /** if (BH_I_Product_Quantity_UU == null)
        {
			setBH_BuyPrice (Env.ZERO);
// 0
