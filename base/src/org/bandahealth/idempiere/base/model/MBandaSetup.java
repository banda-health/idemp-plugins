...
public class MBandaSetup {
	...
	public boolean createDefaultPatientNumberSequence() {
		PO.setCrossTenantSafe();
		MSequence_BH patientNumberSequence = new Query(this.context, MSequence_BH.Table_Name,
				MSequence_BH.COLUMNNAME_AD_Client_ID + " =? AND " + MSequence_BH.COLUMNNAME_Name + "=?",
				getTransactionName()).setParameters(MClient_BH.CLIENTID_CONFIG,
				MSequence_BH.GENERERATE_PATIENT_NUMBER_SEQUENCE_TABLE_NAME_WITH_PREFIX).first();
		PO.clearCrossTenantSafe();
