...
BEGIN;
	...
	ALTER TABLE bh_stocktake DROP CONSTRAINT mattributesetinstance_bhstockt;
	ALTER TABLE c_invoiceline DROP CONSTRAINT c_invoiceline_m_attributesetinstance_id_fkey;
	ALTER TABLE c_landedcostallocation DROP CONSTRAINT masi_clandedcostallocation;
	ALTER TABLE c_orderline DROP CONSTRAINT c_orderline_m_attributesetinstance_id_fkey;
	...
	ALTER TABLE m_cost DROP CONSTRAINT m_cost_m_attributesetinstance_id_fkey;
	ALTER TABLE m_costdetail DROP CONSTRAINT m_costdetail_m_attributesetinstance_id_fkey;
	ALTER TABLE m_costhistory DROP CONSTRAINT m_costhistory_m_attributesetinstance_id_fkey;
	ALTER TABLE m_costqueue DROP CONSTRAINT masi_mcostqueue;
	ALTER TABLE m_inoutline DROP CONSTRAINT m_inoutline_m_attributesetinstance_id_fkey;
	ALTER TABLE m_inoutlinema DROP CONSTRAINT m_inoutlinema_m_attributesetinstance_id_fkey;
	...
	ALTER TABLE m_matchpo DROP CONSTRAINT m_matchpo_m_attributesetinstance_id_fkey;
	...
	ALTER TABLE m_product DROP CONSTRAINT m_product_m_attributesetinstance_id_fkey;
	...
	ALTER TABLE m_storageonhand DROP CONSTRAINT m_storageonhand_m_attributesetinstance_id_fkey;
	ALTER TABLE m_storagereservation DROP CONSTRAINT m_storagereservation_m_attributesetinstance_id_fkey;
	ALTER TABLE m_transaction DROP CONSTRAINT m_transaction_m_attributesetinstance_id_fkey;
	...
	ALTER TABLE c_projectissuema DROP CONSTRAINT c_projectissuema_pkey;
	ALTER TABLE m_attributeinstance DROP CONSTRAINT m_attributeinstance_pkey;
	ALTER TABLE m_attributesetinstance DROP CONSTRAINT m_attributesetinstance_pkey;
	ALTER TABLE m_cost DROP CONSTRAINT m_cost_pkey;
	...
	ALTER TABLE m_storagereservation DROP CONSTRAINT m_storagereservation_pkey;
