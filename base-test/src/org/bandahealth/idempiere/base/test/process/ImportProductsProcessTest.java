...
public class ImportProductsProcessTest extends ChuBoePopulateFactoryVO {
	...
	public void canImportProductsWithDifferentPriceLists() throws SQLException, IOException {
		...
		valueObject.setStepName("Create products with different price lists");
		...
		MPriceListVersion priceListVersion1 = new MPriceListVersion(valueObject.getContext(), 0, valueObject.getTransactionName());
		priceListVersion1.setAD_Org_ID(0);
		priceListVersion1.setName(datePriceList + "; IsSOTrx=Y; " + valueObject.getRandomNumber());
		priceListVersion1.setDescription(valueObject.getStepMessageLong());
		priceListVersion1.setM_PriceList_ID(priceList1.get_ID());
		priceListVersion1.setValidFrom(datePriceList);
		priceListVersion1.setM_DiscountSchema_ID(schema.get_ID());
		priceListVersion1.saveEx(); 
		
		X_BH_I_Product_Quantity product1 = new X_BH_I_Product_Quantity(valueObject.getContext(), 0,
				valueObject.getTransactionName());
		product1.setName(valueObject.getScenarioName());
		product1.setCategoryName("Product1");
		product1.setBH_BuyPrice(new BigDecimal(5));
		product1.setBH_SellPrice(new BigDecimal(25));
		...
		MPriceListVersion priceListVersion2 = new MPriceListVersion(valueObject.getContext(), 0, valueObject.getTransactionName());
		priceListVersion2.setAD_Org_ID(0);
		priceListVersion2.setName(datePriceList + "; IsSOTrx=Y; " + valueObject.getRandomNumber());
		...
		priceListVersion2.setValidFrom(datePriceList);
		priceListVersion2.setM_DiscountSchema_ID(schema.get_ID());
		priceListVersion2.saveEx(); 
	
		
		X_BH_I_Product_Quantity product2 = new X_BH_I_Product_Quantity(valueObject.getContext(), 0,
				valueObject.getTransactionName());
		product2.setName(valueObject.getScenarioName());
		product2.setCategoryName("Product2");
		product2.setBH_BuyPrice(new BigDecimal(5));
		product2.setBH_SellPrice(new BigDecimal(30));
		product2.saveEx();
		...
		List<MProductPrice> productPrices = new Query(valueObject.getContext(), MProductPrice.Table_Name, null,
				valueObject.getTransactionName()).list();	
