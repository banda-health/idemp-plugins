...
public class X_M_PriceListMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MPriceList M_PriceListSave(I_M_PriceListInput input, DataFetchingEnvironment environment) {
		return (MPriceList) super.save((X_M_PriceListInput) input, environment);
	}
