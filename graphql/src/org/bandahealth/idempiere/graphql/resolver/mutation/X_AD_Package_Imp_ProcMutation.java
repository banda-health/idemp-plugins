...
public class X_AD_Package_Imp_ProcMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_Package_Imp_Proc AD_Package_Imp_ProcSave(I_AD_Package_Imp_ProcInput input, DataFetchingEnvironment environment) {
		return (X_AD_Package_Imp_Proc) super.save((X_AD_Package_Imp_ProcInput) input, environment);
	}
