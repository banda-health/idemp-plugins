...
public class X_A_Asset_RetirementMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_A_Asset_Retirement A_Asset_RetirementSave(I_A_Asset_RetirementInput input, DataFetchingEnvironment environment) {
		return (X_A_Asset_Retirement) super.save((X_A_Asset_RetirementInput) input, environment);
	}
