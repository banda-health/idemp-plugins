...
public class X_T_ReportStatementMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_T_ReportStatement T_ReportStatementSave(I_T_ReportStatementInput input, DataFetchingEnvironment environment) {
		return (X_T_ReportStatement) super.save((X_T_ReportStatementInput) input, environment);
	}
