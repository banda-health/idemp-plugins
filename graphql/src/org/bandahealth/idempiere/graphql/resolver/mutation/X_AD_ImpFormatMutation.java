...
public class X_AD_ImpFormatMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_ImpFormat AD_ImpFormatSave(I_AD_ImpFormatInput input, DataFetchingEnvironment environment) {
		return (X_AD_ImpFormat) super.save((X_AD_ImpFormatInput) input, environment);
	}
