...
public class X_AD_Tree_FavoriteMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MTreeFavorite AD_Tree_FavoriteSave(I_AD_Tree_FavoriteInput input, DataFetchingEnvironment environment) {
		return (MTreeFavorite) super.save((X_AD_Tree_FavoriteInput) input, environment);
	}
