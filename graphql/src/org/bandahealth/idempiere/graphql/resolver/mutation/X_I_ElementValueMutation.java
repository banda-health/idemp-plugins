...
public class X_I_ElementValueMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_I_ElementValue I_ElementValueSave(I_I_ElementValueInput input, DataFetchingEnvironment environment) {
		return (X_I_ElementValue) super.save((X_I_ElementValueInput) input, environment);
	}
