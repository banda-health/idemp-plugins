...
public class X_AD_Ref_ListMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MRefList_BH AD_Ref_ListSave(I_AD_Ref_ListInput input, DataFetchingEnvironment environment) {
		return (MRefList_BH) super.save((X_AD_Ref_ListInput) input, environment);
	}
