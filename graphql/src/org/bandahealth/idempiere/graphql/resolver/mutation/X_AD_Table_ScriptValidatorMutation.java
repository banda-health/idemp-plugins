...
public class X_AD_Table_ScriptValidatorMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MTableScriptValidator AD_Table_ScriptValidatorSave(I_AD_Table_ScriptValidatorInput input, DataFetchingEnvironment environment) {
		return (MTableScriptValidator) super.save((X_AD_Table_ScriptValidatorInput) input, environment);
	}
