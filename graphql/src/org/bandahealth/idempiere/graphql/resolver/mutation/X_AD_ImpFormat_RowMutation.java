...
public class X_AD_ImpFormat_RowMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_ImpFormat_Row AD_ImpFormat_RowSave(I_AD_ImpFormat_RowInput input, DataFetchingEnvironment environment) {
		return (X_AD_ImpFormat_Row) super.save((X_AD_ImpFormat_RowInput) input, environment);
	}
