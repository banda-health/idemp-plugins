...
public class X_AD_PrintFormatItemMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_PrintFormatItem AD_PrintFormatItemSave(I_AD_PrintFormatItemInput input, DataFetchingEnvironment environment) {
		return (X_AD_PrintFormatItem) super.save((X_AD_PrintFormatItemInput) input, environment);
	}
