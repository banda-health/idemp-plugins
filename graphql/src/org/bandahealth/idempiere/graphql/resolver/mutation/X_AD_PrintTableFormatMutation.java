...
public class X_AD_PrintTableFormatMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_PrintTableFormat AD_PrintTableFormatSave(I_AD_PrintTableFormatInput input, DataFetchingEnvironment environment) {
		return (X_AD_PrintTableFormat) super.save((X_AD_PrintTableFormatInput) input, environment);
	}
