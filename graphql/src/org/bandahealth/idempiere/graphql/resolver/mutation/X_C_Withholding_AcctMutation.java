...
public class X_C_Withholding_AcctMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_C_Withholding_Acct C_Withholding_AcctSave(I_C_Withholding_AcctInput input, DataFetchingEnvironment environment) {
		return (X_C_Withholding_Acct) super.save((X_C_Withholding_AcctInput) input, environment);
	}
