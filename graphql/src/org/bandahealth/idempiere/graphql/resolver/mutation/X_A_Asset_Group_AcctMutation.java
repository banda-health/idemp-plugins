...
public class X_A_Asset_Group_AcctMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MAssetGroupAcct A_Asset_Group_AcctSave(I_A_Asset_Group_AcctInput input, DataFetchingEnvironment environment) {
		return (MAssetGroupAcct) super.save((X_A_Asset_Group_AcctInput) input, environment);
	}
