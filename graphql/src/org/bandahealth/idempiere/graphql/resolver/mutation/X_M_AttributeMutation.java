...
public class X_M_AttributeMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MAttribute M_AttributeSave(I_M_AttributeInput input, DataFetchingEnvironment environment) {
		return (MAttribute) super.save((X_M_AttributeInput) input, environment);
	}
