...
public class X_C_CommissionDetailMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MCommissionDetail C_CommissionDetailSave(I_C_CommissionDetailInput input, DataFetchingEnvironment environment) {
		return (MCommissionDetail) super.save((X_C_CommissionDetailInput) input, environment);
	}
