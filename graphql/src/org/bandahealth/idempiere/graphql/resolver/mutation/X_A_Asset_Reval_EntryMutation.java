...
public class X_A_Asset_Reval_EntryMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_A_Asset_Reval_Entry A_Asset_Reval_EntrySave(I_A_Asset_Reval_EntryInput input, DataFetchingEnvironment environment) {
		return (X_A_Asset_Reval_Entry) super.save((X_A_Asset_Reval_EntryInput) input, environment);
	}
