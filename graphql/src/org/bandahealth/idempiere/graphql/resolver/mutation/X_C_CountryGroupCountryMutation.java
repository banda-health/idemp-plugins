...
public class X_C_CountryGroupCountryMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MCountryGroupCountry C_CountryGroupCountrySave(I_C_CountryGroupCountryInput input, DataFetchingEnvironment environment) {
		return (MCountryGroupCountry) super.save((X_C_CountryGroupCountryInput) input, environment);
	}
