...
public class X_BH_BP_General_Payer_InfoMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MBHBPGeneralPayerInfo BH_BP_General_Payer_InfoSave(I_BH_BP_General_Payer_InfoInput input, DataFetchingEnvironment environment) {
		return (MBHBPGeneralPayerInfo) super.save((X_BH_BP_General_Payer_InfoInput) input, environment);
	}
