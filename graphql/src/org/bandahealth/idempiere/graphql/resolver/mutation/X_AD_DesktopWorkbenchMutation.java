...
public class X_AD_DesktopWorkbenchMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_DesktopWorkbench AD_DesktopWorkbenchSave(I_AD_DesktopWorkbenchInput input, DataFetchingEnvironment environment) {
		return (X_AD_DesktopWorkbench) super.save((X_AD_DesktopWorkbenchInput) input, environment);
	}
