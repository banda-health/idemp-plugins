...
public class X_C_BP_WithholdingMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_C_BP_Withholding C_BP_WithholdingSave(I_C_BP_WithholdingInput input, DataFetchingEnvironment environment) {
		return (X_C_BP_Withholding) super.save((X_C_BP_WithholdingInput) input, environment);
	}
