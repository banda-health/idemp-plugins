...
public class X_M_Product_POMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MProductPO_BH M_Product_POSave(I_M_Product_POInput input, DataFetchingEnvironment environment) {
		return (MProductPO_BH) super.save((X_M_Product_POInput) input, environment);
	}
