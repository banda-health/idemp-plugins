...
public class X_AD_HouseKeepingMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MHouseKeeping AD_HouseKeepingSave(I_AD_HouseKeepingInput input, DataFetchingEnvironment environment) {
		return (MHouseKeeping) super.save((X_AD_HouseKeepingInput) input, environment);
	}
