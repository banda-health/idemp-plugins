...
public class X_AD_UserDef_Info_ColumnMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MUserDefInfoColumn AD_UserDef_Info_ColumnSave(I_AD_UserDef_Info_ColumnInput input, DataFetchingEnvironment environment) {
		return (MUserDefInfoColumn) super.save((X_AD_UserDef_Info_ColumnInput) input, environment);
	}
