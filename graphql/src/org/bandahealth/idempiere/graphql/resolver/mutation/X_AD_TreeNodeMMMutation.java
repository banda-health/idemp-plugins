...
public class X_AD_TreeNodeMMMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MTree_NodeMM AD_TreeNodeMMSave(I_AD_TreeNodeMMInput input, DataFetchingEnvironment environment) {
		return (MTree_NodeMM) super.save((X_AD_TreeNodeMMInput) input, environment);
	}
