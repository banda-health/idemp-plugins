...
public class X_PA_ReportSourceMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_PA_ReportSource PA_ReportSourceSave(I_PA_ReportSourceInput input, DataFetchingEnvironment environment) {
		return (X_PA_ReportSource) super.save((X_PA_ReportSourceInput) input, environment);
	}
