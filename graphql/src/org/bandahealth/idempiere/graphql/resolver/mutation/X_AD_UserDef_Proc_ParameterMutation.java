...
public class X_AD_UserDef_Proc_ParameterMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MUserDefProcParameter AD_UserDef_Proc_ParameterSave(I_AD_UserDef_Proc_ParameterInput input, DataFetchingEnvironment environment) {
		return (MUserDefProcParameter) super.save((X_AD_UserDef_Proc_ParameterInput) input, environment);
	}
