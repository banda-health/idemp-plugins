...
public class X_AD_ChangeLogMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MChangeLog AD_ChangeLogSave(I_AD_ChangeLogInput input, DataFetchingEnvironment environment) {
		return (MChangeLog) super.save((X_AD_ChangeLogInput) input, environment);
	}
