...
public class X_M_Product_QualityTestMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_M_Product_QualityTest M_Product_QualityTestSave(I_M_Product_QualityTestInput input, DataFetchingEnvironment environment) {
		return (X_M_Product_QualityTest) super.save((X_M_Product_QualityTestInput) input, environment);
	}
