...
public class X_BH_Encounter_Type_WindowMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MBHEncounterTypeWindow BH_Encounter_Type_WindowSave(I_BH_Encounter_Type_WindowInput input, DataFetchingEnvironment environment) {
		return (MBHEncounterTypeWindow) super.save((X_BH_Encounter_Type_WindowInput) input, environment);
	}
