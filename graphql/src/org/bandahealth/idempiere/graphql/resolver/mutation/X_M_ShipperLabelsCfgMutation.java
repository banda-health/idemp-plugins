...
public class X_M_ShipperLabelsCfgMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_M_ShipperLabelsCfg M_ShipperLabelsCfgSave(I_M_ShipperLabelsCfgInput input, DataFetchingEnvironment environment) {
		return (X_M_ShipperLabelsCfg) super.save((X_M_ShipperLabelsCfgInput) input, environment);
	}
