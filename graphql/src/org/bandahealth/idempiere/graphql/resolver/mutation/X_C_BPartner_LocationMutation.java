...
public class X_C_BPartner_LocationMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MBPartnerLocation C_BPartner_LocationSave(I_C_BPartner_LocationInput input, DataFetchingEnvironment environment) {
		return (MBPartnerLocation) super.save((X_C_BPartner_LocationInput) input, environment);
	}
