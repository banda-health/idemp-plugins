...
public class X_C_RevenueRecognitionMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MRevenueRecognition C_RevenueRecognitionSave(I_C_RevenueRecognitionInput input, DataFetchingEnvironment environment) {
		return (MRevenueRecognition) super.save((X_C_RevenueRecognitionInput) input, environment);
	}
