...
public class X_AD_MigrationScriptMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_MigrationScript AD_MigrationScriptSave(I_AD_MigrationScriptInput input, DataFetchingEnvironment environment) {
		return (X_AD_MigrationScript) super.save((X_AD_MigrationScriptInput) input, environment);
	}
