...
public class X_AD_ViewColumnMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MViewColumn AD_ViewColumnSave(I_AD_ViewColumnInput input, DataFetchingEnvironment environment) {
		return (MViewColumn) super.save((X_AD_ViewColumnInput) input, environment);
	}
