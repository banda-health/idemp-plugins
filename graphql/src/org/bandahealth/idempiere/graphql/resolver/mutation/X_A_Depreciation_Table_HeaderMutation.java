...
public class X_A_Depreciation_Table_HeaderMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_A_Depreciation_Table_Header A_Depreciation_Table_HeaderSave(I_A_Depreciation_Table_HeaderInput input, DataFetchingEnvironment environment) {
		return (X_A_Depreciation_Table_Header) super.save((X_A_Depreciation_Table_HeaderInput) input, environment);
	}
