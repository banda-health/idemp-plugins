...
public class X_AD_WF_EventAuditMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_WF_EventAudit AD_WF_EventAuditSave(I_AD_WF_EventAuditInput input, DataFetchingEnvironment environment) {
		return (X_AD_WF_EventAudit) super.save((X_AD_WF_EventAuditInput) input, environment);
	}
