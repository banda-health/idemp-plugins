...
public class X_AD_UserDef_TabMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MUserDefTab AD_UserDef_TabSave(I_AD_UserDef_TabInput input, DataFetchingEnvironment environment) {
		return (MUserDefTab) super.save((X_AD_UserDef_TabInput) input, environment);
	}
