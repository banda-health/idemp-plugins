...
public class X_IMP_ProcessorParameterMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_IMP_ProcessorParameter IMP_ProcessorParameterSave(I_IMP_ProcessorParameterInput input, DataFetchingEnvironment environment) {
		return (X_IMP_ProcessorParameter) super.save((X_IMP_ProcessorParameterInput) input, environment);
	}
