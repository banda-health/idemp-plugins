...
public class X_C_OrderPayScheduleMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MOrderPaySchedule C_OrderPayScheduleSave(I_C_OrderPayScheduleInput input, DataFetchingEnvironment environment) {
		return (MOrderPaySchedule) super.save((X_C_OrderPayScheduleInput) input, environment);
	}
