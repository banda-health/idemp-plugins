...
public class X_C_PeriodControlMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MPeriodControl C_PeriodControlSave(I_C_PeriodControlInput input, DataFetchingEnvironment environment) {
		return (MPeriodControl) super.save((X_C_PeriodControlInput) input, environment);
	}
