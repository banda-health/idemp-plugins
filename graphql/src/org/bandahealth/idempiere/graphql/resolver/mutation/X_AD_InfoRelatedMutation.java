...
public class X_AD_InfoRelatedMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_InfoRelated AD_InfoRelatedSave(I_AD_InfoRelatedInput input, DataFetchingEnvironment environment) {
		return (X_AD_InfoRelated) super.save((X_AD_InfoRelatedInput) input, environment);
	}
