...
public class X_AD_PrintLabelLineMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_PrintLabelLine AD_PrintLabelLineSave(I_AD_PrintLabelLineInput input, DataFetchingEnvironment environment) {
		return (X_AD_PrintLabelLine) super.save((X_AD_PrintLabelLineInput) input, environment);
	}
