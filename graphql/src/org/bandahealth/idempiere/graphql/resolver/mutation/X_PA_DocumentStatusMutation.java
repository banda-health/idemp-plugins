...
public class X_PA_DocumentStatusMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MDocumentStatus PA_DocumentStatusSave(I_PA_DocumentStatusInput input, DataFetchingEnvironment environment) {
		return (MDocumentStatus) super.save((X_PA_DocumentStatusInput) input, environment);
	}
