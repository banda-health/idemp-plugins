...
public class X_AD_PInstance_LogMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_PInstance_Log AD_PInstance_LogSave(I_AD_PInstance_LogInput input, DataFetchingEnvironment environment) {
		return (X_AD_PInstance_Log) super.save((X_AD_PInstance_LogInput) input, environment);
	}
