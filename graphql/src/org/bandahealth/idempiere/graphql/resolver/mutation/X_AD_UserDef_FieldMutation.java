...
public class X_AD_UserDef_FieldMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MUserDefField AD_UserDef_FieldSave(I_AD_UserDef_FieldInput input, DataFetchingEnvironment environment) {
		return (MUserDefField) super.save((X_AD_UserDef_FieldInput) input, environment);
	}
