...
public class X_ASP_WindowMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_ASP_Window ASP_WindowSave(I_ASP_WindowInput input, DataFetchingEnvironment environment) {
		return (X_ASP_Window) super.save((X_ASP_WindowInput) input, environment);
	}
