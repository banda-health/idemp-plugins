...
public class X_C_InterOrg_AcctMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_C_InterOrg_Acct C_InterOrg_AcctSave(I_C_InterOrg_AcctInput input, DataFetchingEnvironment environment) {
		return (X_C_InterOrg_Acct) super.save((X_C_InterOrg_AcctInput) input, environment);
	}

	public boolean C_InterOrg_AcctDelete(List<String> uuids, DataFetchingEnvironment environment) {
