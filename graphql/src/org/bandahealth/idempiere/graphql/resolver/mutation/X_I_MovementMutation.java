...
public class X_I_MovementMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_I_Movement I_MovementSave(I_I_MovementInput input, DataFetchingEnvironment environment) {
		return (X_I_Movement) super.save((X_I_MovementInput) input, environment);
	}
