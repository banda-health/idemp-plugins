...
public class X_M_LocatorTypeMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MLocatorType M_LocatorTypeSave(I_M_LocatorTypeInput input, DataFetchingEnvironment environment) {
		return (MLocatorType) super.save((X_M_LocatorTypeInput) input, environment);
	}
