...
public class X_AD_InfoColumnMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MInfoColumn AD_InfoColumnSave(I_AD_InfoColumnInput input, DataFetchingEnvironment environment) {
		return (MInfoColumn) super.save((X_AD_InfoColumnInput) input, environment);
	}
