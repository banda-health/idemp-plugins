...
public class X_AD_PrintFormMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_AD_PrintForm AD_PrintFormSave(I_AD_PrintFormInput input, DataFetchingEnvironment environment) {
		return (X_AD_PrintForm) super.save((X_AD_PrintFormInput) input, environment);
	}
