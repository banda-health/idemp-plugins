...
public class X_A_Asset_TypeMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MAssetType A_Asset_TypeSave(I_A_Asset_TypeInput input, DataFetchingEnvironment environment) {
		return (MAssetType) super.save((X_A_Asset_TypeInput) input, environment);
	}
