...
public class X_IMP_ProcessorMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_IMP_Processor IMP_ProcessorSave(I_IMP_ProcessorInput input, DataFetchingEnvironment environment) {
		return (X_IMP_Processor) super.save((X_IMP_ProcessorInput) input, environment);
	}
