...
public class X_AD_Replication_LogMutation extends POMutation implements GraphQLMutationResolver {
	...
	public MReplicationLog AD_Replication_LogSave(I_AD_Replication_LogInput input, DataFetchingEnvironment environment) {
		return (MReplicationLog) super.save((X_AD_Replication_LogInput) input, environment);
	}
