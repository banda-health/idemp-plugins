...
public class X_PP_Cost_CollectorMAMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_PP_Cost_CollectorMA PP_Cost_CollectorMASave(I_PP_Cost_CollectorMAInput input, DataFetchingEnvironment environment) {
		return (X_PP_Cost_CollectorMA) super.save((X_PP_Cost_CollectorMAInput) input, environment);
	}
