...
public class X_M_AttributeSearchMutation extends POMutation implements GraphQLMutationResolver {
	...
	public X_M_AttributeSearch M_AttributeSearchSave(I_M_AttributeSearchInput input, DataFetchingEnvironment environment) {
		return (X_M_AttributeSearch) super.save((X_M_AttributeSearchInput) input, environment);
	}

	public boolean M_AttributeSearchDelete(List<String> uuids, DataFetchingEnvironment environment) {
