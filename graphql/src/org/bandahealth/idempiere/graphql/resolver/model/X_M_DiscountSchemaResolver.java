...
public class X_M_DiscountSchemaResolver extends POResolver<MDiscountSchema> implements GraphQLResolver<MDiscountSchema> {
	...
	public static Map<String, String> CUMULATIVELEVEL_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("L", "e1900a88-3b1d-42d1-bdd1-73c98e8da204"); // Line
		}
	};
	...
	public static Map<String, String> DISCOUNTTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("F", "05de479b-68e1-4938-9780-32cc46552a61"); // Flat Percent
			put("S", "0e5a081a-1ff0-41fe-9416-d49900f47c01"); // Formula
			put("B", "72cb1574-a005-4e1f-bb1d-64e2eb4f8724"); // Breaks
			put("P", "fc11d767-ab3d-44c4-bdcc-6404c2c5af07"); // Pricelist
		}
	};
