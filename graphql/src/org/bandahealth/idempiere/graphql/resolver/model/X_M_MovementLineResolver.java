 ...
 */
public class X_M_MovementLineResolver extends POResolver<MMovementLine_BH> implements GraphQLResolver<MMovementLine_BH> {
	 ...
	 */
	public CompletableFuture<MDDOrderLine> DD_OrderLine(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MAttributeSetInstance_BH> M_AttributeSetInstance(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MAttributeSetInstance_BH> M_AttributeSetInstanceTo(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MLocator> M_Locator(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MLocator> M_LocatorTo(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MMovement_BH> M_Movement(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MProduct_BH> M_Product(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	...
	public Boolean Processed(MMovementLine_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MMovementLine_BH> ReversalLine(MMovementLine_BH entity, DataFetchingEnvironment environment) {
