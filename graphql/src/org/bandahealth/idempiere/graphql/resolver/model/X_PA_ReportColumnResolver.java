...
public class X_PA_ReportColumnResolver extends POResolver<X_PA_ReportColumn> implements GraphQLResolver<X_PA_ReportColumn> {
	 ...
	 */
	public CompletableFuture<MCurrency> C_Currency(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> CALCULATIONTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.CALCULATIONTYPE_AddOp1PlusOp2, "f6ceb249-8184-4e03-869c-21a955349210");
			put(X_PA_ReportColumn.CALCULATIONTYPE_SubtractOp1_Op2, "19ad8071-37c2-4c30-86d2-01879fbccfaa");
			put(X_PA_ReportColumn.CALCULATIONTYPE_PercentageOp1OfOp2, "1ee1c801-b264-42b5-b1f6-2ea14ab792da");
			put(X_PA_ReportColumn.CALCULATIONTYPE_AddRangeOp1ToOp2, "1455fb91-3bd5-4f0f-b156-03bb03073ff9");
		}
	};
	public CompletableFuture<MRefList> CalculationType_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> COLUMNTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.COLUMNTYPE_RelativePeriod, "0b9bb902-06aa-469d-82a5-c76ca2931aa9");
			put(X_PA_ReportColumn.COLUMNTYPE_Calculation, "86874133-72ba-4215-bf88-26f3d0cecd16");
			put(X_PA_ReportColumn.COLUMNTYPE_SegmentValue, "f2a870a8-c5c5-4e9a-afdf-e08770b9758f");
		}
	};
	public CompletableFuture<MRefList> ColumnType_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> CURRENCYTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.CURRENCYTYPE_SourceCurrency, "a18c164f-5723-4942-a1c4-fbee8e9367bb");
			put(X_PA_ReportColumn.CURRENCYTYPE_AccountingCurrency, "7d2055f8-02e9-46f1-8217-2340028c7723");
		}
	};
	public CompletableFuture<MRefList> CurrencyType_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> ELEMENTTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.ELEMENTTYPE_Account, "1ce3db23-ba22-4658-a7a3-388e2b83e4ec");
			put(X_PA_ReportColumn.ELEMENTTYPE_Activity, "4cebe278-4b2d-4430-97e2-cb07a3da2065");
			put(X_PA_ReportColumn.ELEMENTTYPE_BPartner, "e0862e7f-7c5c-4f1f-9afd-156bb18d1344");
			put(X_PA_ReportColumn.ELEMENTTYPE_LocationFrom, "11413fc0-e7e2-4d37-b47d-4e485f2a51c7");
			put(X_PA_ReportColumn.ELEMENTTYPE_LocationTo, "9de1cf83-3e27-41f7-b5c6-63906d847d5c");
			put(X_PA_ReportColumn.ELEMENTTYPE_Campaign, "5be39ed1-223b-46ca-99c4-3d7c56b1b306");
			put(X_PA_ReportColumn.ELEMENTTYPE_Organization, "0c36bf24-5a35-4859-9006-279a917b0d7e");
			put(X_PA_ReportColumn.ELEMENTTYPE_OrgTrx, "3de1fe8f-4130-492a-9426-ccff9f1ef9da");
			put(X_PA_ReportColumn.ELEMENTTYPE_Project, "086db93e-bbd8-4ef4-80db-c91f6b6cea77");
			put(X_PA_ReportColumn.ELEMENTTYPE_Product, "9e1a15f5-26c2-4732-b323-dc171adc0b59");
			put(X_PA_ReportColumn.ELEMENTTYPE_SubAccount, "2f271ee7-7a2c-427c-83aa-e44a597aa6dd");
			put(X_PA_ReportColumn.ELEMENTTYPE_SalesRegion, "e9a47662-936e-4a12-93bb-5c2156522beb");
			put(X_PA_ReportColumn.ELEMENTTYPE_UserElementList1, "cde38a17-a4b9-48a5-a4fb-12618a9d1590");
			put(X_PA_ReportColumn.ELEMENTTYPE_UserElementList2, "fb11ce5c-4908-4079-88f9-f4b8a4d1c4d7");
			put(X_PA_ReportColumn.ELEMENTTYPE_UserColumn1, "94eaf88d-d638-4910-92d6-b966d899e13c");
			put(X_PA_ReportColumn.ELEMENTTYPE_UserColumn2, "12ddef97-4164-4434-8874-495cba0b8ec7");
			put(X_PA_ReportColumn.ELEMENTTYPE_Combination, "a852a154-ddbe-43a6-b753-c247521d6bf7");
		}
	};
	public CompletableFuture<MRefList> ElementType_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> FACTOR_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.FACTOR_Thousand, "401c2263-9b2e-4f11-a424-58f9f7a31dd6");
			put(X_PA_ReportColumn.FACTOR_Million, "89f20031-b524-4cd4-a6a1-6c21fe46335a");
		}
	};
	public CompletableFuture<MRefList> Factor_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> PAAMOUNTTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.PAAMOUNTTYPE_BalanceExpectedSign, "7c4060bf-60d8-433d-9536-68b24ac23482");
			put(X_PA_ReportColumn.PAAMOUNTTYPE_CreditOnly, "35749472-d741-46cc-bcfc-78e18981bdd1");
			put(X_PA_ReportColumn.PAAMOUNTTYPE_DebitOnly, "5cef5908-30a5-4bfa-be8c-863602c731cb");
			put(X_PA_ReportColumn.PAAMOUNTTYPE_QuantityExpectedSign, "e940f395-f29e-42c0-860d-b4a6161525ad");
			put(X_PA_ReportColumn.PAAMOUNTTYPE_BalanceAccountedSign, "275d41e4-b6d3-4b96-bee1-054b32174fce");
			put(X_PA_ReportColumn.PAAMOUNTTYPE_QuantityAccountedSign, "f6d19951-ac66-4c69-8626-6252daff15ae");
		}
	};
	public CompletableFuture<MRefList> PAAmountType_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> PAPERIODTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.PAPERIODTYPE_Total, "c674c77f-9cb1-4442-8328-80b476c03aed");
			put(X_PA_ReportColumn.PAPERIODTYPE_Year, "e83324fd-88ac-4482-b0d6-27b734c0c2f2");
			put(X_PA_ReportColumn.PAPERIODTYPE_Period, "a7860462-93bb-4a22-8c5f-25824c6528f7");
			put(X_PA_ReportColumn.PAPERIODTYPE_Natural, "aec483ce-9299-4786-a0cb-a1a851362950");
		}
	};
	public CompletableFuture<MRefList> PAPeriodType_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> POSTINGTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportColumn.POSTINGTYPE_Actual, "3c9d051c-7b7b-459d-90c5-0925e26c1bcc");
			put(X_PA_ReportColumn.POSTINGTYPE_Budget, "07bbb012-66f2-4860-bd6d-dc511618bf4e");
			put(X_PA_ReportColumn.POSTINGTYPE_Commitment, "c40ae7b1-be06-4291-ac88-59974f74a46d");
			put(X_PA_ReportColumn.POSTINGTYPE_Statistical, "6011c5d4-edcc-48f6-ba32-8d820d42dbfb");
			put(X_PA_ReportColumn.POSTINGTYPE_Reservation, "c1e61fc6-ba26-400c-9ae4-716b3c67e1d5");
		}
	};
	public CompletableFuture<MRefList> PostingType_RL(X_PA_ReportColumn entity, DataFetchingEnvironment environment) {
