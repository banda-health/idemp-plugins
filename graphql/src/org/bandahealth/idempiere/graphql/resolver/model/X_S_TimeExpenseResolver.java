...
/**
 * Generated ModelResolver for S_TimeExpense - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_S_TimeExpenseResolver extends POResolver<MTimeExpense> implements GraphQLResolver<MTimeExpense> {
	 ...
	 */
	public CompletableFuture<MBPartner_BH> C_BPartner(MTimeExpense entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocAction(MTimeExpense entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocStatus(MTimeExpense entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsApproved(MTimeExpense entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MPriceList> M_PriceList(MTimeExpense entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MWarehouse_BH> M_Warehouse(MTimeExpense entity, DataFetchingEnvironment environment) {
	...
	public Boolean Processed(MTimeExpense entity, DataFetchingEnvironment environment) {
		return entity.isProcessed();
	}

	public Boolean Processing(MTimeExpense entity, DataFetchingEnvironment environment) {
