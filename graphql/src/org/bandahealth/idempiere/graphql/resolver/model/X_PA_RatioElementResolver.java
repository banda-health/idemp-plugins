...
public class X_PA_RatioElementResolver extends POResolver<X_PA_RatioElement> implements GraphQLResolver<X_PA_RatioElement> {
	...
	public static Map<String, String> RATIOELEMENTTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("R", "11ec6ed4-e9fa-4c96-924b-9a7baedc56fb"); // Ratio
			put("C", "e379a3fa-da0f-4bc8-a3fe-d016f937e92c"); // Constant
			put("X", "025789a9-7fd5-466a-b00e-ce28ef6bc382"); // Calculation
			put("A", "a963fe93-801d-409e-9bfd-866ba80cc05e"); // Account Value
		}
	};
	...
	public static Map<String, String> RATIOOPERAND_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("P", "97e27c57-7ce2-4bf0-9c6e-ed9012ea39d1"); // Plus
			put("N", "ee462114-1054-437f-828a-a71d03bfab55"); // Minus
			put("M", "466f66df-4986-4894-8554-a07998191282"); // Multiply
			put("D", "e137d41c-433d-4cf6-9da0-a3263d2aa5b1"); // Divide
		}
	};
