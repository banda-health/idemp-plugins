...
public class X_M_BP_PriceResolver extends POResolver<X_M_BP_Price> implements GraphQLResolver<X_M_BP_Price> {
	...
	public Boolean IsNetPrice(X_M_BP_Price entity, DataFetchingEnvironment environment) {
		return entity.isNetPrice();
	}
	...
	public CompletableFuture<MRefList_BH> PriceOverrideType(X_M_BP_Price entity, DataFetchingEnvironment environment) {
		if (StringUtil.isNullOrEmpty(entity.getPriceOverrideType())) {
			return null;
		}
