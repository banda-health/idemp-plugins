...
public class X_C_BPartnerResolver extends POResolver<MBPartner_BH> implements GraphQLResolver<MBPartner_BH> {
	...
	public static Map<String, String> BH_GENDER_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("female", "c6cae691-2c3f-43e2-beaa-4d80a196bf34"); // Female
			put("male", "73c2b736-830b-430e-bc43-571c6372ba22"); // Male
		}
	};
	...
	public CompletableFuture<X_C_1099Box> Default1099Box(MBPartner_BH entity, DataFetchingEnvironment environment) {
		if (entity.getDefault1099Box_ID() < 1) {
			return null;
		}
