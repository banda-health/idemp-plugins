...
public class X_PP_Cost_CollectorResolver extends POResolver<X_PP_Cost_Collector> implements GraphQLResolver<X_PP_Cost_Collector> {
	...
	static Map<String, String> COSTCOLLECTORTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PP_Cost_Collector.COSTCOLLECTORTYPE_MaterialReceipt, "6fc51ee8-c1fc-491f-b255-bea65c67c90e");
			put(X_PP_Cost_Collector.COSTCOLLECTORTYPE_ComponentIssue, "5eb1adfa-5acb-4f43-8b8f-6494858ca467");
			put(X_PP_Cost_Collector.COSTCOLLECTORTYPE_UsegeVariance, "b8083980-443f-4d35-bd14-37d73ac6aef0");
			put(X_PP_Cost_Collector.COSTCOLLECTORTYPE_MethodChangeVariance, "9b05daf5-998c-4e51-b248-e338aa732455");
			put(X_PP_Cost_Collector.COSTCOLLECTORTYPE_RateVariance, "e8c88c2a-18e6-4056-a0a5-ececd2a24b73");
			put(X_PP_Cost_Collector.COSTCOLLECTORTYPE_MixVariance, "458e1a27-ce3d-4707-bd78-d7143bbb0837");
			put(X_PP_Cost_Collector.COSTCOLLECTORTYPE_ActivityControl, "bf04263f-d2d6-4403-aa5f-3a7266f4ca11");
		}
	};
	...
	static Map<String, String> DOCACTION_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PP_Cost_Collector.DOCACTION_Complete, "74a9fe55-28e4-4d3b-98aa-02ad6d1a12da");
			put(X_PP_Cost_Collector.DOCACTION_Approve, "f80665a4-0db1-4609-be56-5d69b762d169");
			put(X_PP_Cost_Collector.DOCACTION_Reject, "8fffbfd1-560a-4a78-9181-e5b76bbb3354");
			put(X_PP_Cost_Collector.DOCACTION_Post, "0fe1c0e9-2ca1-48f2-837b-a4ff16c629d9");
			put(X_PP_Cost_Collector.DOCACTION_Void, "930f9be7-85bc-4002-83a6-fe4e1b8cfce3");
			put(X_PP_Cost_Collector.DOCACTION_Close, "d0a6de04-9c59-4d37-998d-f8070db820b0");
			put(X_PP_Cost_Collector.DOCACTION_Reverse_Correct, "597e3e98-f1cd-4157-885a-1fae6424a3a6");
			put(X_PP_Cost_Collector.DOCACTION_Reverse_Accrual, "1a3904b9-86bc-4831-a4af-0281dcafa8f8");
			put(X_PP_Cost_Collector.DOCACTION_Invalidate, "69ff146b-fe0e-44a0-98d1-80b2f7958edf");
			put(X_PP_Cost_Collector.DOCACTION_Re_Activate, "c8f55635-67a3-42ae-b626-2064acb2e260");
			put(X_PP_Cost_Collector.DOCACTION_None, "ea523fb8-e21b-4a77-a657-6f5a7d12a591");
			put(X_PP_Cost_Collector.DOCACTION_Prepare, "b6f04b4b-6034-4490-83ed-d0f4f9cb5f76");
			put(X_PP_Cost_Collector.DOCACTION_Unlock, "b2d93bde-a7e7-43f0-9b1c-82527992f6d5");
			put(X_PP_Cost_Collector.DOCACTION_WaitComplete, "2143c53d-f6a6-4da6-8fe6-4ce4b6dacac0");
		}
	};
	...
	static Map<String, String> DOCSTATUS_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PP_Cost_Collector.DOCSTATUS_Drafted, "d27f8a6b-e8b5-4fea-a6b2-3e7049c473ec");
			put(X_PP_Cost_Collector.DOCSTATUS_Completed, "50702660-bbfc-422a-8acc-5ed3a2dce204");
			put(X_PP_Cost_Collector.DOCSTATUS_Approved, "a838dad1-b7fc-4b26-9d80-d45f2d8484c5");
			put(X_PP_Cost_Collector.DOCSTATUS_NotApproved, "c8c414ee-3e4e-480b-aa0e-bc6c1d100bd2");
			put(X_PP_Cost_Collector.DOCSTATUS_Voided, "d35dfd1d-1eb2-46ef-ab2f-23973d68a570");
			put(X_PP_Cost_Collector.DOCSTATUS_Invalid, "c2d506ba-1916-4ca2-abde-da3127c11d77");
			put(X_PP_Cost_Collector.DOCSTATUS_Reversed, "029a78cf-d45c-4fb2-a6c9-fb92c2311af6");
			put(X_PP_Cost_Collector.DOCSTATUS_Closed, "ab9df095-8aa8-4338-98b6-4b09ab9d459e");
			put(X_PP_Cost_Collector.DOCSTATUS_Unknown, "0b6ed143-fad9-4ba2-824c-b3a89b9bb2d2");
			put(X_PP_Cost_Collector.DOCSTATUS_InProgress, "9f864275-6135-452f-a5a7-9377d9ed32bc");
			put(X_PP_Cost_Collector.DOCSTATUS_WaitingPayment, "4a9871d9-ec70-489f-aca5-05adb7e61df9");
			put(X_PP_Cost_Collector.DOCSTATUS_WaitingConfirmation, "56264c44-b530-4a53-b07b-6fb203ff61a6");
		}
	};
