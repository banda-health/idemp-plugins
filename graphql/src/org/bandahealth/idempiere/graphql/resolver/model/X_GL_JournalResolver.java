...
/**
 * Generated ModelResolver for GL_Journal - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_GL_JournalResolver extends POResolver<MJournal> implements GraphQLResolver<MJournal> {
	...
	public CompletableFuture<MRefList_BH> DocAction(MJournal entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocStatus(MJournal entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsApproved(MJournal entity, DataFetchingEnvironment environment) {
		return entity.isApproved();
	}

	public Boolean IsPrinted(MJournal entity, DataFetchingEnvironment environment) {
		return entity.isPrinted();
	}

	public Boolean Posted(MJournal entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> PostingType(MJournal entity, DataFetchingEnvironment environment) {
	...
	public Boolean Processed(MJournal entity, DataFetchingEnvironment environment) {
		return entity.isProcessed();
	}

	public Boolean Processing(MJournal entity, DataFetchingEnvironment environment) {
