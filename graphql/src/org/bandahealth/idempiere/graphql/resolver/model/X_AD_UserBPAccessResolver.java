...
public class X_AD_UserBPAccessResolver extends POResolver<MUserBPAccess> implements GraphQLResolver<MUserBPAccess> {
	...
	public static Map<String, String> BPACCESSTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("B", "52a99e0f-ab15-43ad-b6de-25a7b499a753"); // Business Documents
			put("R", "7db113da-55af-4657-a097-8a8a5dbb3a63"); // Requests
			put("A", "0be3d84e-b922-48a6-946d-0e9fa151810b"); // Assets, Download
		}
	};
