...
public class X_AD_ViewColumnResolver extends POResolver<MViewColumn> implements GraphQLResolver<MViewColumn> {
	...
	public static Map<String, String> DBDATATYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("B", "da6b3cf4-f719-418f-b395-bbf193b703fa"); // Binary LOB
			put("C", "7db6163c-92ac-4f63-b81f-63277341e5ff"); // Character Fixed
			put("D", "7ffa55a1-6089-45c9-9fbd-9132c134bd18"); // Decimal
			put("I", "1eb7b0f8-23f3-4622-a890-a93410bd0d80"); // Integer
			put("L", "3c799a29-5017-4fc2-9402-0fbf55b198cd"); // Character LOB
			put("N", "7bd0bc54-a940-4afd-98ab-a3011ace6b3f"); // Number
			put("T", "363a5407-0f48-443b-8b78-626ac45b6590"); // Timestamp
			put("V", "ab034a7b-aeba-4bd9-b621-620d67dca79e"); // Character Variable
		}
	};
