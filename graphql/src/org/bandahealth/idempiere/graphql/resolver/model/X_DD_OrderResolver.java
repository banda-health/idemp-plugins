...
/**
 * Generated ModelResolver for DD_Order - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_DD_OrderResolver extends POResolver<MDDOrder> implements GraphQLResolver<MDDOrder> {
	...
	public Boolean IsApproved(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isApproved();
	}

	public Boolean IsDelivered(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isDelivered();
	}

	public Boolean IsDropShip(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isDropShip();
	}

	public Boolean IsInDispute(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isInDispute();
	}

	public Boolean IsInTransit(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isInTransit();
	}

	public Boolean IsPrinted(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isPrinted();
	}

	public Boolean IsSelected(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isSelected();
	}

	public Boolean IsSOTrx(MDDOrder entity, DataFetchingEnvironment environment) {
	...
	public Boolean Posted(MDDOrder entity, DataFetchingEnvironment environment) {
	...
	public Boolean Processed(MDDOrder entity, DataFetchingEnvironment environment) {
		return entity.isProcessed();
	}

	public Boolean Processing(MDDOrder entity, DataFetchingEnvironment environment) {
	...
	public Boolean SendEMail(MDDOrder entity, DataFetchingEnvironment environment) {
