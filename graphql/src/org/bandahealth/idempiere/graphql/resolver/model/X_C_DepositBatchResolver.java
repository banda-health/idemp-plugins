...
public class X_C_DepositBatchResolver extends POResolver<MDepositBatch> implements GraphQLResolver<MDepositBatch> {
	 ...
	 */
	public CompletableFuture<MCurrency_BH> C_Currency(MDepositBatch entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocAction(MDepositBatch entity, DataFetchingEnvironment environment) {
