...
/**
 * Generated ModelResolver for M_Inventory - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 12 - $Id$
 */
public class X_M_InventoryResolver extends POResolver<MInventory_BH> implements GraphQLResolver<MInventory_BH> {


	public static Map<String, String> BH_UPDATE_REASON_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("p_dmg", "315319b8-c274-414c-bb87-6d2d3e9f2acf"); // Damaged products
			put("p_exp", "9070547d-c818-49da-a406-edd3999f9e05"); // Product expired
			put("p_unc", "3dc79710-4a2b-4b58-9c8f-d557cf180c49"); // Products used but not charged
			put("p_los", "044ba1a8-986a-46ec-baf6-4d6efcea1e48"); // Lost or stolen products
	...
	public CompletableFuture<MRefList_BH> CostingMethod(MInventory_BH entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocAction(MInventory_BH entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocStatus(MInventory_BH entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsApproved(MInventory_BH entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<X_M_PerpetualInv> M_PerpetualInv(MInventory_BH entity, DataFetchingEnvironment environment) {
		if (entity.getM_PerpetualInv_ID() < 1) {
			return null;
		}
		DataLoader<Integer, X_M_PerpetualInv> dataLoader =
				environment.getDataLoaderRegistry().getDataLoader(X_M_PerpetualInvDataLoader.DATALOADER_M_PerpetualInv_BY_ID);
		return dataLoader.load(entity.getM_PerpetualInv_ID());
	}
	...
	public Boolean Posted(MInventory_BH entity, DataFetchingEnvironment environment) {
		return entity.isPosted();
	}

	public Boolean Processed(MInventory_BH entity, DataFetchingEnvironment environment) {
		return entity.isProcessed();
	}

	public Boolean Processing(MInventory_BH entity, DataFetchingEnvironment environment) {
