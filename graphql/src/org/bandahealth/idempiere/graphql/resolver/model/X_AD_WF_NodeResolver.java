...
public class X_AD_WF_NodeResolver extends POResolver<X_AD_WF_Node> implements GraphQLResolver<X_AD_WF_Node> {
	...
	public static Map<String, String> DYNPRIORITYUNIT_UUIDS_BY_VALUE = new HashMap<>() {
		{
	...
	public static Map<String, String> EMAILRECIPIENT_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("D", "2cd91171-9693-4710-9b92-b1f7f6660d07"); // Document Owner
			put("B", "e8012ebf-8ec4-4e0d-99c7-1fe01cfd629f"); // Document Business Partner
			put("R", "baf88c37-8379-4722-b228-b1b15858ea00"); // WF Responsible
		}
	};
