...
/**
 * Generated ModelResolver for AD_UserDef_Win - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 12 - $Id$
 */
public class X_AD_UserDef_WinResolver extends POResolver<MUserDefWin> implements GraphQLResolver<MUserDefWin> {
	 ...
	 */
	public CompletableFuture<MLanguage> AD_Language(MUserDefWin entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<X_AD_Role> AD_Role(MUserDefWin entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsDefault(MUserDefWin entity, DataFetchingEnvironment environment) {
		return entity.isDefault();
	}

	public Boolean IsReadOnly(MUserDefWin entity, DataFetchingEnvironment environment) {
		return entity.isReadOnly();
	}

	public Boolean IsUserUpdateable(MUserDefWin entity, DataFetchingEnvironment environment) {
		return entity.isUserUpdateable();
	}
