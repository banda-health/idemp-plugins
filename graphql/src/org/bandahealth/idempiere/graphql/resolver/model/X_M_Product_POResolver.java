...
/**
 * Generated ModelResolver for M_Product_PO - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_M_Product_POResolver extends POResolver<MProductPO_BH> implements GraphQLResolver<MProductPO_BH> {
	...
	public Boolean Discontinued(MProductPO_BH entity, DataFetchingEnvironment environment) {
		return entity.isDiscontinued();
	}

	public Boolean IsCurrentVendor(MProductPO_BH entity, DataFetchingEnvironment environment) {
		return entity.isCurrentVendor();
	}
