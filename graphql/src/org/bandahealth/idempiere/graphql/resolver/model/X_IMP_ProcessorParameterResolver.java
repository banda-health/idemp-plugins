...
public class X_IMP_ProcessorParameterResolver extends POResolver<X_IMP_ProcessorParameter> implements GraphQLResolver<X_IMP_ProcessorParameter> {
	 ...
	 */
	public CompletableFuture<MIMPProcessor> IMP_Processor(X_IMP_ProcessorParameter entity, DataFetchingEnvironment environment) {
		if (entity.getIMP_Processor_ID() < 1) {
			return null;
		}
