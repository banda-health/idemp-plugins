...
public class MInventoryResolver extends X_M_InventoryResolver {
	public CompletableFuture<List<MInventoryLine>> M_InventoryLines(MInventory_BH entity,
			DataFetchingEnvironment environment) {
		DataLoader<String, List<MInventoryLine>> dataLoader = environment.getDataLoaderRegistry()
