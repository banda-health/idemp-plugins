...
public class X_AD_TaskResolver extends POResolver<MTask> implements GraphQLResolver<MTask> {
	...
	static Map<String, String> ACCESSLEVEL_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MTask.ACCESSLEVEL_Organization, "3cc495d2-7e46-4d2d-b8b8-a38bfa97fa60");
			put(MTask.ACCESSLEVEL_ClientPlusOrganization, "b8062c9f-fb7c-4e91-98ec-0a913a3b367f");
			put(MTask.ACCESSLEVEL_SystemOnly, "6e8bdb2d-b494-401c-b586-7d20727b5eab");
			put(MTask.ACCESSLEVEL_All, "04c9829a-008e-4a71-9598-224f770491dc");
			put(MTask.ACCESSLEVEL_SystemPlusClient, "e05482a2-71be-461d-b522-9cda71a9fa5d");
			put(MTask.ACCESSLEVEL_ClientOnly, "391e2c9a-b8e5-43b0-895b-eea914023e59");
		}
	};
	public CompletableFuture<MRefList> AccessLevel_RL(MTask entity, DataFetchingEnvironment environment) {
