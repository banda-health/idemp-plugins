...
public class X_M_AttributeResolver extends POResolver<MAttribute> implements GraphQLResolver<MAttribute> {
	...
	public static Map<String, String> ATTRIBUTEVALUETYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("S", "156e3f9d-3408-4b24-b65e-66cd9c1b2ce2"); // String (max 40)
			put("N", "9af1763b-0bf6-4c9d-8426-c678999ea533"); // Number
