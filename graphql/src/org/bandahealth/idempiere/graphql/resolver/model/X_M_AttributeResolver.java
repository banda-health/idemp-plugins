 ...
 */
public class X_M_AttributeResolver extends POResolver<MAttribute_BH> implements GraphQLResolver<MAttribute_BH> {
	 ...
	 */
	public CompletableFuture<MReference_BH> AD_Reference(MAttribute_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MReference_BH> AD_Reference_Value(MAttribute_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MValRule> AD_Val_Rule(MAttribute_BH entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> AttributeValueType(MAttribute_BH entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsInstanceAttribute(MAttribute_BH entity, DataFetchingEnvironment environment) {
		return entity.isInstanceAttribute();
	}

	public Boolean IsMandatory(MAttribute_BH entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<X_M_AttributeSearch> M_AttributeSearch(MAttribute_BH entity, DataFetchingEnvironment environment) {
