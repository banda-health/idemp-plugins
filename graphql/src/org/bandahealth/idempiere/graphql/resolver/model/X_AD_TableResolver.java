...
public class X_AD_TableResolver extends POResolver<MTable> implements GraphQLResolver<MTable> {
	...
	static Map<String, String> ACCESSLEVEL_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MTable.ACCESSLEVEL_Organization, "3cc495d2-7e46-4d2d-b8b8-a38bfa97fa60");
			put(MTable.ACCESSLEVEL_ClientPlusOrganization, "b8062c9f-fb7c-4e91-98ec-0a913a3b367f");
			put(MTable.ACCESSLEVEL_SystemOnly, "6e8bdb2d-b494-401c-b586-7d20727b5eab");
			put(MTable.ACCESSLEVEL_All, "04c9829a-008e-4a71-9598-224f770491dc");
			put(MTable.ACCESSLEVEL_SystemPlusClient, "e05482a2-71be-461d-b522-9cda71a9fa5d");
			put(MTable.ACCESSLEVEL_ClientOnly, "391e2c9a-b8e5-43b0-895b-eea914023e59");
		}
	};
	...
	static Map<String, String> REPLICATIONTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MTable.REPLICATIONTYPE_Local, "c829969e-9927-491f-89a8-f200b8d29f57");
			put(MTable.REPLICATIONTYPE_Merge, "41211ac8-1137-49f5-9efb-7d8e75682a45");
			put(MTable.REPLICATIONTYPE_Reference, "959a0839-d0f2-43c5-b8da-d0f1fd76d8dd");
			put(MTable.REPLICATIONTYPE_Broadcast, "1be8a931-6954-4fd9-bc76-e67c6f73fc00");
		}
	};
