...
/**
 * Generated ModelResolver for AD_UserDef_Proc - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_AD_UserDef_ProcResolver extends POResolver<MUserDefProc> implements GraphQLResolver<MUserDefProc> {
	 ...
	 */
	public CompletableFuture<MLanguage> AD_Language(MUserDefProc entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<X_AD_Role> AD_Role(MUserDefProc entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsUserUpdateable(MUserDefProc entity, DataFetchingEnvironment environment) {
