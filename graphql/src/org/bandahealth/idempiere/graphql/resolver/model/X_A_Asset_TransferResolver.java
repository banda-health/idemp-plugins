...
public class X_A_Asset_TransferResolver extends POResolver<MAssetTransfer> implements GraphQLResolver<MAssetTransfer> {
	...
	static Map<String, String> A_CAPVSEXP_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MAssetTransfer.A_CAPVSEXP_Capital, "f494c22f-2ce5-471d-aabb-887f528c60da");
			put(MAssetTransfer.A_CAPVSEXP_Expense, "4a84ac91-9720-40a2-8529-6a139dabb96a");
		}
	};
	public CompletableFuture<MRefList> A_CapvsExp_RL(MAssetTransfer entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> DOCACTION_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MAssetTransfer.DOCACTION_Complete, "74a9fe55-28e4-4d3b-98aa-02ad6d1a12da");
			put(MAssetTransfer.DOCACTION_Approve, "f80665a4-0db1-4609-be56-5d69b762d169");
			put(MAssetTransfer.DOCACTION_Reject, "8fffbfd1-560a-4a78-9181-e5b76bbb3354");
			put(MAssetTransfer.DOCACTION_Post, "0fe1c0e9-2ca1-48f2-837b-a4ff16c629d9");
			put(MAssetTransfer.DOCACTION_Void, "930f9be7-85bc-4002-83a6-fe4e1b8cfce3");
			put(MAssetTransfer.DOCACTION_Close, "d0a6de04-9c59-4d37-998d-f8070db820b0");
			put(MAssetTransfer.DOCACTION_Reverse_Correct, "597e3e98-f1cd-4157-885a-1fae6424a3a6");
			put(MAssetTransfer.DOCACTION_Reverse_Accrual, "1a3904b9-86bc-4831-a4af-0281dcafa8f8");
			put(MAssetTransfer.DOCACTION_Invalidate, "69ff146b-fe0e-44a0-98d1-80b2f7958edf");
			put(MAssetTransfer.DOCACTION_Re_Activate, "c8f55635-67a3-42ae-b626-2064acb2e260");
			put(MAssetTransfer.DOCACTION_None, "ea523fb8-e21b-4a77-a657-6f5a7d12a591");
			put(MAssetTransfer.DOCACTION_Prepare, "b6f04b4b-6034-4490-83ed-d0f4f9cb5f76");
			put(MAssetTransfer.DOCACTION_Unlock, "b2d93bde-a7e7-43f0-9b1c-82527992f6d5");
			put(MAssetTransfer.DOCACTION_WaitComplete, "2143c53d-f6a6-4da6-8fe6-4ce4b6dacac0");
		}
	};
	public CompletableFuture<MRefList> DocAction_RL(MAssetTransfer entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> DOCSTATUS_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MAssetTransfer.DOCSTATUS_Drafted, "d27f8a6b-e8b5-4fea-a6b2-3e7049c473ec");
			put(MAssetTransfer.DOCSTATUS_Completed, "50702660-bbfc-422a-8acc-5ed3a2dce204");
			put(MAssetTransfer.DOCSTATUS_Approved, "a838dad1-b7fc-4b26-9d80-d45f2d8484c5");
			put(MAssetTransfer.DOCSTATUS_NotApproved, "c8c414ee-3e4e-480b-aa0e-bc6c1d100bd2");
			put(MAssetTransfer.DOCSTATUS_Voided, "d35dfd1d-1eb2-46ef-ab2f-23973d68a570");
			put(MAssetTransfer.DOCSTATUS_Invalid, "c2d506ba-1916-4ca2-abde-da3127c11d77");
			put(MAssetTransfer.DOCSTATUS_Reversed, "029a78cf-d45c-4fb2-a6c9-fb92c2311af6");
			put(MAssetTransfer.DOCSTATUS_Closed, "ab9df095-8aa8-4338-98b6-4b09ab9d459e");
			put(MAssetTransfer.DOCSTATUS_Unknown, "0b6ed143-fad9-4ba2-824c-b3a89b9bb2d2");
			put(MAssetTransfer.DOCSTATUS_InProgress, "9f864275-6135-452f-a5a7-9377d9ed32bc");
			put(MAssetTransfer.DOCSTATUS_WaitingPayment, "4a9871d9-ec70-489f-aca5-05adb7e61df9");
			put(MAssetTransfer.DOCSTATUS_WaitingConfirmation, "56264c44-b530-4a53-b07b-6fb203ff61a6");
		}
	};
	public CompletableFuture<MRefList> DocStatus_RL(MAssetTransfer entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> POSTED_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MAssetTransfer.POSTED_NotPosted, "f8a3fa32-e816-46b0-8ffa-8f75a9a6f8ce");
			put(MAssetTransfer.POSTED_Posted, "238cfb09-41c2-43ef-81d3-785f45e69eff");
			put(MAssetTransfer.POSTED_NotBalanced, "b356ec40-2b7c-45bd-ae61-5f62875b41ac");
			put(MAssetTransfer.POSTED_NotConvertibleNoRate, "1e0390a8-f7be-4e8b-bd9a-e7c56913f39d");
			put(MAssetTransfer.POSTED_PeriodClosed, "4afac137-c9db-4bbc-ac61-b0c642f7807e");
			put(MAssetTransfer.POSTED_PostPrepared, "b2188064-c2e1-4319-8d1d-59145d49842b");
			put(MAssetTransfer.POSTED_InvalidAccount, "3bd142e3-e397-42b9-ac64-b2c98d970426");
			put(MAssetTransfer.POSTED_PostingError, "bd259a9b-d9a3-4396-ae5c-124968ae3f4d");
			put(MAssetTransfer.POSTED_Deferred, "0630b5d2-0fe4-4ef8-9d2f-a14791c02c7d");
		}
	};
	public CompletableFuture<MRefList> Posted_RL(MAssetTransfer entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> POSTINGTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MAssetTransfer.POSTINGTYPE_Actual, "3c9d051c-7b7b-459d-90c5-0925e26c1bcc");
			put(MAssetTransfer.POSTINGTYPE_Budget, "07bbb012-66f2-4860-bd6d-dc511618bf4e");
			put(MAssetTransfer.POSTINGTYPE_Commitment, "c40ae7b1-be06-4291-ac88-59974f74a46d");
			put(MAssetTransfer.POSTINGTYPE_Statistical, "6011c5d4-edcc-48f6-ba32-8d820d42dbfb");
			put(MAssetTransfer.POSTINGTYPE_Reservation, "c1e61fc6-ba26-400c-9ae4-716b3c67e1d5");
		}
	};
	public CompletableFuture<MRefList> PostingType_RL(MAssetTransfer entity, DataFetchingEnvironment environment) {
