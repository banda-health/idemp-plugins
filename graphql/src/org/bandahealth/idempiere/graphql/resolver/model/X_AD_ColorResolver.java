...
public class X_AD_ColorResolver extends POResolver<MColor> implements GraphQLResolver<MColor> {
	...
	static Map<String, String> COLORTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MColor.COLORTYPE_NormalFlat, "88532852-a8ee-4d5b-ba71-1d7d9cccba52");
			put(MColor.COLORTYPE_Gradient, "4c7701f0-6634-42d0-b099-eceb09c71cc0");
			put(MColor.COLORTYPE_Line, "a1f7e2d9-ca8d-4570-ae2b-389eb3da0fb6");
			put(MColor.COLORTYPE_TexturePicture, "5fb3957b-a5bc-4b9d-93a1-a61da4d990e4");
		}
	};
	...
	static Map<String, String> STARTPOINT_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MColor.STARTPOINT_North, "5ffafd53-f087-438c-909e-e51b2183df07");
			put(MColor.STARTPOINT_NorthEast, "d738f8db-037f-4a83-898a-6d25fa8c3a58");
			put(MColor.STARTPOINT_East, "77df7a8c-39b7-4bd3-9b69-d21c05820b37");
			put(MColor.STARTPOINT_SouthEast, "c0ac335d-bc7e-4273-b70c-c98cdd97320b");
			put(MColor.STARTPOINT_South, "70492ef3-423f-49ae-882f-3a8b3a92ba7a");
			put(MColor.STARTPOINT_SouthWest, "8e961acb-4533-40a4-820a-e4e4ac5ea83a");
			put(MColor.STARTPOINT_West, "b08af11e-8671-49a9-93dd-048bb1ea3c49");
			put(MColor.STARTPOINT_NorthWest, "b37ca5ca-7313-4f43-9f00-12c2b8a77f2c");
		}
	};
