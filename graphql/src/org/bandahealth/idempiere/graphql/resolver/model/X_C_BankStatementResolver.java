...
public class X_C_BankStatementResolver extends POResolver<MBankStatement> implements GraphQLResolver<MBankStatement> {
	 ...
	 */
	public CompletableFuture<MBankAccount_BH> C_BankAccount(MBankStatement entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocAction(MBankStatement entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocStatus(MBankStatement entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsApproved(MBankStatement entity, DataFetchingEnvironment environment) {
		return entity.isApproved();
	}

	public Boolean IsManual(MBankStatement entity, DataFetchingEnvironment environment) {
		return entity.isManual();
	}

	public Boolean Posted(MBankStatement entity, DataFetchingEnvironment environment) {
		return entity.isPosted();
	}

	public Boolean Processed(MBankStatement entity, DataFetchingEnvironment environment) {
		return entity.isProcessed();
	}

	public Boolean Processing(MBankStatement entity, DataFetchingEnvironment environment) {
