...
public class X_AD_ChartResolver extends POResolver<MChart> implements GraphQLResolver<MChart> {
	...
	static Map<String, String> CHARTORIENTATION_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("H", "e4c14bf1-2522-4d47-9469-ea261017054f");
	...
	static Map<String, String> CHARTTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("AC", "4d29bcff-81fc-4a8a-8844-2708847eeed2");
			put("BC", "bfeb4548-7b52-4847-9b56-7529cba194f4");
			put("AS", "53310de6-2cfd-4cee-bd1a-298e77c5ed9a");
			put("B3", "320eebfe-6011-42ce-9698-70bdb8f239fe");
			put("BS", "22572bc7-d1f9-45b0-9adf-5bab4beae5b3");
			put("B4", "272e8091-1706-49c2-af6a-d45b6f23d1ef");
			put("LC", "65f73a60-e27d-4f9b-a6f1-6d32ee8b7bd3");
			put("L3", "d9cae711-0fdd-4de5-b77e-b9a74ea818f1");
			put("WC", "4ae68689-3f5f-4ba4-b0c8-ec9c3c610986");
			put("PC", "622a1d59-28ed-484c-a6e4-1e01443c2a81");
			put("P3", "2070043c-07b7-4f82-8f06-9c7d19ff0d20");
	...
	static Map<String, String> TIMEUNIT_UUIDS_BY_VALUE = new HashMap<>() {
		{
			...
			put("W", "21157769-4f20-454a-b333-6336e1af19e8");
			put("M", "8861af0f-d610-4aa7-9644-b61a47f67b53");
			put("Q", "93cc1101-b9be-4cc2-a500-09f1c15780b7");
