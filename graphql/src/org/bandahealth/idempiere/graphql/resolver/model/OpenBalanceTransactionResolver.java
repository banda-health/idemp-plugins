...
public class OpenBalanceTransactionResolver implements GraphQLResolver<OpenBalanceTransaction> {

	public CompletableFuture<MBHVisit> BH_Visit(OpenBalanceTransaction entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MBPartner_BH> C_BPartner(OpenBalanceTransaction entity,
	...
	public CompletableFuture<MInvoice_BH> C_Invoice(OpenBalanceTransaction entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MPayment_BH> C_Payment(OpenBalanceTransaction entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MUser_BH> CreatedBy(OpenBalanceTransaction Entity, DataFetchingEnvironment environment) {
