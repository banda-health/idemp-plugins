...
public class X_PA_ReportSourceResolver extends POResolver<X_PA_ReportSource> implements GraphQLResolver<X_PA_ReportSource> {
	...
	static Map<String, String> ELEMENTTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_PA_ReportSource.ELEMENTTYPE_Account, "1ce3db23-ba22-4658-a7a3-388e2b83e4ec");
			put(X_PA_ReportSource.ELEMENTTYPE_Activity, "4cebe278-4b2d-4430-97e2-cb07a3da2065");
			put(X_PA_ReportSource.ELEMENTTYPE_BPartner, "e0862e7f-7c5c-4f1f-9afd-156bb18d1344");
			put(X_PA_ReportSource.ELEMENTTYPE_LocationFrom, "11413fc0-e7e2-4d37-b47d-4e485f2a51c7");
			put(X_PA_ReportSource.ELEMENTTYPE_LocationTo, "9de1cf83-3e27-41f7-b5c6-63906d847d5c");
			put(X_PA_ReportSource.ELEMENTTYPE_Campaign, "5be39ed1-223b-46ca-99c4-3d7c56b1b306");
			put(X_PA_ReportSource.ELEMENTTYPE_Organization, "0c36bf24-5a35-4859-9006-279a917b0d7e");
			put(X_PA_ReportSource.ELEMENTTYPE_OrgTrx, "3de1fe8f-4130-492a-9426-ccff9f1ef9da");
			put(X_PA_ReportSource.ELEMENTTYPE_Project, "086db93e-bbd8-4ef4-80db-c91f6b6cea77");
			put(X_PA_ReportSource.ELEMENTTYPE_Product, "9e1a15f5-26c2-4732-b323-dc171adc0b59");
			put(X_PA_ReportSource.ELEMENTTYPE_SubAccount, "2f271ee7-7a2c-427c-83aa-e44a597aa6dd");
			put(X_PA_ReportSource.ELEMENTTYPE_SalesRegion, "e9a47662-936e-4a12-93bb-5c2156522beb");
			put(X_PA_ReportSource.ELEMENTTYPE_UserElementList1, "cde38a17-a4b9-48a5-a4fb-12618a9d1590");
			put(X_PA_ReportSource.ELEMENTTYPE_UserElementList2, "fb11ce5c-4908-4079-88f9-f4b8a4d1c4d7");
			put(X_PA_ReportSource.ELEMENTTYPE_UserColumn1, "94eaf88d-d638-4910-92d6-b966d899e13c");
			put(X_PA_ReportSource.ELEMENTTYPE_UserColumn2, "12ddef97-4164-4434-8874-495cba0b8ec7");
			put(X_PA_ReportSource.ELEMENTTYPE_Combination, "a852a154-ddbe-43a6-b753-c247521d6bf7");
		}
	};
