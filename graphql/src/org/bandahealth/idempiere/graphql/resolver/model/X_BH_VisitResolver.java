...
public class X_BH_VisitResolver extends POResolver<MBHVisit> implements GraphQLResolver<MBHVisit> {
	...
	static Map<String, String> BH_PATIENTTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("O", "0a48b24a-8c67-4067-beb5-4eb3bc7daeb1");
			put("I", "46d397b3-103d-4663-86b2-27e395dd158d");
			put("A", "3ce6d10d-8c9c-4e4d-b7ff-67abe9da58a1");
			put("Im", "3cbeb14f-10db-4e32-9b85-e3463eb620b8");
			put("M", "4fa370d8-d02f-4506-91b9-9f06c2e00baf");
			put("D", "1841d957-db04-4640-af15-811a12deb7e4");
			put("E", "1e8a9ec6-0f1e-4fac-8085-593ebeec9d44");
			put("S", "74d58aed-2017-47bc-94f0-9a20c7b208a2");
			put("ot", "6ba8938f-3337-4224-be0b-0cbcd3c606ad");
			put("z", "6403b016-5628-4612-a7a1-00e68e3dd0ae");
			put("y", "1cbfa54e-47ba-4d7b-ada0-119ac3404767");
			put("x", "65ef5222-ed10-4764-b516-a9874ef56519");
	...
	static Map<String, String> BH_REFERRAL_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("hf", "d8a8e37e-18ff-4445-9469-775eea1408e4");
			put("OHF", "bffef4a3-34ef-4af3-9cf5-8471bfda5cd7");
			put("fcu", "4274fce2-29b8-4e4f-a58e-dd77ec039f53");
