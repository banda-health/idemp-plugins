...
public class X_AD_ReferenceResolver extends POResolver<MReference_BH> implements GraphQLResolver<MReference_BH> {
	...
	static Map<String, String> VALIDATIONTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MReference_BH.VALIDATIONTYPE_ListValidation, "6fd23c6a-c10e-4b49-9c48-becb3f819527");
			put(MReference_BH.VALIDATIONTYPE_DataType, "b5ced8c7-63e7-453b-a0f7-678aa6eff4aa");
			put(MReference_BH.VALIDATIONTYPE_TableValidation, "3acb50b1-a8c9-4754-a52e-5e3d427a4fa8");
		}
	};
	public CompletableFuture<MRefList> ValidationType_RL(MReference_BH entity, DataFetchingEnvironment environment) {
