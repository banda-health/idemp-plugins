...
public class X_C_PaymentProcessorResolver extends POResolver<MPaymentProcessor> implements GraphQLResolver<MPaymentProcessor> {
	...
	static Map<String, String> TRXTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(MPaymentProcessor.TRXTYPE_Sales, "62ede000-ce9c-48fd-b805-24dfa336bef6");
			put(MPaymentProcessor.TRXTYPE_DelayedCapture, "65ae32d1-fb46-4b5c-8b6e-ca692bc9071f");
			put(MPaymentProcessor.TRXTYPE_CreditPayment, "3ec6abf2-3776-4bc6-b0ad-e26a805e8fa4");
			put(MPaymentProcessor.TRXTYPE_VoiceAuthorization, "fa969983-3f23-444e-bb5b-91e584657242");
			put(MPaymentProcessor.TRXTYPE_Authorization, "d70a8f1d-2bdc-4aee-b07c-831aae57eb30");
			put(MPaymentProcessor.TRXTYPE_Void, "0778d779-1c5a-47eb-b68e-c94771517f0f");
		}
	};
