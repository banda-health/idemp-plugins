...
public class X_M_InOutConfirmResolver extends POResolver<MInOutConfirm> implements GraphQLResolver<MInOutConfirm> {
	...
	static Map<String, String> CONFIRMTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("XV", "2a49382c-445e-4946-bd65-2d21333e3b0d");
			put("XC", "ddc9bca3-6d9d-4a2e-adc4-49167828de37");
			put("DS", "e7a9ea6a-6204-4ddd-8810-204fe5ffef08");
			put("SC", "c296467e-164b-425a-b3c5-e4a4e4982990");
			put("PC", "b12518be-012d-40a8-8e19-32996a4f812e");
		}
	};
