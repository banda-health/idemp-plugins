...
/**
 * Generated ModelResolver for M_InOutConfirm - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 13 - $Id$
 */
public class X_M_InOutConfirmResolver extends POResolver<MInOutConfirm> implements GraphQLResolver<MInOutConfirm> {
	...
	public static Map<String, String> CONFIRMTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("XV", "2a49382c-445e-4946-bd65-2d21333e3b0d"); // Vendor Confirmation
			put("XC", "ddc9bca3-6d9d-4a2e-adc4-49167828de37"); // Customer Confirmation
			put("DS", "e7a9ea6a-6204-4ddd-8810-204fe5ffef08"); // Drop Ship Confirm
			put("SC", "c296467e-164b-425a-b3c5-e4a4e4982990"); // Ship/Receipt Confirm
			put("PC", "b12518be-012d-40a8-8e19-32996a4f812e"); // Pick/QA Confirm
		}
	};
	public CompletableFuture<MRefList_BH> ConfirmType(MInOutConfirm entity, DataFetchingEnvironment environment) {
		if (StringUtil.isNullOrEmpty(entity.getConfirmType())) {
			return null;
		}
		DataLoader<String, MRefList_BH> dataLoader =
				environment.getDataLoaderRegistry().getDataLoader(X_AD_Ref_ListDataLoader.DATALOADER_AD_Ref_List_BY_UUID);
		return dataLoader.load(CONFIRMTYPE_UUIDS_BY_VALUE.get(entity.getConfirmType()));
	}
	...
	public CompletableFuture<MRefList_BH> DocAction(MInOutConfirm entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocStatus(MInOutConfirm entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsApproved(MInOutConfirm entity, DataFetchingEnvironment environment) {
		return entity.isApproved();
	}

	public Boolean IsCancelled(MInOutConfirm entity, DataFetchingEnvironment environment) {
		return entity.isCancelled();
	}

	public Boolean IsInDispute(MInOutConfirm entity, DataFetchingEnvironment environment) {
	...
	public Boolean Processed(MInOutConfirm entity, DataFetchingEnvironment environment) {
		return entity.isProcessed();
	}

	public Boolean Processing(MInOutConfirm entity, DataFetchingEnvironment environment) {
