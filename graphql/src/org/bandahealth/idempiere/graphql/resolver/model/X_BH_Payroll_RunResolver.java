...
/**
 * Generated ModelResolver for BH_Payroll_Run - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 12 - $Id$
 */
public class X_BH_Payroll_RunResolver extends POResolver<MBHPayrollRun> implements GraphQLResolver<MBHPayrollRun> {
	...
	public CompletableFuture<MRefList_BH> DocAction(MBHPayrollRun entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocStatus(MBHPayrollRun entity, DataFetchingEnvironment environment) {
	...
	public Boolean Processed(MBHPayrollRun entity, DataFetchingEnvironment environment) {
