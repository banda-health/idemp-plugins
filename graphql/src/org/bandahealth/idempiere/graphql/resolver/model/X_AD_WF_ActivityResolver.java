...
public class X_AD_WF_ActivityResolver extends POResolver<X_AD_WF_Activity> implements GraphQLResolver<X_AD_WF_Activity> {
	 ...
	 */
	public CompletableFuture<MMessage_BH> AD_Message(X_AD_WF_Activity entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<MUser_BH> AD_User(X_AD_WF_Activity entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<X_AD_WF_Node> AD_WF_Node(X_AD_WF_Activity entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<X_AD_WF_Process> AD_WF_Process(X_AD_WF_Activity entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<X_AD_WF_Responsible> AD_WF_Responsible(X_AD_WF_Activity entity, DataFetchingEnvironment environment) {
	 ...
	 */
	public CompletableFuture<X_AD_Workflow> AD_Workflow(X_AD_WF_Activity entity, DataFetchingEnvironment environment) {
	...
	static Map<String, String> WFSTATE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put(X_AD_WF_Activity.WFSTATE_NotStarted, "79c0657d-e1c1-4662-8580-1819db98c456");
			put(X_AD_WF_Activity.WFSTATE_Running, "6f40ec26-7f2b-48af-b711-2711462d14a2");
			put(X_AD_WF_Activity.WFSTATE_Suspended, "5fa1df1a-94c6-4a25-b845-3778646130ef");
			put(X_AD_WF_Activity.WFSTATE_Completed, "e622243a-7242-417c-a8fb-c167a1dbecfd");
			put(X_AD_WF_Activity.WFSTATE_Aborted, "89ddf7c1-385d-4590-85c7-728e1c33016b");
			put(X_AD_WF_Activity.WFSTATE_Terminated, "1f8d557d-9955-4285-aa92-d098d5ed7ca9");
		}
	};
