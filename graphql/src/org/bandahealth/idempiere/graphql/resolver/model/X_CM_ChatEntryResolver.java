...
public class X_CM_ChatEntryResolver extends POResolver<MChatEntry> implements GraphQLResolver<MChatEntry> {
	...
	static Map<String, String> CHATENTRYTYPE_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("W", "afbefe8f-d3da-4c6b-b600-392ed0314198");
			put("N", "a4d64cd0-5449-4916-bd90-205c85560cf0");
			put("F", "48206093-4e04-44bd-b00c-adc1d38ebb4c");
		}
	};
	...
	static Map<String, String> MODERATORSTATUS_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("N", "3db5a09c-6691-45e3-9e96-b5d1177bfddb");
			put("P", "a19e1d0d-4969-466f-af73-4c6ecab3e86b");
			put("R", "f5b46f16-69d2-42c4-9525-26431a486056");
			put("S", "9218908f-fb7d-4b1e-8fac-4ee7796cc8c9");
		}
	};
