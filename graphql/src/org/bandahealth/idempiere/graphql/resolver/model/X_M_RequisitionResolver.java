...
/**
 * Generated ModelResolver for M_Requisition - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_M_RequisitionResolver extends POResolver<MRequisition> implements GraphQLResolver<MRequisition> {
	 ...
	 */
	public CompletableFuture<MDocType_BH> C_DocType(MRequisition entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocAction(MRequisition entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> DocStatus(MRequisition entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsApproved(MRequisition entity, DataFetchingEnvironment environment) {
	...
	public Boolean Posted(MRequisition entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> PriorityRule(MRequisition entity, DataFetchingEnvironment environment) {
	...
	public Boolean Processed(MRequisition entity, DataFetchingEnvironment environment) {
		return entity.isProcessed();
	}

	public Boolean Processing(MRequisition entity, DataFetchingEnvironment environment) {
