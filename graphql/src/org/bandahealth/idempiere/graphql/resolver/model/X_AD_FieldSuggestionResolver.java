...
/**
 * Generated ModelResolver for AD_FieldSuggestion - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_AD_FieldSuggestionResolver extends POResolver<MFieldSuggestion> implements GraphQLResolver<MFieldSuggestion> {
	 ...
	 */
	public CompletableFuture<MLanguage> AD_Language(MFieldSuggestion entity, DataFetchingEnvironment environment) {
	...
	public CompletableFuture<MRefList_BH> FieldSuggestionTarget(MFieldSuggestion entity, DataFetchingEnvironment environment) {
		if (StringUtil.isNullOrEmpty(entity.getFieldSuggestionTarget())) {
			return null;
		}
	...
	public Boolean IsApproved(MFieldSuggestion entity, DataFetchingEnvironment environment) {
		return entity.isApproved();
	}

	public Boolean IsUpdateBaseLanguage(MFieldSuggestion entity, DataFetchingEnvironment environment) {
		return entity.isUpdateBaseLanguage();
	}

	public Boolean Processed(MFieldSuggestion entity, DataFetchingEnvironment environment) {
