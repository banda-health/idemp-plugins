...
public class X_C_OnlineTrxHistoryResolver extends POResolver<MOnlineTrxHistory> implements GraphQLResolver<MOnlineTrxHistory> {
	 ...
	 */
	public CompletableFuture<MTable_BH> AD_Table(MOnlineTrxHistory entity, DataFetchingEnvironment environment) {
	...
	public Boolean IsError(MOnlineTrxHistory entity, DataFetchingEnvironment environment) {
		return entity.isError();
	}

	public Boolean Processed(MOnlineTrxHistory entity, DataFetchingEnvironment environment) {
