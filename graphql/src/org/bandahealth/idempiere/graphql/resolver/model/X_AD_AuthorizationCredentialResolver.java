...
public class X_AD_AuthorizationCredentialResolver extends POResolver<MAuthorizationCredential> implements GraphQLResolver<MAuthorizationCredential> {
	...
	static Map<String, String> AD_AUTHORIZATIONSCOPELIST_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("Calendar", "2d70e5ab-b291-44dc-b610-e4de4170e635");
			put("EMail", "d104581f-ad0b-41f2-9922-174d8e27487a");
			put("Document", "b2c69b9e-c59d-4bec-8b2d-d871047a0904");
			put("Profile", "2961bff8-d875-4b01-84f2-1f311b41a15f");
			put("Storage", "df766e64-dad7-4970-a026-fa759e4de151");
		}
	};
