...
public class X_C_PeriodControlResolver extends POResolver<MPeriodControl> implements GraphQLResolver<MPeriodControl> {
	...
	public static Map<String, String> PERIODACTION_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("O", "2d220135-09be-48c5-a90c-40e44d71cd71"); // Open Period
			put("C", "6beb259f-6741-426f-a76e-5f76578d1710"); // Close Period
			put("P", "019e9f60-00b1-4610-9be6-a23e1527d0a5"); // Permanently Close Period
			put("N", "6d8d0aae-1aa8-4566-b719-17be55dbfd30"); // <No Action>
			put("D", "115de309-7e7b-42a0-873b-7acf400d3ac3"); // Document Close Period
		}
	};
	...
	public static Map<String, String> PERIODSTATUS_UUIDS_BY_VALUE = new HashMap<>() {
		{
			put("O", "22753496-ce7b-4cb2-8aa4-63ae48a20f4c"); // Open
			put("C", "70c7284e-a6de-41b1-b9b0-fc21b6b24ea2"); // Closed
			put("P", "1372bf72-0e91-496b-b554-e2aeaa58cd1a"); // Permanently closed
			put("N", "83b5a615-686a-4ea2-a87c-dffd45b89c26"); // Never opened
			put("D", "948b0299-f812-4fc7-92b8-9063f7deae6d"); // Document closed
		}
	};
