...
public class X_PP_Order_Node_ProductQuery extends POQuery<X_PP_Order_Node_Product> implements GraphQLQueryResolver {
	...
	public CompletableFuture<X_PP_Order_Node_Product> PP_Order_Node_Product(String UU, DataFetchingEnvironment environment) {
		DataLoader<String, X_PP_Order_Node_Product> dataLoader = environment.getDataLoaderRegistry()
				.getDataLoader(X_PP_Order_Node_ProductDataLoader.DATALOADER_PP_Order_Node_Product_BY_UUID);
