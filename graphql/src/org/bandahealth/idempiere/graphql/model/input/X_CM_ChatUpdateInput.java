...
public class X_CM_ChatUpdateInput extends X_CM_ChatUpdate implements I_CM_ChatUpdateInput {
	 ...
	 *
	 * @param UUID The CM_ChatUpdate_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_CM_ChatUpdateInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_CM_ChatUpdate(null, (ResultSet) null, null),
