...
public class X_A_Asset_ClassInput extends MAssetClass implements I_A_Asset_ClassInput {
	 ...
	 */
	@JsonCreator
	public X_A_Asset_ClassInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MAssetClass(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	/**
