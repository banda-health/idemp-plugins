...
public class X_C_LandedCostAllocationInput extends MLandedCostAllocation implements I_C_LandedCostAllocationInput {
	 ...
	 */
	@JsonCreator
	public X_C_LandedCostAllocationInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MLandedCostAllocation(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setID(String ID) {
		setC_LandedCostAllocation_UU(ID);
	}
	 ...
	 */
	public String getID() {
		return getC_LandedCostAllocation_UU();
	}
