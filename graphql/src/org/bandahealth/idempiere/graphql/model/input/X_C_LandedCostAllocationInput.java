...
public class X_C_LandedCostAllocationInput extends MLandedCostAllocation implements I_C_LandedCostAllocationInput {
	 ...
	 *
	 * @param UU The C_LandedCostAllocation_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_LandedCostAllocationInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setC_LandedCostAllocation_UU(UU);
	}
