...
public class X_C_CountryGroupInput extends MCountryGroup implements I_C_CountryGroupInput {
	 ...
	 */
	@JsonCreator
	public X_C_CountryGroupInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MCountryGroup(null, (ResultSet) null, null),
