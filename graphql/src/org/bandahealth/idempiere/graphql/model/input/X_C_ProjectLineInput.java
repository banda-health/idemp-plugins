...
public class X_C_ProjectLineInput extends MProjectLine implements I_C_ProjectLineInput {
	 ...
	 *
	 * @param UU The C_ProjectLine_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_ProjectLineInput(@JsonProperty("UU") String UU) {
	...
	public void setC_OrderPOInput(ForeignEntityInput C_OrderPO) {
		...
		if (C_OrderPO != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table C_Order with UU " + C_OrderPO.getUU());
			}
		} else {
