...
public class X_AD_ImpFormatInput extends X_AD_ImpFormat implements I_AD_ImpFormatInput {
	 ...
	 */
	@JsonCreator
	public X_AD_ImpFormatInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_ImpFormat(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	/**
	...
	public void setFormatTypeInput(I_AD_Ref_ListInput FormatType) {
		...
		if (FormatType != null &&
				(foreignEntity = new Query(getCtx(), MRefList_BH.Table_Name, MRefList_BH.COLUMNNAME_AD_Ref_List_UU + "=?", get_TrxName())
						.setParameters(FormatType.getID())
						.first()) != null && foreignEntity.get_ID() != 0) {
