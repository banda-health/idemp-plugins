...
public class X_M_DistributionListInput extends MDistributionList implements I_M_DistributionListInput {
	 ...
	 *
	 * @param UU The M_DistributionList_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_DistributionListInput(@JsonProperty("UU") String UU) {
