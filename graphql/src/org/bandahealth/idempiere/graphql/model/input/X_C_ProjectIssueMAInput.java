...
public class X_C_ProjectIssueMAInput extends X_C_ProjectIssueMA implements I_C_ProjectIssueMAInput {
	 ...
	 */
	@JsonCreator
	public X_C_ProjectIssueMAInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_C_ProjectIssueMA(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
