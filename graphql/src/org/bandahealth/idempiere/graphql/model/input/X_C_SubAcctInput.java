...
public class X_C_SubAcctInput extends X_C_SubAcct implements I_C_SubAcctInput {
	 ...
	 *
	 * @param UUID The C_SubAcct_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_SubAcctInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_SubAcct(null, (ResultSet) null, null),
