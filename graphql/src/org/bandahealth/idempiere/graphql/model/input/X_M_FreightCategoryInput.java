...
public class X_M_FreightCategoryInput extends MFreightCategory implements I_M_FreightCategoryInput {
	 ...
	 */
	@JsonCreator
	public X_M_FreightCategoryInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MFreightCategory(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
