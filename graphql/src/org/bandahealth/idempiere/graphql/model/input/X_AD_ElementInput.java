...
public class X_AD_ElementInput extends M_Element implements I_AD_ElementInput {
	 ...
	 */
	@JsonCreator
	public X_AD_ElementInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new M_Element(null, (ResultSet) null, null),
