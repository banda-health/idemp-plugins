...
public class X_R_StandardResponseInput extends X_R_StandardResponse implements I_R_StandardResponseInput {
	 ...
	 *
	 * @param UU The R_StandardResponse_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_R_StandardResponseInput(@JsonProperty("UU") String UU) {
