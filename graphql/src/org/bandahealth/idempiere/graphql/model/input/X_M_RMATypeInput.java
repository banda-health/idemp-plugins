...
public class X_M_RMATypeInput extends X_M_RMAType implements I_M_RMATypeInput {
	 ...
	 *
	 * @param UUID The M_RMAType_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_RMATypeInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_RMAType(null, (ResultSet) null, null),
