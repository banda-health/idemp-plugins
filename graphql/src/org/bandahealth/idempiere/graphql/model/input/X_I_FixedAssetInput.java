...
import org.bandahealth.idempiere.graphql.resolver.model.X_I_FixedAssetResolver;
...
public class X_I_FixedAssetInput extends MIFixedAsset implements I_I_FixedAssetInput {
	 ...
	 *
	 * @param UU The I_FixedAsset_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_I_FixedAssetInput(@JsonProperty("UU") String UU) {
	...
	public void setDocActionInput(ForeignEntityInput DocAction) {
		...
		if (DocAction != null) {
			...
			if (!X_I_FixedAssetResolver.DOCACTION_UUIDS_BY_VALUE.containsValue(DocAction.getUU())) {
