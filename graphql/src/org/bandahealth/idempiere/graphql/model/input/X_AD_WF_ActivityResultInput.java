...
public class X_AD_WF_ActivityResultInput extends X_AD_WF_ActivityResult implements I_AD_WF_ActivityResultInput {
	 ...
	 *
	 * @param UUID The AD_WF_ActivityResult_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_WF_ActivityResultInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_WF_ActivityResult(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setAD_WF_ActivityResult_UU(UUID);
	}
