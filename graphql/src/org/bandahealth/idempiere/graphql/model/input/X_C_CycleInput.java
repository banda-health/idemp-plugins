...
public class X_C_CycleInput extends X_C_Cycle implements I_C_CycleInput {
	 ...
	 *
	 * @param UUID The C_Cycle_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_CycleInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_Cycle(null, (ResultSet) null, null),
