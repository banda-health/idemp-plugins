...
import org.bandahealth.idempiere.graphql.resolver.model.X_AD_ViewColumnResolver;
...
public class X_AD_ViewColumnInput extends MViewColumn implements I_AD_ViewColumnInput {
	...
	public void setDBDataTypeInput(ForeignEntityInput DBDataType) {
		...
		if (DBDataType != null) {
			...
			if (!X_AD_ViewColumnResolver.DBDATATYPE_UUIDS_BY_VALUE.containsValue(DBDataType.getUU())) {
				throw new AdempiereException("The reference list UU of " + DBDataType.getUU() +
						" is not in the list defined for the DBDataType column");
			}
