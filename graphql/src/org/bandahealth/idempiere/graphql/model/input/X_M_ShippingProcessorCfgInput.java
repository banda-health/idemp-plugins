...
public class X_M_ShippingProcessorCfgInput extends X_M_ShippingProcessorCfg implements I_M_ShippingProcessorCfgInput {
	 ...
	 *
	 * @param UUID The M_ShippingProcessorCfg_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ShippingProcessorCfgInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_ShippingProcessorCfg(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setM_ShippingProcessorCfg_UU(UUID);
	}
