...
import org.bandahealth.idempiere.graphql.resolver.model.X_M_InOutConfirmResolver;
...
public class X_M_InOutConfirmInput extends MInOutConfirm implements I_M_InOutConfirmInput {
	...
	public void setConfirmTypeInput(ForeignEntityInput ConfirmType) {
		...
		if (ConfirmType != null) {
			...
			if (!X_M_InOutConfirmResolver.CONFIRMTYPE_UUIDS_BY_VALUE.containsValue(ConfirmType.getUU())) {
				throw new AdempiereException("The reference list UU of " + ConfirmType.getUU() +
						" is not in the list defined for the ConfirmType column");
			}
	...
	public void setDocActionInput(ForeignEntityInput DocAction) {
		...
		if (DocAction != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_InOutConfirmResolver.DOCACTION_UUIDS_BY_VALUE.containsValue(DocAction.getUU())) {
	...
	public void setDocStatusInput(ForeignEntityInput DocStatus) {
		...
		if (DocStatus != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_InOutConfirmResolver.DOCSTATUS_UUIDS_BY_VALUE.containsValue(DocStatus.getUU())) {
