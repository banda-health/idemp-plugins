...
public class X_C_OnlineTrxHistoryInput extends MOnlineTrxHistory implements I_C_OnlineTrxHistoryInput {
	 ...
	 */
	@JsonCreator
	public X_C_OnlineTrxHistoryInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MOnlineTrxHistory(null, (ResultSet) null, null),
