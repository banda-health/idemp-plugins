...
public class X_TestInput extends MTest implements I_TestInput {
	 ...
	 */
	@JsonCreator
	public X_TestInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MTest(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setAccount_AInput(ForeignEntityInput Account_A) {
		...
		if (Account_A != null &&
				(foreignEntity = new Query(getCtx(), "C_ValidCombination", "C_ValidCombination_UU=?", get_TrxName())
						.setParameters(Account_A.getID())
						.first()) != null && foreignEntity.get_ID() != 0) {
			super.setAccount_Acct(foreignEntity.get_ID());
		} else {
