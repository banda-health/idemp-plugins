...
public class X_AD_User_RolesInput extends MUserRoles implements I_AD_User_RolesInput {
	 ...
	 */
	@JsonCreator
	public X_AD_User_RolesInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MUserRoles(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
