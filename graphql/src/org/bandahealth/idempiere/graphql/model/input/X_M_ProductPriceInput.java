...
public class X_M_ProductPriceInput extends MProductPrice_BH implements I_M_ProductPriceInput {
	 ...
	 *
	 * @param UUID The M_ProductPrice_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ProductPriceInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MProductPrice_BH(null, (ResultSet) null, null),
