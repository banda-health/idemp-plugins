...
import org.bandahealth.idempiere.graphql.resolver.model.X_C_ChargeResolver;
...
public class X_C_ChargeInput extends MCharge_BH implements I_C_ChargeInput {
	...
	public void setBH_SubTypeInput(ForeignEntityInput BH_SubType) {
		...
		if (BH_SubType != null) {
			...
			if (!X_C_ChargeResolver.BH_SUBTYPE_UUIDS_BY_VALUE.containsValue(BH_SubType.getUU())) {
