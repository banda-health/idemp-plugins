...
public class X_PA_SLA_GoalInput extends X_PA_SLA_Goal implements I_PA_SLA_GoalInput {
	 ...
	 *
	 * @param UU The PA_SLA_Goal_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_PA_SLA_GoalInput(@JsonProperty("UU") String UU) {
	...
	public void setPA_SLA_CriteriaInput(ForeignEntityInput PA_SLA_Criteria) {
		...
		if (PA_SLA_Criteria != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table PA_SLA_Criteria with UU " + PA_SLA_Criteria.getUU());
			}
		} else {
