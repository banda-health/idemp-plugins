...
public class X_PA_MeasureCalcInput extends MMeasureCalc implements I_PA_MeasureCalcInput {
	 ...
	 */
	@JsonCreator
	public X_PA_MeasureCalcInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MMeasureCalc(null, (ResultSet) null, null),
