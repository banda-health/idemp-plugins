...
public class X_AD_Private_AccessInput extends MPrivateAccess implements I_AD_Private_AccessInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Private_AccessInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MPrivateAccess(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	 ...
	 */
	public String getID() {
		return getAD_Private_Access_UU();
	}
