...
public class X_AD_Role_OrgAccessInput extends MRoleOrgAccess implements I_AD_Role_OrgAccessInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Role_OrgAccessInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MRoleOrgAccess(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	 ...
	 */
	public String getID() {
		return getAD_Role_OrgAccess_UU();
	}
}
