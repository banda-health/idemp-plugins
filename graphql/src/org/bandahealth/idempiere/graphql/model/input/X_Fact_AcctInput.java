...
import org.bandahealth.idempiere.graphql.resolver.model.X_Fact_AcctResolver;
...
public class X_Fact_AcctInput extends MFactAcct implements I_Fact_AcctInput {
	...
	public void setPostingTypeInput(ForeignEntityInput PostingType) {
		...
		if (PostingType != null) {
			...
			if (!X_Fact_AcctResolver.POSTINGTYPE_UUIDS_BY_VALUE.containsValue(PostingType.getUU())) {
