...
public class X_BH_Client_ConceptInput extends MBHClientConcept implements I_BH_Client_ConceptInput {
	 ...
	 *
	 * @param UU The BH_Client_Concept_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_BH_Client_ConceptInput(@JsonProperty("UU") String UU) {
	 ...
	 */
	public String getUU() {
		return getBH_Client_Concept_UU();
	}
