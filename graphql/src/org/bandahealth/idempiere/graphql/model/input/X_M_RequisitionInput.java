...
import org.bandahealth.idempiere.graphql.resolver.model.X_M_RequisitionResolver;
...
public class X_M_RequisitionInput extends MRequisition implements I_M_RequisitionInput {
	...
	public void setDocActionInput(ForeignEntityInput DocAction) {
		...
		if (DocAction != null) {
			...
			if (!X_M_RequisitionResolver.DOCACTION_UUIDS_BY_VALUE.containsValue(DocAction.getUU())) {
	...
	public void setDocStatusInput(ForeignEntityInput DocStatus) {
		...
		if (DocStatus != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_RequisitionResolver.DOCSTATUS_UUIDS_BY_VALUE.containsValue(DocStatus.getUU())) {
	...
	public void setPriorityRuleInput(ForeignEntityInput PriorityRule) {
		...
		if (PriorityRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_RequisitionResolver.PRIORITYRULE_UUIDS_BY_VALUE.containsValue(PriorityRule.getUU())) {
