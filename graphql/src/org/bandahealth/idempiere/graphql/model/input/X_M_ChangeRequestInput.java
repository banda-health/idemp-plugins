...
public class X_M_ChangeRequestInput extends MChangeRequest implements I_M_ChangeRequestInput {
	 ...
	 */
	@JsonCreator
	public X_M_ChangeRequestInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MChangeRequest(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
