...
public class X_C_AddressValidationCfgInput extends X_C_AddressValidationCfg implements I_C_AddressValidationCfgInput {
	 ...
	 *
	 * @param UU The C_AddressValidationCfg_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_AddressValidationCfgInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setC_AddressValidationCfg_UU(UU);
	}
