...
public class X_A_Asset_Info_OthInput extends X_A_Asset_Info_Oth implements I_A_Asset_Info_OthInput {
	 ...
	 *
	 * @param UU The A_Asset_Info_Oth_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_A_Asset_Info_OthInput(@JsonProperty("UU") String UU) {
	...
	public void setA_Asset_Info_OthInput(ForeignEntityInput A_Asset_Info_Oth) {
		...
		if (A_Asset_Info_Oth != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table A_Asset_Info_Oth with UU " + A_Asset_Info_Oth.getUU());
			}
		} else {
