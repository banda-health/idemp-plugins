...
public class X_IMP_ProcessorParameterInput extends X_IMP_ProcessorParameter implements I_IMP_ProcessorParameterInput {
	 ...
	 *
	 * @param UU The IMP_ProcessorParameter_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_IMP_ProcessorParameterInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setIMP_ProcessorParameter_UU(UU);
	}
