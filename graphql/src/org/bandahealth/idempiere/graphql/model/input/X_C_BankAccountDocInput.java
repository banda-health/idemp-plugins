...
import org.bandahealth.idempiere.graphql.resolver.model.X_C_BankAccountDocResolver;
...
public class X_C_BankAccountDocInput extends X_C_BankAccountDoc implements I_C_BankAccountDocInput {
	...
	public void setPaymentRuleInput(ForeignEntityInput PaymentRule) {
		...
		if (PaymentRule != null) {
			...
			if (!X_C_BankAccountDocResolver.PAYMENTRULE_UUIDS_BY_VALUE.containsValue(PaymentRule.getUU())) {
