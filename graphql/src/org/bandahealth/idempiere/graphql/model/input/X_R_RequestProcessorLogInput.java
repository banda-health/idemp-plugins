...
public class X_R_RequestProcessorLogInput extends MRequestProcessorLog implements I_R_RequestProcessorLogInput {
	 ...
	 */
	@JsonCreator
	public X_R_RequestProcessorLogInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MRequestProcessorLog(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setID(String ID) {
		setR_RequestProcessorLog_UU(ID);
	}
