...
public class X_AD_TableIndexInput extends MTableIndex implements I_AD_TableIndexInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TableIndexInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MTableIndex(null, (ResultSet) null, null),
