...
public class X_M_ProductPriceVendorBreakInput extends X_M_ProductPriceVendorBreak implements I_M_ProductPriceVendorBreakInput {
	 ...
	 *
	 * @param UU The M_ProductPriceVendorBreak_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ProductPriceVendorBreakInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setM_ProductPriceVendorBreak_UU(UU);
	}
