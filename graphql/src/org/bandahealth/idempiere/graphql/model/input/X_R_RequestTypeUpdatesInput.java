...
public class X_R_RequestTypeUpdatesInput extends X_R_RequestTypeUpdates implements I_R_RequestTypeUpdatesInput {
	 ...
	 *
	 * @param UUID The R_RequestTypeUpdates_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_R_RequestTypeUpdatesInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_R_RequestTypeUpdates(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setR_RequestTypeUpdates_UU(UUID);
	}
