...
public class X_R_RequestTypeUpdatesInput extends X_R_RequestTypeUpdates implements I_R_RequestTypeUpdatesInput {
	 ...
	 *
	 * @param UU The R_RequestTypeUpdates_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_R_RequestTypeUpdatesInput(@JsonProperty("UU") String UU) {
