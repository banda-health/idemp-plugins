...
import org.bandahealth.idempiere.graphql.resolver.model.X_I_GLJournalResolver;
...
public class X_I_GLJournalInput extends X_I_GLJournal implements I_I_GLJournalInput {
	 ...
	 *
	 * @param UU The I_GLJournal_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_I_GLJournalInput(@JsonProperty("UU") String UU) {
	...
	public void setPostingTypeInput(ForeignEntityInput PostingType) {
		...
		if (PostingType != null) {
			...
			if (!X_I_GLJournalResolver.POSTINGTYPE_UUIDS_BY_VALUE.containsValue(PostingType.getUU())) {
