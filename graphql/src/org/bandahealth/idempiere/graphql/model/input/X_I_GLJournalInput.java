...
public class X_I_GLJournalInput extends X_I_GLJournal implements I_I_GLJournalInput {
	 ...
	 */
	@JsonCreator
	public X_I_GLJournalInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_I_GLJournal(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
