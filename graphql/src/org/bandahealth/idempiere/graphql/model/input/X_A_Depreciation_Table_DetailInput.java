...
import org.bandahealth.idempiere.graphql.resolver.model.X_A_Depreciation_Table_DetailResolver;
...
public class X_A_Depreciation_Table_DetailInput extends X_A_Depreciation_Table_Detail implements I_A_Depreciation_Table_DetailInput {
	 ...
	 */
	@JsonProperty("A_Depreciation_Table_Code")
	public void setA_Depreciation_Table_CodeFromJson(String A_Depreciation_Table_Code) {
		if (get_ID() == 0) {
	 ...
	 */
	@JsonProperty("A_Depreciation_Table_Detail_ID")
	public void setA_Depreciation_Table_Detail_IDFromJson(int A_Depreciation_Table_Detail_ID) {
		if (get_ID() == 0) {
	...
	public void setA_Table_Rate_TypeInput(ForeignEntityInput A_Table_Rate_Type) {
		...
		if (A_Table_Rate_Type != null) {
			...
			if (!X_A_Depreciation_Table_DetailResolver.A_TABLE_RATE_TYPE_UUIDS_BY_VALUE.containsValue(A_Table_Rate_Type.getUU())) {
