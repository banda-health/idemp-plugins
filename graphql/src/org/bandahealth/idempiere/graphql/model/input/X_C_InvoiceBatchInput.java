...
public class X_C_InvoiceBatchInput extends MInvoiceBatch implements I_C_InvoiceBatchInput {
	 ...
	 */
	@JsonCreator
	public X_C_InvoiceBatchInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MInvoiceBatch(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
