...
import org.bandahealth.idempiere.graphql.resolver.model.X_C_SubscriptionTypeResolver;
...
public class X_C_SubscriptionTypeInput extends X_C_SubscriptionType implements I_C_SubscriptionTypeInput {
	...
	public void setFrequencyTypeInput(ForeignEntityInput FrequencyType) {
		...
		if (FrequencyType != null) {
			...
			if (!X_C_SubscriptionTypeResolver.FREQUENCYTYPE_UUIDS_BY_VALUE.containsValue(FrequencyType.getUU())) {
