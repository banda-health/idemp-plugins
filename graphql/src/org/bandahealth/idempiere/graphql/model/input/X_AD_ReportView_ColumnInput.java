...
public class X_AD_ReportView_ColumnInput extends X_AD_ReportView_Column implements I_AD_ReportView_ColumnInput {
	 ...
	 *
	 * @param UUID The AD_ReportView_Column_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_ReportView_ColumnInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_ReportView_Column(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setAD_ReportView_Column_UU(UUID);
	}
