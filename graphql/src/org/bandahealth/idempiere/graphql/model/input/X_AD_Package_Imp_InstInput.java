...
public class X_AD_Package_Imp_InstInput extends X_AD_Package_Imp_Inst implements I_AD_Package_Imp_InstInput {
	 ...
	 *
	 * @param UU The AD_Package_Imp_Inst_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_Package_Imp_InstInput(@JsonProperty("UU") String UU) {
