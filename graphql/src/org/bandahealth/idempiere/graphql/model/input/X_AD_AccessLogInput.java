...
/**
 * Generated Model for AD_AccessLog - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_AD_AccessLogInput extends MAccessLog implements I_AD_AccessLogInput {
	 ...
	 */
	@JsonCreator
	public X_AD_AccessLogInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MAccessLog(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	/**
