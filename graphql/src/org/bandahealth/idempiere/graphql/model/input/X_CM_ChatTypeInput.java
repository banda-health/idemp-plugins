...
import org.bandahealth.idempiere.graphql.resolver.model.X_CM_ChatTypeResolver;
...
public class X_CM_ChatTypeInput extends MChatType implements I_CM_ChatTypeInput {
	 ...
	 *
	 * @param UU The CM_ChatType_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_CM_ChatTypeInput(@JsonProperty("UU") String UU) {
	...
	public void setModerationTypeInput(ForeignEntityInput ModerationType) {
		...
		if (ModerationType != null) {
			...
			if (!X_CM_ChatTypeResolver.MODERATIONTYPE_UUIDS_BY_VALUE.containsValue(ModerationType.getUU())) {
