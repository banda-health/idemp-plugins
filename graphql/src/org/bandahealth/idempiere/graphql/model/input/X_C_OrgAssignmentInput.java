...
public class X_C_OrgAssignmentInput extends X_C_OrgAssignment implements I_C_OrgAssignmentInput {
	 ...
	 *
	 * @param UUID The C_OrgAssignment_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_OrgAssignmentInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_OrgAssignment(null, (ResultSet) null, null),
