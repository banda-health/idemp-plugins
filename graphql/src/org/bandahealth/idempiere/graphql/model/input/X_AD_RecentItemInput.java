...
/**
 * Generated Model for AD_RecentItem - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_AD_RecentItemInput extends MRecentItem implements I_AD_RecentItemInput {
	 ...
	 */
	@JsonCreator
	public X_AD_RecentItemInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MRecentItem(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
