...
public class X_C_CountryGroupCountryInput extends MCountryGroupCountry implements I_C_CountryGroupCountryInput {
	 ...
	 *
	 * @param UU The C_CountryGroupCountry_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_CountryGroupCountryInput(@JsonProperty("UU") String UU) {
	...
	public void setC_CountryGroupInput(ForeignEntityInput C_CountryGroup) {
		...
		if (C_CountryGroup != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table C_CountryGroup with UU " + C_CountryGroup.getUU());
			}
		} else {
