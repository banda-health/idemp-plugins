...
public class X_C_Conversion_RateInput extends MConversionRate implements I_C_Conversion_RateInput {
	 ...
	 */
	@JsonCreator
	public X_C_Conversion_RateInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MConversionRate(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setC_ConversionTypeInput(ForeignEntityInput C_ConversionType) {
		...
		if (get_ID() == 0 && C_ConversionType != null &&
	...
	public void setC_Currency_ToInput(ForeignEntityInput C_Currency_To) {
		...
		MCurrency_BH foreignEntity;
		if (get_ID() == 0 && C_Currency_To != null &&
				(foreignEntity = new Query(getCtx(), "C_Currency", "C_Currency_UU=?", get_TrxName())
