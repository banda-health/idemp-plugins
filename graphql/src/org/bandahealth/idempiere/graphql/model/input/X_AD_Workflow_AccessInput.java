...
/**
 * Generated Model for AD_Workflow_Access - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_AD_Workflow_AccessInput extends X_AD_Workflow_Access implements I_AD_Workflow_AccessInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Workflow_AccessInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_Workflow_Access(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	 ...
	 */
	public String getID() {
		return getAD_Workflow_Access_UU();
	}
