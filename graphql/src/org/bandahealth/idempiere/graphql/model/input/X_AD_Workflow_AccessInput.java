...
public class X_AD_Workflow_AccessInput extends X_AD_Workflow_Access implements I_AD_Workflow_AccessInput {
	 ...
	 *
	 * @param UU The AD_Workflow_Access_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_Workflow_AccessInput(@JsonProperty("UU") String UU) {
