...
public class X_AD_NoteInput extends MNote implements I_AD_NoteInput {
	 ...
	 */
	@JsonCreator
	public X_AD_NoteInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MNote(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setAD_BroadcastMessageInput(ForeignEntityInput AD_BroadcastMessage) {
		...
		if (AD_BroadcastMessage != null &&
				(foreignEntity = new Query(getCtx(), "AD_BroadcastMessage", "AD_BroadcastMessage_UU=?", get_TrxName())
						.setParameters(AD_BroadcastMessage.getID())
						.first()) != null && foreignEntity.get_ID() != 0) {
			super.setAD_BroadcastMessage_ID(foreignEntity.get_ID());
		} else {
