...
import org.bandahealth.idempiere.graphql.resolver.model.X_ASP_ClientExceptionResolver;
...
public class X_ASP_ClientExceptionInput extends X_ASP_ClientException implements I_ASP_ClientExceptionInput {
	...
	public void setASP_StatusInput(ForeignEntityInput ASP_Status) {
		...
		if (ASP_Status != null) {
			...
			if (!X_ASP_ClientExceptionResolver.ASP_STATUS_UUIDS_BY_VALUE.containsValue(ASP_Status.getUU())) {
