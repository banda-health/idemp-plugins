...
public class X_C_RfQ_TopicSubscriberInput extends MRfQTopicSubscriber implements I_C_RfQ_TopicSubscriberInput {
	 ...
	 */
	@JsonCreator
	public X_C_RfQ_TopicSubscriberInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MRfQTopicSubscriber(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setID(String ID) {
		setC_RfQ_TopicSubscriber_UU(ID);
	}
