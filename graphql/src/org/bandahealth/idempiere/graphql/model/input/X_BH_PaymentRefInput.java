...
/**
 * Generated Model for BH_PaymentRef - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_BH_PaymentRefInput extends MBHPaymentRef implements I_BH_PaymentRefInput {
	 ...
	 */
	@JsonCreator
	public X_BH_PaymentRefInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MBHPaymentRef(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
