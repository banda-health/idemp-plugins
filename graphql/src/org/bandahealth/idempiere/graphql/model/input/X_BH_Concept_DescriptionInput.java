...
/**
 * Generated Model for BH_Concept_Description - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_BH_Concept_DescriptionInput extends MBHConceptDescription implements I_BH_Concept_DescriptionInput {
	 ...
	 *
	 * @param UU The BH_Concept_Description_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_BH_Concept_DescriptionInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setBH_Concept_Description_UU(UU);
	}
	 ...
	 */
	public String getUU() {
		return getBH_Concept_Description_UU();
	}
