...
/**
 * Generated Model for M_Cost - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_M_CostInput extends MCost implements I_M_CostInput {
	 ...
	 */
	@JsonCreator
	public X_M_CostInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MCost(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setCostingMethodInput(I_AD_Ref_ListInput CostingMethod) {
		...
		if (get_ID() == 0 &&CostingMethod != null &&
