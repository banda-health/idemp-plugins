...
public class X_C_TaxProviderInput extends MTaxProvider implements I_C_TaxProviderInput {
	 ...
	 *
	 * @param UU The C_TaxProvider_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_TaxProviderInput(@JsonProperty("UU") String UU) {
	...
	public void setC_TaxProviderCfgInput(ForeignEntityInput C_TaxProviderCfg) {
		...
		if (C_TaxProviderCfg != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table C_TaxProviderCfg with UU " + C_TaxProviderCfg.getUU());
			}
		} else {
