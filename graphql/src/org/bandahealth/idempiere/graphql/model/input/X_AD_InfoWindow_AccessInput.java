...
public class X_AD_InfoWindow_AccessInput extends MInfoWindowAccess implements I_AD_InfoWindow_AccessInput {
	 ...
	 *
	 * @param UU The AD_InfoWindow_Access_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_InfoWindow_AccessInput(@JsonProperty("UU") String UU) {
