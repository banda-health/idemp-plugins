...
public class X_C_UserRemunerationInput extends X_C_UserRemuneration implements I_C_UserRemunerationInput {
	 ...
	 *
	 * @param UU The C_UserRemuneration_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_UserRemunerationInput(@JsonProperty("UU") String UU) {
