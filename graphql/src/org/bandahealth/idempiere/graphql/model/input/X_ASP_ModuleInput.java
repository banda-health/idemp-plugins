...
public class X_ASP_ModuleInput extends X_ASP_Module implements I_ASP_ModuleInput {
	 ...
	 *
	 * @param UUID The ASP_Module_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_ASP_ModuleInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_ASP_Module(null, (ResultSet) null, null),
