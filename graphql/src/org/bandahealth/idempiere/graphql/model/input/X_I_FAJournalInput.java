...
public class X_I_FAJournalInput extends MXIFAJournal implements I_I_FAJournalInput {
	...
	public X_I_FAJournalInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MXIFAJournal(null, (ResultSet) null, null),
	...
	public void setCurrencyRateTypeInput(I_AD_Ref_ListInput CurrencyRateType) {
		...
		if (CurrencyRateType != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table " + MRefList_BH.Table_Name + " with UUID " + CurrencyRateType.getUUID());
			}
		} else {
