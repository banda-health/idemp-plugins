...
public class X_AD_Document_Action_AccessInput extends MDocumentActionAccess implements I_AD_Document_Action_AccessInput {
	 ...
	 *
	 * @param UU The AD_Document_Action_Access_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_Document_Action_AccessInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setAD_Document_Action_Access_UU(UU);
	}
