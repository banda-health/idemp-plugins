...
import org.bandahealth.idempiere.graphql.resolver.model.X_AD_InfoColumnResolver;
...
public class X_AD_InfoColumnInput extends MInfoColumn implements I_AD_InfoColumnInput {
	...
	public void setQueryOperatorInput(ForeignEntityInput QueryOperator) {
		...
		if (QueryOperator != null) {
			...
			if (!X_AD_InfoColumnResolver.QUERYOPERATOR_UUIDS_BY_VALUE.containsValue(QueryOperator.getUU())) {
