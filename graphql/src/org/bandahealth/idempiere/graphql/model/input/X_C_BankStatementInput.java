...
public class X_C_BankStatementInput extends MBankStatement implements I_C_BankStatementInput {
	 ...
	 */
	@JsonCreator
	public X_C_BankStatementInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MBankStatement(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
