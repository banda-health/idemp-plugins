...
public class X_C_BPartner_LocationInput extends MBPartnerLocation implements I_C_BPartner_LocationInput {
	 ...
	 *
	 * @param UU The C_BPartner_Location_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_BPartner_LocationInput(@JsonProperty("UU") String UU) {
