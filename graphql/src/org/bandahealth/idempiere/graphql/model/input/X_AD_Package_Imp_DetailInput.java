...
public class X_AD_Package_Imp_DetailInput extends X_AD_Package_Imp_Detail implements I_AD_Package_Imp_DetailInput {
	 ...
	 *
	 * @param UUID The AD_Package_Imp_Detail_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_Package_Imp_DetailInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_Package_Imp_Detail(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setAD_Package_Imp_Detail_UU(UUID);
	}
