...
public class X_R_IssueSystemInput extends X_R_IssueSystem implements I_R_IssueSystemInput {
	 ...
	 *
	 * @param UU The R_IssueSystem_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_R_IssueSystemInput(@JsonProperty("UU") String UU) {
	...
	public void setSystemStatusInput(ForeignEntityInput SystemStatus) {
		...
		if (SystemStatus != null) {
			...
			if (!X_R_IssueSystemResolver.SYSTEMSTATUS_UUIDS_BY_VALUE.containsValue(SystemStatus.getUU())) {
