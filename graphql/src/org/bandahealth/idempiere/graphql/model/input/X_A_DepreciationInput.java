...
public class X_A_DepreciationInput extends MDepreciation implements I_A_DepreciationInput {
	 ...
	 */
	@JsonCreator
	public X_A_DepreciationInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MDepreciation(null, (ResultSet) null, null),
