...
public class X_PP_Order_Node_AssetInput extends X_PP_Order_Node_Asset implements I_PP_Order_Node_AssetInput {
	 ...
	 *
	 * @param UU The PP_Order_Node_Asset_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_PP_Order_Node_AssetInput(@JsonProperty("UU") String UU) {
