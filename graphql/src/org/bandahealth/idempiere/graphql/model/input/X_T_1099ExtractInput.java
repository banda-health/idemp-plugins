...
public class X_T_1099ExtractInput extends X_T_1099Extract implements I_T_1099ExtractInput {
	 ...
	 */
	@JsonCreator
	public X_T_1099ExtractInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_T_1099Extract(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
