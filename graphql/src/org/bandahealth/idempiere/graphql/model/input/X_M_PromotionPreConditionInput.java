...
public class X_M_PromotionPreConditionInput extends X_M_PromotionPreCondition implements I_M_PromotionPreConditionInput {
	 ...
	 *
	 * @param UUID The M_PromotionPreCondition_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_PromotionPreConditionInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_PromotionPreCondition(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setM_PromotionPreCondition_UU(UUID);
	}
