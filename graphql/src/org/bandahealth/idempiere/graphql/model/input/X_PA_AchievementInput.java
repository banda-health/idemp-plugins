...
public class X_PA_AchievementInput extends MAchievement implements I_PA_AchievementInput {
	 ...
	 */
	@JsonCreator
	public X_PA_AchievementInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MAchievement(null, (ResultSet) null, null),
