...
public class X_C_TaxTypeInput extends X_C_TaxType implements I_C_TaxTypeInput {
	 ...
	 *
	 * @param UUID The C_TaxType_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_TaxTypeInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_TaxType(null, (ResultSet) null, null),
