...
import org.bandahealth.idempiere.graphql.resolver.model.X_A_Asset_TransferResolver;
...
public class X_A_Asset_TransferInput extends MAssetTransfer implements I_A_Asset_TransferInput {
	...
	public void setA_Accumdepreciation_New_AInput(ForeignEntityInput A_Accumdepreciation_New_A) {
		...
		if (A_Accumdepreciation_New_A != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "C_ValidCombination", "C_ValidCombination_UU=?", get_TrxName())
							.setParameters(A_Accumdepreciation_New_A.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
	...
	public void setA_Asset_New_AInput(ForeignEntityInput A_Asset_New_A) {
		...
		if (A_Asset_New_A != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "C_ValidCombination", "C_ValidCombination_UU=?", get_TrxName())
							.setParameters(A_Asset_New_A.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
	...
	public void setA_CapvsExpInput(ForeignEntityInput A_CapvsExp) {
		...
		if (A_CapvsExp != null) {
			...
			if (!X_A_Asset_TransferResolver.A_CAPVSEXP_UUIDS_BY_VALUE.containsValue(A_CapvsExp.getUU())) {
	...
	public void setA_Depreciation_New_AInput(ForeignEntityInput A_Depreciation_New_A) {
		...
		if (A_Depreciation_New_A != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "C_ValidCombination", "C_ValidCombination_UU=?", get_TrxName())
							.setParameters(A_Depreciation_New_A.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
	...
	public void setA_Disposal_Loss_New_AInput(ForeignEntityInput A_Disposal_Loss_New_A) {
		...
		if (A_Disposal_Loss_New_A != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "C_ValidCombination", "C_ValidCombination_UU=?", get_TrxName())
							.setParameters(A_Disposal_Loss_New_A.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
	...
	public void setA_Disposal_Revenue_New_AInput(ForeignEntityInput A_Disposal_Revenue_New_A) {
		...
		if (A_Disposal_Revenue_New_A != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "C_ValidCombination", "C_ValidCombination_UU=?", get_TrxName())
							.setParameters(A_Disposal_Revenue_New_A.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
	...
	public void setDocActionInput(ForeignEntityInput DocAction) {
		...
		if (DocAction != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_A_Asset_TransferResolver.DOCACTION_UUIDS_BY_VALUE.containsValue(DocAction.getUU())) {
	...
	public void setDocStatusInput(ForeignEntityInput DocStatus) {
		...
		if (DocStatus != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_A_Asset_TransferResolver.DOCSTATUS_UUIDS_BY_VALUE.containsValue(DocStatus.getUU())) {
	...
	public void setPostingTypeInput(ForeignEntityInput PostingType) {
		...
		if (PostingType != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_A_Asset_TransferResolver.POSTINGTYPE_UUIDS_BY_VALUE.containsValue(PostingType.getUU())) {
