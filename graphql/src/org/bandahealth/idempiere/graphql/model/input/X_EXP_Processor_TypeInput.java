...
public class X_EXP_Processor_TypeInput extends MEXPProcessorType implements I_EXP_Processor_TypeInput {
	 ...
	 *
	 * @param UU The EXP_Processor_Type_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_EXP_Processor_TypeInput(@JsonProperty("UU") String UU) {
