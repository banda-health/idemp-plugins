...
public class X_AD_ReportViewInput extends MReportView implements I_AD_ReportViewInput {
	 ...
	 */
	@JsonCreator
	public X_AD_ReportViewInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MReportView(null, (ResultSet) null, null),
