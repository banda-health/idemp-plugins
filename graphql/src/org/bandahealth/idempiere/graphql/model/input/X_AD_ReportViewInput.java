...
/**
 * Generated Model for AD_ReportView - DO NOT CHANGE
 *
...
public class X_AD_ReportViewInput extends MReportView implements I_AD_ReportViewInput {
	 ...
	 */
	@JsonCreator
	public X_AD_ReportViewInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MReportView(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
