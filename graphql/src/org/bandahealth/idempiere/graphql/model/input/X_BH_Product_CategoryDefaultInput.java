...
public class X_BH_Product_CategoryDefaultInput extends MBHProductCategoryDefault implements I_BH_Product_CategoryDefaultInput {
	 ...
	 */
	@JsonCreator
	public X_BH_Product_CategoryDefaultInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MBHProductCategoryDefault(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setBH_Product_CategoryDefault_UU(UUID);
	}
