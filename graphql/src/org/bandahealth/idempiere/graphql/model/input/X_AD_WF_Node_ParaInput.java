...
public class X_AD_WF_Node_ParaInput extends X_AD_WF_Node_Para implements I_AD_WF_Node_ParaInput {
	 ...
	 *
	 * @param UUID The AD_WF_Node_Para_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_WF_Node_ParaInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_WF_Node_Para(null, (ResultSet) null, null),
