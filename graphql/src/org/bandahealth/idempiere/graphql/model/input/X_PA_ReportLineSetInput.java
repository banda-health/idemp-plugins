 ...
 */
public class X_PA_ReportLineSetInput extends MReportLineSet implements I_PA_ReportLineSetInput {
	 ...
	 *
	 * @param UU The PA_ReportLineSet_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_PA_ReportLineSetInput(@JsonProperty("UU") String UU) {
