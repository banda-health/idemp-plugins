...
public class X_AD_AttachmentInput extends MAttachment implements I_AD_AttachmentInput {
	 ...
	 *
	 * @param UUID The AD_Attachment_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_AttachmentInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MAttachment(null, (ResultSet) null, null),
