...
public class X_C_DepositBatchInput extends MDepositBatch implements I_C_DepositBatchInput {
	 ...
	 */
	@JsonProperty("C_DepositBatch_ID")
	public void setC_DepositBatch_IDFromJson(int C_DepositBatch_ID) {
		if (get_ID() == 0) {
	...
	public void setDocStatusInput(ForeignEntityInput DocStatus) {
		...
		if (DocStatus != null) {
			...
			if (!X_C_DepositBatchResolver.DOCSTATUS_UUIDS_BY_VALUE.containsValue(DocStatus.getUU())) {
