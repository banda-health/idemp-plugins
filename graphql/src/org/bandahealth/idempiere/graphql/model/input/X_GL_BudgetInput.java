...
public class X_GL_BudgetInput extends X_GL_Budget implements I_GL_BudgetInput {
	 ...
	 *
	 * @param UUID The GL_Budget_UU to fetch this entity from the DB
	 */
	@JsonCreator
	...
	public void setBudgetStatusInput(I_AD_Ref_ListInput BudgetStatus) {
		...
		if (BudgetStatus != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table " + MRefList_BH.Table_Name + " with UUID " + BudgetStatus.getUUID());
			}
		} else {
