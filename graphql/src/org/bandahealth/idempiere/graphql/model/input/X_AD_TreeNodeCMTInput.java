...
public class X_AD_TreeNodeCMTInput extends X_AD_TreeNodeCMT implements I_AD_TreeNodeCMTInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeCMTInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_TreeNodeCMT(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
