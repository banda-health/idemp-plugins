...
/**
 * Generated Model for AD_TreeNodeCMT - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_AD_TreeNodeCMTInput extends X_AD_TreeNodeCMT implements I_AD_TreeNodeCMTInput {
	 ...
	 *
	 * @param UUID The AD_TreeNodeCMT_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_TreeNodeCMTInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_TreeNodeCMT(null, (ResultSet) null, null),
