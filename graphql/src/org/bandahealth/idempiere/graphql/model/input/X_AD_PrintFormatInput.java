...
public class X_AD_PrintFormatInput extends X_AD_PrintFormat implements I_AD_PrintFormatInput {
	 ...
	 *
	 * @param UUID The AD_PrintFormat_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_PrintFormatInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_PrintFormat(null, (ResultSet) null, null),
