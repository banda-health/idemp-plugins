...
public class X_C_OrderSourceInput extends X_C_OrderSource implements I_C_OrderSourceInput {
	 ...
	 *
	 * @param UUID The C_OrderSource_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_OrderSourceInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_OrderSource(null, (ResultSet) null, null),
