...
public class X_AD_TreeNodeCMMInput extends X_AD_TreeNodeCMM implements I_AD_TreeNodeCMMInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeCMMInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_TreeNodeCMM(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
