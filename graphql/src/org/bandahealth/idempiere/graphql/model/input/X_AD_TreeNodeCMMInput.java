...
/**
 * Generated Model for AD_TreeNodeCMM - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_AD_TreeNodeCMMInput extends X_AD_TreeNodeCMM implements I_AD_TreeNodeCMMInput {
	 ...
	 *
	 * @param UUID The AD_TreeNodeCMM_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_TreeNodeCMMInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_TreeNodeCMM(null, (ResultSet) null, null),
