...
public class X_AD_ReplicationTableInput extends X_AD_ReplicationTable implements I_AD_ReplicationTableInput {
	 ...
	 */
	@JsonCreator
	public X_AD_ReplicationTableInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_ReplicationTable(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
