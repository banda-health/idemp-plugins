...
public class X_PA_ReportColumnSetInput extends MReportColumnSet implements I_PA_ReportColumnSetInput {
	 ...
	 *
	 * @param UU The PA_ReportColumnSet_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_PA_ReportColumnSetInput(@JsonProperty("UU") String UU) {
