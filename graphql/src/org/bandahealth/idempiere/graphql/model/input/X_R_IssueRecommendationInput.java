...
public class X_R_IssueRecommendationInput extends X_R_IssueRecommendation implements I_R_IssueRecommendationInput {
	 ...
	 *
	 * @param UU The R_IssueRecommendation_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_R_IssueRecommendationInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setR_IssueRecommendation_UU(UU);
	}
