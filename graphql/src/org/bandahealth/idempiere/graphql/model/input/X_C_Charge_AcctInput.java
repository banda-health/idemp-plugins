...
public class X_C_Charge_AcctInput extends X_C_Charge_Acct implements I_C_Charge_AcctInput {
	 ...
	 *
	 * @param UUID The C_Charge_Acct_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_Charge_AcctInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_Charge_Acct(null, (ResultSet) null, null),
