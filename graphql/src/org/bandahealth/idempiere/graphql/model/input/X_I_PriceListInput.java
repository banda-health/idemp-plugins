...
public class X_I_PriceListInput extends X_I_PriceList implements I_I_PriceListInput {
	 ...
	 *
	 * @param UUID The I_PriceList_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_I_PriceListInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_I_PriceList(null, (ResultSet) null, null),
