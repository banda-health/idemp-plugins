...
import org.bandahealth.idempiere.graphql.resolver.model.X_M_PackageResolver;
...
public class X_M_PackageInput extends MPackage implements I_M_PackageInput {
	...
	public void setDeliveryConfirmationTypeInput(ForeignEntityInput DeliveryConfirmationType) {
		...
		if (DeliveryConfirmationType != null) {
			...
			if (!X_M_PackageResolver.DELIVERYCONFIRMATIONTYPE_UUIDS_BY_VALUE.containsValue(DeliveryConfirmationType.getUU())) {
	...
	public void setDotHazardClassOrDivisionInput(ForeignEntityInput DotHazardClassOrDivision) {
		...
		if (DotHazardClassOrDivision != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_PackageResolver.DOTHAZARDCLASSORDIVISION_UUIDS_BY_VALUE.containsValue(DotHazardClassOrDivision.getUU())) {
	...
	public void setHomeDeliveryPremiumTypeInput(ForeignEntityInput HomeDeliveryPremiumType) {
		...
		if (HomeDeliveryPremiumType != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_PackageResolver.HOMEDELIVERYPREMIUMTYPE_UUIDS_BY_VALUE.containsValue(HomeDeliveryPremiumType.getUU())) {
	...
	public void setNotificationTypeInput(ForeignEntityInput NotificationType) {
		...
		if (NotificationType != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_PackageResolver.NOTIFICATIONTYPE_UUIDS_BY_VALUE.containsValue(NotificationType.getUU())) {
	...
	public void setPaymentRuleInput(ForeignEntityInput PaymentRule) {
		...
		if (PaymentRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_PackageResolver.PAYMENTRULE_UUIDS_BY_VALUE.containsValue(PaymentRule.getUU())) {
