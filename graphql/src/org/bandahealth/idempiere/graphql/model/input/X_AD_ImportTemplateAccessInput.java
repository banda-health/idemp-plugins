...
public class X_AD_ImportTemplateAccessInput extends X_AD_ImportTemplateAccess implements I_AD_ImportTemplateAccessInput {
	 ...
	 *
	 * @param UUID The AD_ImportTemplateAccess_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_ImportTemplateAccessInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_ImportTemplateAccess(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setAD_ImportTemplateAccess_UU(UUID);
	}
