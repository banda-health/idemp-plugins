...
public class X_HR_ProcessInput extends X_HR_Process implements I_HR_ProcessInput {
	 ...
	 *
	 * @param UU The HR_Process_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_HR_ProcessInput(@JsonProperty("UU") String UU) {
	...
	public void setHR_PeriodInput(ForeignEntityInput HR_Period) {
		...
		if (HR_Period != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table HR_Period with UU " + HR_Period.getUU());
			}
		} else {
	...
	public void setReversalInput(ForeignEntityInput Reversal) {
		...
		if (Reversal != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table HR_Process with UU " + Reversal.getUU());
			}
		} else {
