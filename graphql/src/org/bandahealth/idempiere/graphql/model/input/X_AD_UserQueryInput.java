...
/**
 * Generated Model for AD_UserQuery - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_AD_UserQueryInput extends MUserQuery implements I_AD_UserQueryInput {
	 ...
	 */
	@JsonCreator
	public X_AD_UserQueryInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MUserQuery(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
