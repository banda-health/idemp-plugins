...
public class X_AD_TreeNodeU1Input extends X_AD_TreeNodeU1 implements I_AD_TreeNodeU1Input {
	 ...
	 *
	 * @param UUID The AD_TreeNodeU1_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_TreeNodeU1Input(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_TreeNodeU1(null, (ResultSet) null, null),
