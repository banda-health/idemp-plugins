...
public class X_AD_TreeNodeU1Input extends X_AD_TreeNodeU1 implements I_AD_TreeNodeU1Input {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeU1Input(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_TreeNodeU1(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
