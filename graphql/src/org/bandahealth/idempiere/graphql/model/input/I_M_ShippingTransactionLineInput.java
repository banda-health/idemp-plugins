...
public interface I_M_ShippingTransactionLineInput extends I_M_ShippingTransactionLine {
	 ...
	 */
	void setM_PackageMPS(I_M_PackageMPSInput M_PackageMPS);
	 ...
	 * @return M_PackageMPS
	 */
	I_M_PackageMPSInput getM_PackageMPS();
	 ...
	 */
	void setM_ShippingTransaction(I_M_ShippingTransactionInput M_ShippingTransaction);
	 ...
	 */
	I_M_ShippingTransactionInput getM_ShippingTransaction();
