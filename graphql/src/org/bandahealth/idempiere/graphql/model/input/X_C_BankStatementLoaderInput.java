...
public class X_C_BankStatementLoaderInput extends MBankStatementLoader implements I_C_BankStatementLoaderInput {
	 ...
	 */
	@JsonCreator
	public X_C_BankStatementLoaderInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MBankStatementLoader(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setC_BankStatementLoader_UU(UUID);
	}
