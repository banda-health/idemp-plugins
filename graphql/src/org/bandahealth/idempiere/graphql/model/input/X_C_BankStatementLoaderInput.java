...
public class X_C_BankStatementLoaderInput extends MBankStatementLoader implements I_C_BankStatementLoaderInput {
	 ...
	 *
	 * @param UU The C_BankStatementLoader_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_BankStatementLoaderInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setC_BankStatementLoader_UU(UU);
	}
