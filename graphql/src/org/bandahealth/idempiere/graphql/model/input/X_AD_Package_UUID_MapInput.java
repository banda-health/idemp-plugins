...
public class X_AD_Package_UUID_MapInput extends X_AD_Package_UUID_Map implements I_AD_Package_UUID_MapInput {
	 ...
	 *
	 * @param UU The AD_Package_UUID_Map_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_Package_UUID_MapInput(@JsonProperty("UU") String UU) {
