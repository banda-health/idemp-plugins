...
public class X_DD_OrderLineInput extends MDDOrderLine implements I_DD_OrderLineInput {
	 ...
	 */
	@JsonCreator
	public X_DD_OrderLineInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MDDOrderLine(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setM_AttributeSetInstanceToInput(ForeignEntityInput M_AttributeSetInstanceTo) {
		...
		if (M_AttributeSetInstanceTo != null &&
			...
			super.setM_AttributeSetInstanceTo_ID(0);
		}
	}
