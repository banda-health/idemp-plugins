...
public class X_DD_OrderLineInput extends MDDOrderLine implements I_DD_OrderLineInput {
	 ...
	 */
	@JsonCreator
	public X_DD_OrderLineInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MDDOrderLine(null, (ResultSet) null, null),
