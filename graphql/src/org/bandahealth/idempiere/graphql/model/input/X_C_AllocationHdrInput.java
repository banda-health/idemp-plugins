...
public class X_C_AllocationHdrInput extends MAllocationHdr implements I_C_AllocationHdrInput {
	 ...
	 */
	@JsonCreator
	public X_C_AllocationHdrInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MAllocationHdr(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
