...
public class X_AD_PInstanceInput extends MPInstance implements I_AD_PInstanceInput {
	 ...
	 *
	 * @param UU The AD_PInstance_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_PInstanceInput(@JsonProperty("UU") String UU) {
