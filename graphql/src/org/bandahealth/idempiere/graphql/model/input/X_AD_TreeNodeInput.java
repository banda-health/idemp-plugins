...
public class X_AD_TreeNodeInput extends MTree_Node implements I_AD_TreeNodeInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MTree_Node(null, (ResultSet) null, null),
