...
/**
 * Generated Model for AD_TreeNode - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_AD_TreeNodeInput extends MTree_Node implements I_AD_TreeNodeInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MTree_Node(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
