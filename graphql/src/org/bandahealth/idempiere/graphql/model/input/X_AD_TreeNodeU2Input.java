...
public class X_AD_TreeNodeU2Input extends X_AD_TreeNodeU2 implements I_AD_TreeNodeU2Input {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeU2Input(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_TreeNodeU2(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
