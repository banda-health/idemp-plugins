...
/**
 * Generated Model for AD_TreeNodeU2 - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_AD_TreeNodeU2Input extends X_AD_TreeNodeU2 implements I_AD_TreeNodeU2Input {
	 ...
	 *
	 * @param UUID The AD_TreeNodeU2_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_TreeNodeU2Input(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_TreeNodeU2(null, (ResultSet) null, null),
