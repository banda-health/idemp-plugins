...
public class X_C_RfQResponseInput extends MRfQResponse implements I_C_RfQResponseInput {
	 ...
	 */
	@JsonCreator
	public X_C_RfQResponseInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MRfQResponse(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
