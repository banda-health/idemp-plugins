...
public class X_C_AcctProcessorLogInput extends MAcctProcessorLog implements I_C_AcctProcessorLogInput {
	 ...
	 *
	 * @param UU The C_AcctProcessorLog_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_AcctProcessorLogInput(@JsonProperty("UU") String UU) {
	...
	public void setC_AcctProcessorInput(ForeignEntityInput C_AcctProcessor) {
		...
		if (C_AcctProcessor != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table C_AcctProcessor with UU " + C_AcctProcessor.getUU());
			}
		} else {
			this.setC_AcctProcessor_ID(0);
		}
	}
