...
public class X_M_ShipperPickupTypesCfgInput extends X_M_ShipperPickupTypesCfg implements I_M_ShipperPickupTypesCfgInput {
	 ...
	 *
	 * @param UU The M_ShipperPickupTypesCfg_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ShipperPickupTypesCfgInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setM_ShipperPickupTypesCfg_UU(UU);
	}
