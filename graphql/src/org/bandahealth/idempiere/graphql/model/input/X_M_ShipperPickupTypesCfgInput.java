...
public class X_M_ShipperPickupTypesCfgInput extends X_M_ShipperPickupTypesCfg implements I_M_ShipperPickupTypesCfgInput {
	 ...
	 *
	 * @param UUID The M_ShipperPickupTypesCfg_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ShipperPickupTypesCfgInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_ShipperPickupTypesCfg(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setM_ShipperPickupTypesCfg_UU(UUID);
	}
