...
import org.bandahealth.idempiere.graphql.resolver.model.X_DD_OrderResolver;
...
public class X_DD_OrderInput extends MDDOrder implements I_DD_OrderInput {
	 ...
	 *
	 * @param UU The DD_Order_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_DD_OrderInput(@JsonProperty("UU") String UU) {
	...
	public void setDeliveryRuleInput(ForeignEntityInput DeliveryRule) {
		...
		if (DeliveryRule != null) {
			...
			if (!X_DD_OrderResolver.DELIVERYRULE_UUIDS_BY_VALUE.containsValue(DeliveryRule.getUU())) {
	...
	public void setDeliveryViaRuleInput(ForeignEntityInput DeliveryViaRule) {
		...
		if (DeliveryViaRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_DD_OrderResolver.DELIVERYVIARULE_UUIDS_BY_VALUE.containsValue(DeliveryViaRule.getUU())) {
	...
	public void setDocActionInput(ForeignEntityInput DocAction) {
		...
		if (DocAction != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_DD_OrderResolver.DOCACTION_UUIDS_BY_VALUE.containsValue(DocAction.getUU())) {
	...
	public void setDocStatusInput(ForeignEntityInput DocStatus) {
		...
		if (DocStatus != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_DD_OrderResolver.DOCSTATUS_UUIDS_BY_VALUE.containsValue(DocStatus.getUU())) {
	...
	public void setFreightCostRuleInput(ForeignEntityInput FreightCostRule) {
		...
		if (FreightCostRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_DD_OrderResolver.FREIGHTCOSTRULE_UUIDS_BY_VALUE.containsValue(FreightCostRule.getUU())) {
	...
	public void setPriorityRuleInput(ForeignEntityInput PriorityRule) {
		...
		if (PriorityRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_DD_OrderResolver.PRIORITYRULE_UUIDS_BY_VALUE.containsValue(PriorityRule.getUU())) {
