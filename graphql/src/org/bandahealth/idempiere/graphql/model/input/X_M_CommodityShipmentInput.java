...
public class X_M_CommodityShipmentInput extends X_M_CommodityShipment implements I_M_CommodityShipmentInput {
	 ...
	 *
	 * @param UU The M_CommodityShipment_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_CommodityShipmentInput(@JsonProperty("UU") String UU) {
