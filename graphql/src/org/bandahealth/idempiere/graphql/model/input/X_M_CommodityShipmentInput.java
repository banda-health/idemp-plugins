...
public class X_M_CommodityShipmentInput extends X_M_CommodityShipment implements I_M_CommodityShipmentInput {
	 ...
	 *
	 * @param UUID The M_CommodityShipment_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_CommodityShipmentInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_CommodityShipment(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setM_CommodityShipment_UU(UUID);
	}
