...
public class X_B_BuyerFundsInput extends X_B_BuyerFunds implements I_B_BuyerFundsInput {
	 ...
	 */
	@JsonCreator
	public X_B_BuyerFundsInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_B_BuyerFunds(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
