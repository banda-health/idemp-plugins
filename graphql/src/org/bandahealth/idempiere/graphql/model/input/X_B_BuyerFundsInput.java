...
public class X_B_BuyerFundsInput extends X_B_BuyerFunds implements I_B_BuyerFundsInput {
	 ...
	 *
	 * @param UU The B_BuyerFunds_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_B_BuyerFundsInput(@JsonProperty("UU") String UU) {
	 ...
	 */
	@JsonProperty("B_BuyerFunds_ID")
	public void setB_BuyerFunds_IDFromJson(int B_BuyerFunds_ID) {
		if (get_ID() == 0) {
