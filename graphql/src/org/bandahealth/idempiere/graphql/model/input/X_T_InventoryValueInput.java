...
public class X_T_InventoryValueInput extends X_T_InventoryValue implements I_T_InventoryValueInput {
	 ...
	 */
	@JsonCreator
	public X_T_InventoryValueInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_T_InventoryValue(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
