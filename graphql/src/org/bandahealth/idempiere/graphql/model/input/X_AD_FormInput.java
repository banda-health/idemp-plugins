...
import org.bandahealth.idempiere.graphql.resolver.model.X_AD_FormResolver;
...
public class X_AD_FormInput extends MForm implements I_AD_FormInput {
	 ...
	 *
	 * @param UU The AD_Form_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_FormInput(@JsonProperty("UU") String UU) {
	...
	public void setAccessLevelInput(ForeignEntityInput AccessLevel) {
		...
		if (AccessLevel != null) {
			...
			if (!X_AD_FormResolver.ACCESSLEVEL_UUIDS_BY_VALUE.containsValue(AccessLevel.getUU())) {
