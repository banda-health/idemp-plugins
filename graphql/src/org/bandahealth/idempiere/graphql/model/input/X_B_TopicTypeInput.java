...
public class X_B_TopicTypeInput extends X_B_TopicType implements I_B_TopicTypeInput {
	 ...
	 *
	 * @param UU The B_TopicType_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_B_TopicTypeInput(@JsonProperty("UU") String UU) {
	...
	public void setM_ProductMemberInput(ForeignEntityInput M_ProductMember) {
		...
		if (M_ProductMember != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table M_Product with UU " + M_ProductMember.getUU());
			}
		} else {
