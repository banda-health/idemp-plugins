...
/**
 * Generated Interface for I_BankStatement - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 13 - $Id$
 */
public interface I_I_BankStatementInput extends I_I_BankStatement {
	 ...
	 */
	void setC_BankStatementInput(ForeignEntityInput C_BankStatement);
	 ...
	 */
	ForeignEntityInput C_BankStatement();

	/**
	 * Set C_BankStatementLine.
	 *
	 * @param C_BankStatementLine Line on a statement from this Bank
	 */
	void setC_BankStatementLineInput(ForeignEntityInput C_BankStatementLine);

	/**
	 * Get C_BankStatementLine.
	 *
	 * @return Line on a statement from this Bank
	 */
	ForeignEntityInput C_BankStatementLine();
