...
import org.bandahealth.idempiere.graphql.resolver.model.X_M_ReplenishResolver;
...
public class X_M_ReplenishInput extends MReplenish implements I_M_ReplenishInput {
	 ...
	 *
	 * @param UU The M_Replenish_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ReplenishInput(@JsonProperty("UU") String UU) {
	...
	public void setReplenishTypeInput(ForeignEntityInput ReplenishType) {
		...
		if (ReplenishType != null) {
			...
			if (!X_M_ReplenishResolver.REPLENISHTYPE_UUIDS_BY_VALUE.containsValue(ReplenishType.getUU())) {
