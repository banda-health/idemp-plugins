...
public class X_A_Depreciation_Table_HeaderInput extends X_A_Depreciation_Table_Header implements I_A_Depreciation_Table_HeaderInput {
	 ...
	 *
	 * @param UUID The A_Depreciation_Table_Header_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_A_Depreciation_Table_HeaderInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_A_Depreciation_Table_Header(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setA_Depreciation_Table_Header_UU(UUID);
	}
	...
	public void setA_TermInput(I_AD_Ref_ListInput A_Term) {
		...
		if (A_Term != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table " + MRefList_BH.Table_Name + " with UUID " + A_Term.getUUID());
			}
		} else {
			this.setA_Term(null);
		}
