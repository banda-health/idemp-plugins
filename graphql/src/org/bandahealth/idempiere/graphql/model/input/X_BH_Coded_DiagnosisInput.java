...
public class X_BH_Coded_DiagnosisInput extends MBHCodedDiagnosis implements I_BH_Coded_DiagnosisInput {
	 ...
	 *
	 * @param UU The BH_Coded_Diagnosis_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_BH_Coded_DiagnosisInput(@JsonProperty("UU") String UU) {
