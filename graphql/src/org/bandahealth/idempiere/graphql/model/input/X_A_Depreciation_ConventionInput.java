...
public class X_A_Depreciation_ConventionInput extends MDepreciationConvention implements I_A_Depreciation_ConventionInput {
	 ...
	 */
	@JsonCreator
	public X_A_Depreciation_ConventionInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MDepreciationConvention(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setA_Depreciation_Convention_UU(UUID);
	}
