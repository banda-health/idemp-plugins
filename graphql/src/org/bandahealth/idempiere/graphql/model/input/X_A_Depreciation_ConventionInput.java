...
public class X_A_Depreciation_ConventionInput extends MDepreciationConvention implements I_A_Depreciation_ConventionInput {
	 ...
	 *
	 * @param UU The A_Depreciation_Convention_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_A_Depreciation_ConventionInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setA_Depreciation_Convention_UU(UU);
	}
