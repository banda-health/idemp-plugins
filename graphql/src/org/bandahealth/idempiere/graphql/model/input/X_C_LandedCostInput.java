...
import org.bandahealth.idempiere.graphql.resolver.model.X_C_LandedCostResolver;
...
public class X_C_LandedCostInput extends MLandedCost implements I_C_LandedCostInput {
	 ...
	 *
	 * @param UU The C_LandedCost_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_LandedCostInput(@JsonProperty("UU") String UU) {
	...
	public void setLandedCostDistributionInput(ForeignEntityInput LandedCostDistribution) {
		...
		if (LandedCostDistribution != null) {
			...
			if (!X_C_LandedCostResolver.LANDEDCOSTDISTRIBUTION_UUIDS_BY_VALUE.containsValue(LandedCostDistribution.getUU())) {
