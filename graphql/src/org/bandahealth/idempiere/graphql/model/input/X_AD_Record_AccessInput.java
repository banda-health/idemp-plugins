...
public class X_AD_Record_AccessInput extends MRecordAccess implements I_AD_Record_AccessInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Record_AccessInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MRecordAccess(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
