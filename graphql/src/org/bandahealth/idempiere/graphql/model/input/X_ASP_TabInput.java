...
import org.bandahealth.idempiere.graphql.resolver.model.X_ASP_TabResolver;
...
public class X_ASP_TabInput extends X_ASP_Tab implements I_ASP_TabInput {
	...
	public void setASP_StatusInput(ForeignEntityInput ASP_Status) {
		...
		if (ASP_Status != null) {
			...
			if (!X_ASP_TabResolver.ASP_STATUS_UUIDS_BY_VALUE.containsValue(ASP_Status.getUU())) {
