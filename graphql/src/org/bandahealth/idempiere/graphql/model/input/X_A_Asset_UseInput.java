...
public class X_A_Asset_UseInput extends MAssetUse implements I_A_Asset_UseInput {
	 ...
	 *
	 * @param UUID The A_Asset_Use_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_A_Asset_UseInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MAssetUse(null, (ResultSet) null, null),
