...
public class X_M_QualityTestInput extends MQualityTest implements I_M_QualityTestInput {
	 ...
	 *
	 * @param UU The M_QualityTest_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_QualityTestInput(@JsonProperty("UU") String UU) {
	 ...
	 */
	@JsonProperty("M_QualityTest_ID")
	public void setM_QualityTest_IDFromJson(int M_QualityTest_ID) {
		if (get_ID() == 0) {
