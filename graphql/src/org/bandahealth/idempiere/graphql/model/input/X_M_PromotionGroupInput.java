...
public class X_M_PromotionGroupInput extends X_M_PromotionGroup implements I_M_PromotionGroupInput {
	 ...
	 *
	 * @param UUID The M_PromotionGroup_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_PromotionGroupInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_PromotionGroup(null, (ResultSet) null, null),
