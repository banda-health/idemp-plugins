...
public class X_C_AcctProcessorInput extends MAcctProcessor implements I_C_AcctProcessorInput {
	 ...
	 */
	@JsonCreator
	public X_C_AcctProcessorInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MAcctProcessor(null, (ResultSet) null, null),
