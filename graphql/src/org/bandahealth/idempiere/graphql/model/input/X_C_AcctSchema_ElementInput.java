...
import org.bandahealth.idempiere.graphql.resolver.model.X_C_AcctSchema_ElementResolver;
...
public class X_C_AcctSchema_ElementInput extends MAcctSchemaElement implements I_C_AcctSchema_ElementInput {
	 ...
	 *
	 * @param UU The C_AcctSchema_Element_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_AcctSchema_ElementInput(@JsonProperty("UU") String UU) {
	...
	public void setElementTypeInput(ForeignEntityInput ElementType) {
		...
		if (ElementType != null) {
			...
			if (!X_C_AcctSchema_ElementResolver.ELEMENTTYPE_UUIDS_BY_VALUE.containsValue(ElementType.getUU())) {
