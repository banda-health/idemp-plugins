...
public class X_AD_Ref_TableInput extends MRefTable implements I_AD_Ref_TableInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Ref_TableInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MRefTable(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setAD_DispInput(ForeignEntityInput AD_Disp) {
		...
		if (AD_Disp != null &&
				(foreignEntity = new Query(getCtx(), "AD_Column", "AD_Column_UU=?", get_TrxName())
						.setParameters(AD_Disp.getID())
						.first()) != null && foreignEntity.get_ID() != 0) {
			super.setAD_Display(foreignEntity.get_ID());
		} else {
	...
	public void setAD_Input(ForeignEntityInput AD_) {
		...
		if (AD_ != null &&
				(foreignEntity = new Query(getCtx(), "AD_Column", "AD_Column_UU=?", get_TrxName())
						.setParameters(AD_.getID())
						.first()) != null && foreignEntity.get_ID() != 0) {
			super.setAD_Key(foreignEntity.get_ID());
		} else {
			super.setAD_Key(0);
		}
	}
