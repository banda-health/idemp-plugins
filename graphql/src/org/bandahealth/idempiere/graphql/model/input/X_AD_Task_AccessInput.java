...
public class X_AD_Task_AccessInput extends X_AD_Task_Access implements I_AD_Task_AccessInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Task_AccessInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_Task_Access(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
