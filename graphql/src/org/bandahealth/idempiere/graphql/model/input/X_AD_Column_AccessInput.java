...
public class X_AD_Column_AccessInput extends MColumnAccess implements I_AD_Column_AccessInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Column_AccessInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MColumnAccess(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
