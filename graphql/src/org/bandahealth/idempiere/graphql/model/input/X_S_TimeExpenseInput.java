...
public class X_S_TimeExpenseInput extends MTimeExpense implements I_S_TimeExpenseInput {
	 ...
	 */
	@JsonCreator
	public X_S_TimeExpenseInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MTimeExpense(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
