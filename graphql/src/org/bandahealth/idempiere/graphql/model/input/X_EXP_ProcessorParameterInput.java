...
public class X_EXP_ProcessorParameterInput extends MEXPProcessorParameter implements I_EXP_ProcessorParameterInput {
	 ...
	 */
	@JsonCreator
	public X_EXP_ProcessorParameterInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MEXPProcessorParameter(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setEXP_ProcessorParameter_UU(UUID);
	}
