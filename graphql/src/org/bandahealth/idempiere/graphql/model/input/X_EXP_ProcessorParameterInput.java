...
public class X_EXP_ProcessorParameterInput extends MEXPProcessorParameter implements I_EXP_ProcessorParameterInput {
	 ...
	 *
	 * @param UU The EXP_ProcessorParameter_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_EXP_ProcessorParameterInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setEXP_ProcessorParameter_UU(UU);
	}
