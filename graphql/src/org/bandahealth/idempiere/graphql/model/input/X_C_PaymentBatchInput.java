...
public class X_C_PaymentBatchInput extends MPaymentBatch implements I_C_PaymentBatchInput {
	 ...
	 */
	@JsonCreator
	public X_C_PaymentBatchInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MPaymentBatch(null, (ResultSet) null, null),
