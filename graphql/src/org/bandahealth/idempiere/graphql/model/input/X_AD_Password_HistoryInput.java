...
public class X_AD_Password_HistoryInput extends MPasswordHistory implements I_AD_Password_HistoryInput {
	 ...
	 *
	 * @param UU The AD_Password_History_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_Password_HistoryInput(@JsonProperty("UU") String UU) {
