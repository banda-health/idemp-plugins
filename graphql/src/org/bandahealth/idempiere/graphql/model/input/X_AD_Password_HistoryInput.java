...
public class X_AD_Password_HistoryInput extends MPasswordHistory implements I_AD_Password_HistoryInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Password_HistoryInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MPasswordHistory(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setAD_Password_History_UU(UUID);
	}
