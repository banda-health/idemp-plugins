...
public class X_AD_PrintFontInput extends X_AD_PrintFont implements I_AD_PrintFontInput {
	 ...
	 */
	@JsonCreator
	public X_AD_PrintFontInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_PrintFont(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
