...
public class X_M_PromotionInput extends X_M_Promotion implements I_M_PromotionInput {
	 ...
	 *
	 * @param UUID The M_Promotion_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_PromotionInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_Promotion(null, (ResultSet) null, null),
