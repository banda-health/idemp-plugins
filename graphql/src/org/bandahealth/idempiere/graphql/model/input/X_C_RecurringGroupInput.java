...
public class X_C_RecurringGroupInput extends X_C_RecurringGroup implements I_C_RecurringGroupInput {
	 ...
	 */
	@JsonCreator
	public X_C_RecurringGroupInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_C_RecurringGroup(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
