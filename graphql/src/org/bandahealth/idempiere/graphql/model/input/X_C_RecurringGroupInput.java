...
public class X_C_RecurringGroupInput extends X_C_RecurringGroup implements I_C_RecurringGroupInput {
	 ...
	 *
	 * @param UUID The C_RecurringGroup_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_RecurringGroupInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_RecurringGroup(null, (ResultSet) null, null),
