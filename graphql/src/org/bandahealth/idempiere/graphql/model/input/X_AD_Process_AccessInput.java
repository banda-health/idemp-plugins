...
/**
 * Generated Model for AD_Process_Access - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_AD_Process_AccessInput extends MProcessAccess implements I_AD_Process_AccessInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Process_AccessInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MProcessAccess(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	 ...
	 */
	public String getID() {
		return getAD_Process_Access_UU();
	}
