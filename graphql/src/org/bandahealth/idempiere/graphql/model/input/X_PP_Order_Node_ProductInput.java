...
public class X_PP_Order_Node_ProductInput extends X_PP_Order_Node_Product implements I_PP_Order_Node_ProductInput {
	 ...
	 *
	 * @param UU The PP_Order_Node_Product_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_PP_Order_Node_ProductInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setPP_Order_Node_Product_UU(UU);
	}
