...
public class X_AD_WorkflowProcessorInput extends X_AD_WorkflowProcessor implements I_AD_WorkflowProcessorInput {
	 ...
	 *
	 * @param UUID The AD_WorkflowProcessor_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_WorkflowProcessorInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_WorkflowProcessor(null, (ResultSet) null, null),
	...
	public void setUUID(String UUID) {
		setAD_WorkflowProcessor_UU(UUID);
	}
