...
public class X_AD_ReportView_ColInput extends X_AD_ReportView_Col implements I_AD_ReportView_ColInput {
	 ...
	 */
	@JsonCreator
	public X_AD_ReportView_ColInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_ReportView_Col(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
