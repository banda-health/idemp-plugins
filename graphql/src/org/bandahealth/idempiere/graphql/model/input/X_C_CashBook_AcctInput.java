...
public class X_C_CashBook_AcctInput extends X_C_CashBook_Acct implements I_C_CashBook_AcctInput {
	 ...
	 *
	 * @param UUID The C_CashBook_Acct_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_CashBook_AcctInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_CashBook_Acct(null, (ResultSet) null, null),
