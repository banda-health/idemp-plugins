...
/**
 * Generated Model for AD_TreeNodePR - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_AD_TreeNodePRInput extends MTree_NodePR implements I_AD_TreeNodePRInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodePRInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MTree_NodePR(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
