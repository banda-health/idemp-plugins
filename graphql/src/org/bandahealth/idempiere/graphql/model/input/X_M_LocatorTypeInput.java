...
public class X_M_LocatorTypeInput extends MLocatorType implements I_M_LocatorTypeInput {
	 ...
	 */
	@JsonCreator
	public X_M_LocatorTypeInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MLocatorType(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
