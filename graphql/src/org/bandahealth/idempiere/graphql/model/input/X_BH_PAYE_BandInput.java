...
/**
 * Generated Model for BH_PAYE_Band - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 12 - $Id$
 */
public class X_BH_PAYE_BandInput extends MBHPAYEBand implements I_BH_PAYE_BandInput {
	 ...
	 */
	@JsonCreator
	public X_BH_PAYE_BandInput(@JsonProperty("UU") String UU) {
	 ...
	 */
	@JsonProperty("BH_PAYE_Band_ID")
	public void setBH_PAYE_Band_IDFromJson(int BH_PAYE_Band_ID) {
		if (get_ID() == 0) {
			super.setBH_PAYE_Band_ID(BH_PAYE_Band_ID);
		}
	}
