...
import org.bandahealth.idempiere.graphql.resolver.model.X_AD_WF_ActivityResolver;
...
public class X_AD_WF_ActivityInput extends X_AD_WF_Activity implements I_AD_WF_ActivityInput {
	...
	public void setWFStateInput(ForeignEntityInput WFState) {
		...
		if (WFState != null) {
			...
			if (!X_AD_WF_ActivityResolver.WFSTATE_UUIDS_BY_VALUE.containsValue(WFState.getUU())) {
