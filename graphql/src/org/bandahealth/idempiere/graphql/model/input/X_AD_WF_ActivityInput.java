...
public class X_AD_WF_ActivityInput extends X_AD_WF_Activity implements I_AD_WF_ActivityInput {
	 ...
	 *
	 * @param UUID The AD_WF_Activity_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_WF_ActivityInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_WF_Activity(null, (ResultSet) null, null),
