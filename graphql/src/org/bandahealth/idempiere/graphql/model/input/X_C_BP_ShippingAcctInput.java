...
public class X_C_BP_ShippingAcctInput extends X_C_BP_ShippingAcct implements I_C_BP_ShippingAcctInput {
	 ...
	 *
	 * @param UUID The C_BP_ShippingAcct_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_BP_ShippingAcctInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_BP_ShippingAcct(null, (ResultSet) null, null),
