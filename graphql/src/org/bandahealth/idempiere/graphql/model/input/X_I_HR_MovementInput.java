...
public class X_I_HR_MovementInput extends X_I_HR_Movement implements I_I_HR_MovementInput {
	 ...
	 *
	 * @param UU The I_HR_Movement_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_I_HR_MovementInput(@JsonProperty("UU") String UU) {
	...
	public void setHR_MovementInput(ForeignEntityInput HR_Movement) {
		...
		if (HR_Movement != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table HR_Movement with UU " + HR_Movement.getUU());
			}
		} else {
