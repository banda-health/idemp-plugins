...
public class X_AD_SearchDefinitionInput extends MSearchDefinition implements I_AD_SearchDefinitionInput {
	 ...
	 */
	@JsonCreator
	public X_AD_SearchDefinitionInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MSearchDefinition(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
