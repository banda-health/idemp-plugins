...
public class X_AD_Val_RuleInput extends MValRule implements I_AD_Val_RuleInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Val_RuleInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MValRule(null, (ResultSet) null, null),
