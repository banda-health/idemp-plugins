...
import org.bandahealth.idempiere.graphql.resolver.model.X_AD_Val_RuleResolver;
...
public class X_AD_Val_RuleInput extends MValRule implements I_AD_Val_RuleInput {
	 ...
	 *
	 * @param UU The AD_Val_Rule_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_Val_RuleInput(@JsonProperty("UU") String UU) {
	...
	public void setTypeInput(ForeignEntityInput Type) {
		...
		if (Type != null) {
			...
			if (!X_AD_Val_RuleResolver.TYPE_UUIDS_BY_VALUE.containsValue(Type.getUU())) {
