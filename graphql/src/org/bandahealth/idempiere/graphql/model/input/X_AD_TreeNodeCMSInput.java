...
public class X_AD_TreeNodeCMSInput extends MTree_NodeCMS implements I_AD_TreeNodeCMSInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeCMSInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MTree_NodeCMS(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
