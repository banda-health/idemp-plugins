...
/**
 * Generated Model for AD_TreeNodeCMS - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 11 - $Id$
 */
public class X_AD_TreeNodeCMSInput extends MTree_NodeCMS implements I_AD_TreeNodeCMSInput {
	 ...
	 *
	 * @param UUID The AD_TreeNodeCMS_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_TreeNodeCMSInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MTree_NodeCMS(null, (ResultSet) null, null),
