...
public class X_C_AddressValidationInput extends MAddressValidation implements I_C_AddressValidationInput {
	 ...
	 *
	 * @param UU The C_AddressValidation_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_AddressValidationInput(@JsonProperty("UU") String UU) {
	...
	public void setC_AddressValidationCfgInput(ForeignEntityInput C_AddressValidationCfg) {
		...
		if (C_AddressValidationCfg != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table C_AddressValidationCfg with UU " + C_AddressValidationCfg.getUU());
			}
		} else {
