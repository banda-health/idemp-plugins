...
import org.bandahealth.idempiere.graphql.resolver.model.X_C_DocTypeCounterResolver;
...
public class X_C_DocTypeCounterInput extends MDocTypeCounter implements I_C_DocTypeCounterInput {
	 ...
	 *
	 * @param UU The C_DocTypeCounter_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_DocTypeCounterInput(@JsonProperty("UU") String UU) {
	...
	public void setCounter_C_DocTypeInput(ForeignEntityInput Counter_C_DocType) {
		...
		if (Counter_C_DocType != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table C_DocType with UU " + Counter_C_DocType.getUU());
			}
		} else {
	...
	public void setDocActionInput(ForeignEntityInput DocAction) {
		...
		if (DocAction != null) {
			...
			if (!X_C_DocTypeCounterResolver.DOCACTION_UUIDS_BY_VALUE.containsValue(DocAction.getUU())) {
