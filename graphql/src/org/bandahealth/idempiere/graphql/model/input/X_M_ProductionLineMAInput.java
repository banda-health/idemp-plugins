...
public class X_M_ProductionLineMAInput extends MProductionLineMA implements I_M_ProductionLineMAInput {
	 ...
	 *
	 * @param UU The M_ProductionLineMA_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ProductionLineMAInput(@JsonProperty("UU") String UU) {
