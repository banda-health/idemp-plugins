...
public class X_AD_TreeNodeMMInput extends MTree_NodeMM implements I_AD_TreeNodeMMInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeMMInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MTree_NodeMM(null, (ResultSet) null, null),
