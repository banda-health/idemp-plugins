...
/**
 * Generated Model for AD_TreeNodeMM - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_AD_TreeNodeMMInput extends MTree_NodeMM implements I_AD_TreeNodeMMInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeMMInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MTree_NodeMM(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
