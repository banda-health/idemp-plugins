...
public class X_AD_AlertProcessorInput extends MAlertProcessor implements I_AD_AlertProcessorInput {
	 ...
	 */
	@JsonCreator
	public X_AD_AlertProcessorInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MAlertProcessor(null, (ResultSet) null, null),
