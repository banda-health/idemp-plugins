...
public class X_DD_NetworkDistributionInput extends X_DD_NetworkDistribution implements I_DD_NetworkDistributionInput {
	 ...
	 *
	 * @param UU The DD_NetworkDistribution_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_DD_NetworkDistributionInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setDD_NetworkDistribution_UU(UU);
	}
