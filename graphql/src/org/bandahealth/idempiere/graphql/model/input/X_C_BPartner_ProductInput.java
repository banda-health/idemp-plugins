...
public class X_C_BPartner_ProductInput extends MBPartnerProduct implements I_C_BPartner_ProductInput {
	 ...
	 *
	 * @param UU The C_BPartner_Product_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_BPartner_ProductInput(@JsonProperty("UU") String UU) {
