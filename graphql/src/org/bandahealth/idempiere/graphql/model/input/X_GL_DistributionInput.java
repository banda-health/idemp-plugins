...
public class X_GL_DistributionInput extends MDistribution implements I_GL_DistributionInput {
	 ...
	 */
	@JsonCreator
	public X_GL_DistributionInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MDistribution(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
