...
public class X_AD_CtxHelpMsgInput extends MCtxHelpMsg implements I_AD_CtxHelpMsgInput {
	 ...
	 */
	@JsonCreator
	public X_AD_CtxHelpMsgInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MCtxHelpMsg(null, (ResultSet) null, null),
