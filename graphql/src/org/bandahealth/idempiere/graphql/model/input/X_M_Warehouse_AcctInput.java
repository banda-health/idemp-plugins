...
public class X_M_Warehouse_AcctInput extends X_M_Warehouse_Acct implements I_M_Warehouse_AcctInput {
	 ...
	 *
	 * @param UUID The M_Warehouse_Acct_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_Warehouse_AcctInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_Warehouse_Acct(null, (ResultSet) null, null),
