...
public class X_M_ShipperPackagingCfgInput extends X_M_ShipperPackagingCfg implements I_M_ShipperPackagingCfgInput {
	 ...
	 *
	 * @param UU The M_ShipperPackagingCfg_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ShipperPackagingCfgInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setM_ShipperPackagingCfg_UU(UU);
	}
