...
public class X_C_BankAccount_ProcessorInput extends MBankAccountProcessor implements I_C_BankAccount_ProcessorInput {
	 ...
	 */
	@JsonCreator
	public X_C_BankAccount_ProcessorInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MBankAccountProcessor(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setID(String ID) {
		setC_BankAccount_Processor_UU(ID);
	}
