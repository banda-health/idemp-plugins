...
public class X_AD_TreeNodeCMCInput extends MTree_NodeCMC implements I_AD_TreeNodeCMCInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeCMCInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MTree_NodeCMC(null, (ResultSet) null, null),
