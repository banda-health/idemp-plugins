...
/**
 * Generated Model for AD_TreeNodeCMC - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_AD_TreeNodeCMCInput extends MTree_NodeCMC implements I_AD_TreeNodeCMCInput {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeCMCInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MTree_NodeCMC(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
