...
public class X_C_JobAssignmentInput extends X_C_JobAssignment implements I_C_JobAssignmentInput {
	 ...
	 *
	 * @param UUID The C_JobAssignment_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_JobAssignmentInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_JobAssignment(null, (ResultSet) null, null),
