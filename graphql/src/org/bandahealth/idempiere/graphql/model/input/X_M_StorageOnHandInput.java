...
public class X_M_StorageOnHandInput extends MStorageOnHand implements I_M_StorageOnHandInput {
	 ...
	 */
	@JsonCreator
	public X_M_StorageOnHandInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MStorageOnHand(null, (ResultSet) null, null),
