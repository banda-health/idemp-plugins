...
public class X_AD_SequenceInput extends MSequence_BH implements I_AD_SequenceInput {
	 ...
	 */
	@JsonCreator
	public X_AD_SequenceInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MSequence_BH(null, (ResultSet) null, null),
