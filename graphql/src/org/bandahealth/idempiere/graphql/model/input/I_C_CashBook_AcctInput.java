...
public interface I_C_CashBook_AcctInput extends I_C_CashBook_Acct {
	 ...
	 */
	void setCB_Asset_AInput(I_C_ValidCombinationInput CB_Asset_A);
	 ...
	 */
	I_C_ValidCombinationInput CB_Asset_A();
	 ...
	 */
	void setCB_CashTransfer_AInput(I_C_ValidCombinationInput CB_CashTransfer_A);
	 ...
	 */
	I_C_ValidCombinationInput CB_CashTransfer_A();
	 ...
	 */
	void setCB_Differences_AInput(I_C_ValidCombinationInput CB_Differences_A);
	 ...
	 */
	I_C_ValidCombinationInput CB_Differences_A();
	 ...
	 */
	void setCB_Expense_AInput(I_C_ValidCombinationInput CB_Expense_A);
	 ...
	 */
	I_C_ValidCombinationInput CB_Expense_A();
	 ...
	 */
	void setCB_Receipt_AInput(I_C_ValidCombinationInput CB_Receipt_A);
	 ...
	 */
	I_C_ValidCombinationInput CB_Receipt_A();
}
