...
import org.bandahealth.idempiere.graphql.resolver.model.X_C_ProjectTypeResolver;
...
public class X_C_ProjectTypeInput extends MProjectType implements I_C_ProjectTypeInput {
	 ...
	 *
	 * @param UU The C_ProjectType_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_ProjectTypeInput(@JsonProperty("UU") String UU) {
	...
	public void setProjectCategoryInput(ForeignEntityInput ProjectCategory) {
		...
		if (ProjectCategory != null) {
			...
			if (!X_C_ProjectTypeResolver.PROJECTCATEGORY_UUIDS_BY_VALUE.containsValue(ProjectCategory.getUU())) {
