...
public class X_AD_WorkbenchInput extends X_AD_Workbench implements I_AD_WorkbenchInput {
	 ...
	 */
	@JsonCreator
	public X_AD_WorkbenchInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_Workbench(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
