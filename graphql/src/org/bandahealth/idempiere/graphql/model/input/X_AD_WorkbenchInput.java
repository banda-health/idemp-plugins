...
/**
 * Generated Model for AD_Workbench - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_AD_WorkbenchInput extends X_AD_Workbench implements I_AD_WorkbenchInput {
	 ...
	 *
	 * @param UUID The AD_Workbench_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_AD_WorkbenchInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_AD_Workbench(null, (ResultSet) null, null),
	...
	public void setAD_Workbench_ID(int AD_Workbench_ID) {
		if (get_ID() == 0) {
			super.setAD_Workbench_ID(AD_Workbench_ID);
		}
	}
