...
public class X_M_StorageReservationInput extends MStorageReservation implements I_M_StorageReservationInput {
	 ...
	 *
	 * @param UU The M_StorageReservation_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_StorageReservationInput(@JsonProperty("UU") String UU) {
