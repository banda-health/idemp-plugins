...
public class X_A_Asset_RetirementInput extends X_A_Asset_Retirement implements I_A_Asset_RetirementInput {
	 ...
	 *
	 * @param UUID The A_Asset_Retirement_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_A_Asset_RetirementInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_A_Asset_Retirement(null, (ResultSet) null, null),
