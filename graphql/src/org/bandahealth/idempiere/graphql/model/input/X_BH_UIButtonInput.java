...
public class X_BH_UIButtonInput extends MUIButton implements I_BH_UIButtonInput {
	 ...
	 */
	@JsonCreator
	public X_BH_UIButtonInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MUIButton(null, (ResultSet) null, null),
