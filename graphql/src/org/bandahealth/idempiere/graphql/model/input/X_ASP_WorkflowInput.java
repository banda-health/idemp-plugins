...
import org.bandahealth.idempiere.graphql.resolver.model.X_ASP_WorkflowResolver;
...
public class X_ASP_WorkflowInput extends X_ASP_Workflow implements I_ASP_WorkflowInput {
	 ...
	 *
	 * @param UU The ASP_Workflow_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_ASP_WorkflowInput(@JsonProperty("UU") String UU) {
	...
	public void setASP_StatusInput(ForeignEntityInput ASP_Status) {
		...
		if (ASP_Status != null) {
			...
			if (!X_ASP_WorkflowResolver.ASP_STATUS_UUIDS_BY_VALUE.containsValue(ASP_Status.getUU())) {
