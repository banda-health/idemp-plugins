...
public class X_C_TaxProviderCfgInput extends X_C_TaxProviderCfg implements I_C_TaxProviderCfgInput {
	 ...
	 *
	 * @param UUID The C_TaxProviderCfg_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_TaxProviderCfgInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_TaxProviderCfg(null, (ResultSet) null, null),
