...
public class X_C_TaxProviderCfgInput extends X_C_TaxProviderCfg implements I_C_TaxProviderCfgInput {
	 ...
	 */
	@JsonCreator
	public X_C_TaxProviderCfgInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_C_TaxProviderCfg(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
