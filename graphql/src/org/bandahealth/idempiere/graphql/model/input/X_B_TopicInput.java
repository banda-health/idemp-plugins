...
public class X_B_TopicInput extends X_B_Topic implements I_B_TopicInput {
	 ...
	 *
	 * @param UUID The B_Topic_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_B_TopicInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_B_Topic(null, (ResultSet) null, null),
