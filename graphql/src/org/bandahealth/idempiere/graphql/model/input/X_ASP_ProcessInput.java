...
import org.bandahealth.idempiere.graphql.resolver.model.X_ASP_ProcessResolver;
...
public class X_ASP_ProcessInput extends X_ASP_Process implements I_ASP_ProcessInput {
	 ...
	 *
	 * @param UU The ASP_Process_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_ASP_ProcessInput(@JsonProperty("UU") String UU) {
	...
	public void setASP_StatusInput(ForeignEntityInput ASP_Status) {
		...
		if (ASP_Status != null) {
			...
			if (!X_ASP_ProcessResolver.ASP_STATUS_UUIDS_BY_VALUE.containsValue(ASP_Status.getUU())) {
