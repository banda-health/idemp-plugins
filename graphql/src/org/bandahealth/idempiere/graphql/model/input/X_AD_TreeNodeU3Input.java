...
public class X_AD_TreeNodeU3Input extends X_AD_TreeNodeU3 implements I_AD_TreeNodeU3Input {
	 ...
	 */
	@JsonCreator
	public X_AD_TreeNodeU3Input(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_AD_TreeNodeU3(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
