...
public class X_PP_Cost_CollectorInput extends X_PP_Cost_Collector implements I_PP_Cost_CollectorInput {
	 ...
	 *
	 * @param UUID The PP_Cost_Collector_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_PP_Cost_CollectorInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_PP_Cost_Collector(null, (ResultSet) null, null),
	...
	public void setCostCollectorTypeInput(I_AD_Ref_ListInput CostCollectorType) {
		...
		if (CostCollectorType != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table " + MRefList_BH.Table_Name + " with UUID " + CostCollectorType.getUUID());
			}
		} else {
