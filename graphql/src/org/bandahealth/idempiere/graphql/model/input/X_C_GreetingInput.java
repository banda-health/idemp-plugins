...
public class X_C_GreetingInput extends X_C_Greeting implements I_C_GreetingInput {
	 ...
	 *
	 * @param UUID The C_Greeting_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_GreetingInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_Greeting(null, (ResultSet) null, null),
