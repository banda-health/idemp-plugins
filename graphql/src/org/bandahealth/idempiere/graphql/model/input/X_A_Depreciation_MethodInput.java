...
public class X_A_Depreciation_MethodInput extends MDepreciationMethod implements I_A_Depreciation_MethodInput {
	 ...
	 *
	 * @param UU The A_Depreciation_Method_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_A_Depreciation_MethodInput(@JsonProperty("UU") String UU) {
	...
	public void setUU(String UU) {
		setA_Depreciation_Method_UU(UU);
	}
