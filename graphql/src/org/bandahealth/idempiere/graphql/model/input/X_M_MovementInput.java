...
import org.bandahealth.idempiere.graphql.resolver.model.X_M_MovementResolver;
...
public class X_M_MovementInput extends MMovement_BH implements I_M_MovementInput {
	 ...
	 *
	 * @param UU The M_Movement_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_MovementInput(@JsonProperty("UU") String UU) {
		...
		if (BH_From_Warehouse != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "M_Warehouse", "M_Warehouse_UU=?", get_TrxName())
							.setParameters(BH_From_Warehouse.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
				this.setBH_From_Warehouse_ID(foreignEntity.get_ID());
			} else {
				throw new AdempiereException(
						"Could not find entity in table M_Warehouse with UU " + BH_From_Warehouse.getUU());
			}
		} else {
	...
	public void setBH_To_WarehouseInput(ForeignEntityInput BH_To_Warehouse) {
		...
		if (BH_To_Warehouse != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "M_Warehouse", "M_Warehouse_UU=?", get_TrxName())
							.setParameters(BH_To_Warehouse.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
				this.setBH_To_Warehouse_ID(foreignEntity.get_ID());
			} else {
				throw new AdempiereException(
						"Could not find entity in table M_Warehouse with UU " + BH_To_Warehouse.getUU());
			}
		} else {
	...
	public void setDeliveryRuleInput(ForeignEntityInput DeliveryRule) {
		...
		if (DeliveryRule != null) {
			...
			if (!X_M_MovementResolver.DELIVERYRULE_UUIDS_BY_VALUE.containsValue(DeliveryRule.getUU())) {
	...
	public void setDeliveryViaRuleInput(ForeignEntityInput DeliveryViaRule) {
		...
		if (DeliveryViaRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_MovementResolver.DELIVERYVIARULE_UUIDS_BY_VALUE.containsValue(DeliveryViaRule.getUU())) {
	...
	public void setDocActionInput(ForeignEntityInput DocAction) {
		...
		if (DocAction != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_MovementResolver.DOCACTION_UUIDS_BY_VALUE.containsValue(DocAction.getUU())) {
	...
	public void setDocStatusInput(ForeignEntityInput DocStatus) {
		...
		if (DocStatus != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_MovementResolver.DOCSTATUS_UUIDS_BY_VALUE.containsValue(DocStatus.getUU())) {
	...
	public void setFreightCostRuleInput(ForeignEntityInput FreightCostRule) {
		...
		if (FreightCostRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_MovementResolver.FREIGHTCOSTRULE_UUIDS_BY_VALUE.containsValue(FreightCostRule.getUU())) {
	...
	public void setM_WarehouseToInput(ForeignEntityInput M_WarehouseTo) {
		...
		if (M_WarehouseTo != null) {
			...
			if ((foreignEntity =
					new Query(getCtx(), "M_Warehouse", "M_Warehouse_UU=?", get_TrxName())
							.setParameters(M_WarehouseTo.getUU()).first()) != null && foreignEntity.get_ID() >= 1) {
				this.setM_WarehouseTo_ID(foreignEntity.get_ID());
			} else {
				throw new AdempiereException(
						"Could not find entity in table M_Warehouse with UU " + M_WarehouseTo.getUU());
			}
		} else {
	...
	public void setPriorityRuleInput(ForeignEntityInput PriorityRule) {
		...
		if (PriorityRule != null) {
			// Since an entity was passed, make sure it's in the list of acceptable values
			if (!X_M_MovementResolver.PRIORITYRULE_UUIDS_BY_VALUE.containsValue(PriorityRule.getUU())) {
	...
	public void setReversalInput(ForeignEntityInput Reversal) {
		...
		if (Reversal != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table M_Movement with UU " + Reversal.getUU());
			}
		} else {
