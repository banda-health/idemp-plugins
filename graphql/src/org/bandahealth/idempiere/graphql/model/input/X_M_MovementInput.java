...
public class X_M_MovementInput extends MMovement_BH implements I_M_MovementInput {
	 ...
	 */
	@JsonCreator
	public X_M_MovementInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MMovement_BH(null, (ResultSet) null, null),
	...
	public void setReversalInput(ForeignEntityInput Reversal) {
		...
		if (Reversal != null) {
			...
			if ((foreignEntity =
				...
				throw new AdempiereException(
						"Could not find entity in table M_Movement with UUID " + Reversal.getUUID());
			}
		} else {
