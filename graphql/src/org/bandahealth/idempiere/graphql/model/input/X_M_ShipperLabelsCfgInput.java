...
public class X_M_ShipperLabelsCfgInput extends X_M_ShipperLabelsCfg implements I_M_ShipperLabelsCfgInput {
	 ...
	 *
	 * @param UUID The M_ShipperLabelsCfg_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_M_ShipperLabelsCfgInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_M_ShipperLabelsCfg(null, (ResultSet) null, null),
