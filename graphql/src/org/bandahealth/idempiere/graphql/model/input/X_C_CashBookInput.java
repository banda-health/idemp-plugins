...
public class X_C_CashBookInput extends MCashBook implements I_C_CashBookInput {
	 ...
	 *
	 * @param UUID The C_CashBook_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_CashBookInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MCashBook(null, (ResultSet) null, null),
