...
public class X_C_OrderPayScheduleInput extends MOrderPaySchedule implements I_C_OrderPayScheduleInput {
	 ...
	 *
	 * @param UU The C_OrderPaySchedule_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_OrderPayScheduleInput(@JsonProperty("UU") String UU) {
