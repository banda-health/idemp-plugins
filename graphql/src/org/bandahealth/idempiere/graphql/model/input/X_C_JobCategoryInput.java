...
public class X_C_JobCategoryInput extends X_C_JobCategory implements I_C_JobCategoryInput {
	 ...
	 *
	 * @param UUID The C_JobCategory_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_JobCategoryInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new X_C_JobCategory(null, (ResultSet) null, null),
