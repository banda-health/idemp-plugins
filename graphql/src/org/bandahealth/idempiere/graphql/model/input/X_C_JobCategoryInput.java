...
public class X_C_JobCategoryInput extends X_C_JobCategory implements I_C_JobCategoryInput {
	 ...
	 *
	 * @param UU The C_JobCategory_UU to fetch this entity from the DB
	 */
	@JsonCreator
	public X_C_JobCategoryInput(@JsonProperty("UU") String UU) {
	...
	public void setC_JobCategory_IDFromJson(int C_JobCategory_ID) {
		if (get_ID() == 0) {
