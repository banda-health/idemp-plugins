...
public class X_M_ShippingTransactionLineInput extends MShippingTransactionLine implements I_M_ShippingTransactionLineInput {
	...
	public X_M_ShippingTransactionLineInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new MShippingTransactionLine(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
	...
	public void setM_ShippingTransactionInput(ForeignEntityInput M_ShippingTransaction) {
		...
		if (get_ID() == 0 && M_ShippingTransaction != null &&
				(foreignEntity = new Query(getCtx(), "M_ShippingTransaction", "M_ShippingTransaction_UU=?", get_TrxName())
