 ...
 */
public class X_M_AttributeSetExcludeInput extends X_M_AttributeSetExclude implements I_M_AttributeSetExcludeInput {
	...
	public X_M_AttributeSetExcludeInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_M_AttributeSetExclude(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
