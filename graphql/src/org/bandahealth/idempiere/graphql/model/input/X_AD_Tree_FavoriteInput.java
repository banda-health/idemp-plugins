...
public class X_AD_Tree_FavoriteInput extends MTreeFavorite implements I_AD_Tree_FavoriteInput {
	 ...
	 */
	@JsonCreator
	public X_AD_Tree_FavoriteInput(@JsonProperty("UUID") String UUID) {
		super(Env.getCtx(), ModelUtil.getModelResultSet(new MTreeFavorite(null, (ResultSet) null, null),
