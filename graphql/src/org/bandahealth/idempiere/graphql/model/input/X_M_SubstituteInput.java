...
public class X_M_SubstituteInput extends X_M_Substitute implements I_M_SubstituteInput {
	 ...
	 */
	@JsonCreator
	public X_M_SubstituteInput(@JsonProperty("ID") String ID) {
		super(null, ModelUtil.getModelResultSet(new X_M_Substitute(null, (ResultSet) null, null), null, Table_Name, ID),
				null);
		setID(ID);
	}
