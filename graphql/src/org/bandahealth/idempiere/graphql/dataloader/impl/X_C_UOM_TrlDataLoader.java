...
/**
 * Data Loader for C_UOM_Trl - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_C_UOM_TrlDataLoader extends PODataLoader<PO> {
	public static String C_UOM_Trl_BY_ID_DATA_LOADER = "C_UOM_TrlByIdDataLoader";
	public static String C_UOM_Trl_BY_UUID_DATA_LOADER = "C_UOM_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return MUOM.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return C_UOM_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(C_UOM_Trl_BY_ID_DATA_LOADER,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					MUOM.COLUMNNAME_C_UOM_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(MUOM.COLUMNNAME_C_UOM_ID),
