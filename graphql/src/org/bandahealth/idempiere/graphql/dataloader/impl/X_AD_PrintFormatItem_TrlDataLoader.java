...
public class X_AD_PrintFormatItem_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_PrintFormatItem_Trl_BY_ID_DATA_LOADER = "AD_PrintFormatItem_TrlByIdDataLoader";
	public static String AD_PrintFormatItem_Trl_BY_UUID_DATA_LOADER = "AD_PrintFormatItem_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return X_AD_PrintFormatItem.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return AD_PrintFormatItem_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(AD_PrintFormatItem_Trl_BY_ID_DATA_LOADER,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					X_AD_PrintFormatItem.COLUMNNAME_AD_PrintFormatItem_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(X_AD_PrintFormatItem.COLUMNNAME_AD_PrintFormatItem_ID),
