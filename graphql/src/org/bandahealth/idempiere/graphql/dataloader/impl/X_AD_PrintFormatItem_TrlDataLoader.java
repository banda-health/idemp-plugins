...
public class X_AD_PrintFormatItem_TrlDataLoader extends PODataLoader<PO> {
	...
	public static String DATALOADER_AD_PrintFormatItem_Trl_BY_UUID = "AD_PrintFormatItem_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_AD_PrintFormatItem_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_AD_PrintFormatItem_Trl_BY_ID,
