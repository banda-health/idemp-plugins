...
public class X_PA_ReportLine_TrlDataLoader extends PODataLoader<PO> {
	public static String PA_ReportLine_Trl_BY_ID_DATA_LOADER = "PA_ReportLine_TrlByIdDataLoader";
	public static String PA_ReportLine_Trl_BY_UUID_DATA_LOADER = "PA_ReportLine_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return X_PA_ReportLine.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return PA_ReportLine_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(PA_ReportLine_Trl_BY_ID_DATA_LOADER,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					X_PA_ReportLine.COLUMNNAME_PA_ReportLine_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(X_PA_ReportLine.COLUMNNAME_PA_ReportLine_ID),
