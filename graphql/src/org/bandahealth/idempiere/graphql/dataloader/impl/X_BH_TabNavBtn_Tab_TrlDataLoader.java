...
public class X_BH_TabNavBtn_Tab_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_BH_TabNavBtn_Tab_Trl_BY_ID = "BH_TabNavBtn_Tab_TrlByIdDataLoader";
	public static String DATALOADER_BH_TabNavBtn_Tab_Trl_BY_UUID = "BH_TabNavBtn_Tab_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_BH_TabNavBtn_Tab_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_BH_TabNavBtn_Tab_Trl_BY_ID,
