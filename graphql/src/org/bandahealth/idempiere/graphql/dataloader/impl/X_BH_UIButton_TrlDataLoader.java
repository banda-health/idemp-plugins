...
/**
 * Data Loader for BH_UIButton_Trl - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 7.1 - $Id$
 */
public class X_BH_UIButton_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_BH_UIButton_Trl_BY_ID = "BH_UIButton_TrlByIdDataLoader";
	public static String DATALOADER_BH_UIButton_Trl_BY_UUID = "BH_UIButton_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return MUIButton.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_BH_UIButton_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_BH_UIButton_Trl_BY_ID,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					MUIButton.COLUMNNAME_BH_UIButton_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(MUIButton.COLUMNNAME_BH_UIButton_ID),
