...
public class X_AD_Chart_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_Chart_Trl_BY_ID_DATA_LOADER = "AD_ChartByIdDataLoader";
	public static String AD_Chart_Trl_BY_UUID_DATA_LOADER = "AD_ChartByUuidDataLoader";
