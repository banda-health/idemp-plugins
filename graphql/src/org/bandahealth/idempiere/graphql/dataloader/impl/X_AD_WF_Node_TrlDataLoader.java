...
public class X_AD_WF_Node_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_WF_Node_Trl_BY_ID_DATA_LOADER = "AD_WF_NodeByIdDataLoader";
	public static String AD_WF_Node_Trl_BY_UUID_DATA_LOADER = "AD_WF_NodeByUuidDataLoader";
