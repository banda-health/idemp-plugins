...
public class X_AD_WF_Node_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_WF_Node_Trl_BY_ID_DATA_LOADER = "AD_WF_Node_TrlByIdDataLoader";
	public static String AD_WF_Node_Trl_BY_UUID_DATA_LOADER = "AD_WF_Node_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return AD_WF_Node_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(AD_WF_Node_Trl_BY_ID_DATA_LOADER,
