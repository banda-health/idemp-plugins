...
public class X_C_ElementValue_TrlDataLoader extends PODataLoader<PO> {
	public static String C_ElementValue_Trl_BY_ID_DATA_LOADER = "C_ElementValue_TrlByIdDataLoader";
	public static String C_ElementValue_Trl_BY_UUID_DATA_LOADER = "C_ElementValue_TrlByUuidDataLoader";
