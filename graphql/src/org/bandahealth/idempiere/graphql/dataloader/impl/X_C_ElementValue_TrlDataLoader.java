...
public class X_C_ElementValue_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_C_ElementValue_Trl_BY_ID = "C_ElementValue_TrlByIdDataLoader";
	public static String DATALOADER_C_ElementValue_Trl_BY_UUID = "C_ElementValue_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_C_ElementValue_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_C_ElementValue_Trl_BY_ID,
