...
public class X_PA_DocumentStatus_TrlDataLoader extends PODataLoader<PO> {
	public static String PA_DocumentStatus_Trl_BY_ID_DATA_LOADER = "PA_DocumentStatus_TrlByIdDataLoader";
	public static String PA_DocumentStatus_Trl_BY_UUID_DATA_LOADER = "PA_DocumentStatus_TrlByUuidDataLoader";
