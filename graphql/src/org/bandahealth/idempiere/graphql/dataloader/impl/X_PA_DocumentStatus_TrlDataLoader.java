...
public class X_PA_DocumentStatus_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_PA_DocumentStatus_Trl_BY_ID = "PA_DocumentStatus_TrlByIdDataLoader";
	public static String DATALOADER_PA_DocumentStatus_Trl_BY_UUID = "PA_DocumentStatus_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_PA_DocumentStatus_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_PA_DocumentStatus_Trl_BY_ID,
