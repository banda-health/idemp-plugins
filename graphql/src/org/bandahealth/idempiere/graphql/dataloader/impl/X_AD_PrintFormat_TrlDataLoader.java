...
/**
 * Data Loader for AD_PrintFormat_Trl - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 13 - $Id$
 */
public class X_AD_PrintFormat_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_AD_PrintFormat_Trl_BY_ID = "AD_PrintFormat_TrlByIdDataLoader";
	public static String DATALOADER_AD_PrintFormat_Trl_BY_UUID = "AD_PrintFormat_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return X_AD_PrintFormat.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_AD_PrintFormat_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_AD_PrintFormat_Trl_BY_ID,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					X_AD_PrintFormat.COLUMNNAME_AD_PrintFormat_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(X_AD_PrintFormat.COLUMNNAME_AD_PrintFormat_ID),
