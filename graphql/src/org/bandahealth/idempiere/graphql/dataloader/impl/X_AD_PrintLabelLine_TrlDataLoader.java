...
public class X_AD_PrintLabelLine_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_PrintLabelLine_Trl_BY_ID_DATA_LOADER = "AD_PrintLabelLineByIdDataLoader";
	public static String AD_PrintLabelLine_Trl_BY_UUID_DATA_LOADER = "AD_PrintLabelLineByUuidDataLoader";
