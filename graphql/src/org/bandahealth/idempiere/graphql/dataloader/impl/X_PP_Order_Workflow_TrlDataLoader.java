...
public class X_PP_Order_Workflow_TrlDataLoader extends PODataLoader<PO> {
	public static String PP_Order_Workflow_Trl_BY_ID_DATA_LOADER = "PP_Order_Workflow_TrlByIdDataLoader";
	public static String PP_Order_Workflow_Trl_BY_UUID_DATA_LOADER = "PP_Order_Workflow_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return X_PP_Order_Workflow.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return PP_Order_Workflow_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(PP_Order_Workflow_Trl_BY_ID_DATA_LOADER,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					X_PP_Order_Workflow.COLUMNNAME_PP_Order_Workflow_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(X_PP_Order_Workflow.COLUMNNAME_PP_Order_Workflow_ID),
