...
public class X_AD_Table_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_Table_Trl_BY_ID_DATA_LOADER = "AD_Table_TrlByIdDataLoader";
	public static String AD_Table_Trl_BY_UUID_DATA_LOADER = "AD_Table_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return AD_Table_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(AD_Table_Trl_BY_ID_DATA_LOADER,
