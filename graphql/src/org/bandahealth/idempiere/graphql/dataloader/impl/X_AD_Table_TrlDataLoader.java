...
public class X_AD_Table_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_Table_Trl_BY_ID_DATA_LOADER = "AD_TableByIdDataLoader";
	public static String AD_Table_Trl_BY_UUID_DATA_LOADER = "AD_TableByUuidDataLoader";
