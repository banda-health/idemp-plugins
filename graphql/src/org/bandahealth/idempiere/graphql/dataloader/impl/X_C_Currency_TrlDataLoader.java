...
/**
 * Data Loader for C_Currency_Trl - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_C_Currency_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_C_Currency_Trl_BY_ID = "C_Currency_TrlByIdDataLoader";
	public static String DATALOADER_C_Currency_Trl_BY_UUID = "C_Currency_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return MCurrency_BH.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_C_Currency_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_C_Currency_Trl_BY_ID,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					MCurrency_BH.COLUMNNAME_C_Currency_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(MCurrency_BH.COLUMNNAME_C_Currency_ID),
