...
public class X_C_Tax_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_C_Tax_Trl_BY_ID = "C_Tax_TrlByIdDataLoader";
	public static String DATALOADER_C_Tax_Trl_BY_UUID = "C_Tax_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_C_Tax_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_C_Tax_Trl_BY_ID,
