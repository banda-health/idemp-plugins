...
/**
 * Data Loader for C_Tax_Trl - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_C_Tax_TrlDataLoader extends PODataLoader<PO> {
	public static String C_Tax_Trl_BY_ID_DATA_LOADER = "C_Tax_TrlByIdDataLoader";
	public static String C_Tax_Trl_BY_UUID_DATA_LOADER = "C_Tax_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return MTax.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return C_Tax_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(C_Tax_Trl_BY_ID_DATA_LOADER,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					MTax.COLUMNNAME_C_Tax_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(MTax.COLUMNNAME_C_Tax_ID),
