...
public class X_AD_Field_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_Field_Trl_BY_ID_DATA_LOADER = "AD_FieldByIdDataLoader";
	public static String AD_Field_Trl_BY_UUID_DATA_LOADER = "AD_FieldByUuidDataLoader";
