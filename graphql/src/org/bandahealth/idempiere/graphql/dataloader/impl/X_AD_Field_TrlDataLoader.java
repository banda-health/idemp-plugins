...
/**
 * Data Loader for AD_Field_Trl - DO NOT CHANGE
 *
 * @author Banda Health (generated)
 * @version Release 8.2 - $Id$
 */
public class X_AD_Field_TrlDataLoader extends PODataLoader<PO> {
	public static String AD_Field_Trl_BY_ID_DATA_LOADER = "AD_Field_TrlByIdDataLoader";
	public static String AD_Field_Trl_BY_UUID_DATA_LOADER = "AD_Field_TrlByUuidDataLoader";

	@Override
	protected String getTableName() {
		return MField_BH.Table_Name + "_Trl";
	}
	...
	protected String getByUuidDataLoaderName() {
		return AD_Field_Trl_BY_UUID_DATA_LOADER;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(AD_Field_Trl_BY_ID_DATA_LOADER,
	...
	private MappedBatchLoaderWithContext<Integer, PO> getByIdAndLanguageBatchLoader() {
		return (keys, batchLoaderEnvironment) -> CompletableFuture.supplyAsync(() -> {
			...
			List<PO> translations = new Query(batchLoaderEnvironment.getContext(), getTableName(),
					MField_BH.COLUMNNAME_AD_Field_ID + " IN (" + whereClause + ") AND AD_Language = ?", null).setParameters(
					parameters).list();
			return translations.stream().collect(
					Collectors.toMap(translation -> translation.get_ValueAsInt(MField_BH.COLUMNNAME_AD_Field_ID),
