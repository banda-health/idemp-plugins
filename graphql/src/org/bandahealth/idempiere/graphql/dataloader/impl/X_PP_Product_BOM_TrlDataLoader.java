...
public class X_PP_Product_BOM_TrlDataLoader extends PODataLoader<PO> {
	public static String DATALOADER_PP_Product_BOM_Trl_BY_ID = "PP_Product_BOM_TrlByIdDataLoader";
	public static String DATALOADER_PP_Product_BOM_Trl_BY_UUID = "PP_Product_BOM_TrlByUuidDataLoader";
	...
	protected String getByUuidDataLoaderName() {
		return DATALOADER_PP_Product_BOM_Trl_BY_UUID;
	}

	@Override
	public void register(DataLoaderRegistry registry, Properties idempiereContext) {
		super.register(registry, idempiereContext);
		registry.register(DATALOADER_PP_Product_BOM_Trl_BY_ID,
