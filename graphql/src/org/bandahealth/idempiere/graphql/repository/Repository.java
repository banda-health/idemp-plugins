...
public class Repository {
	...
	public static Query getQuery(Properties idempiereContext, String tableName, String transactionName,
		...
		Query query = new Query(idempiereContext, tableName, whereClause, transactionName)
				.setNoVirtualColumn(true).setApplyAccessFilter(fullyQualifiedWhere, isReadWrite);
	...
	public static <T extends PO> Connection<T> get(String tableName, String transactionName, PagingInfo pagingInfo, String sort, String filter,
	 ...
	 */
	public static <T extends PO> CompletableFuture<Map<String, List<T>>> getGroupsByIdsCompletableFuture(
		...
		return CompletableFuture.supplyAsync(
				() -> getGroupsByIds(idempiereContext, tableName, transactionName, groupingFunction, columnToSearch,
