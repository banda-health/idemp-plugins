...
3. After the container is running, attach to it via `docker compose -f docker-compose.dev.yml exec tests /bin/bash`.
4. Move into the `graphql-test` directory and execute `jest` to run the tests.
