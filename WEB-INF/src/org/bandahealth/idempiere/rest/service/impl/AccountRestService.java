...
public class AccountRestService extends BaseEntityRestService<Account> {
	...
	@Override
	public BaseListResponse<Account> getAll(@QueryParam("page") int page, @QueryParam("size") int size,
																					@QueryParam("sortColumn") String sortColumn, @QueryParam("sortOrder") String sortOrder) {
		return dbService.getAll(null, null, getPagingInfo(page, size), sortColumn, sortOrder);
	}
