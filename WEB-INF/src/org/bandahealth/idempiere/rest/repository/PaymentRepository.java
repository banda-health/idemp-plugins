...
public class PaymentRepository extends BaseRepository<MPayment_BH> {
	...
	public Map<Integer, List<MPayment_BH>> getByOrderIds(Set<Integer> orderIds) {
	...
	@Override
	public MPayment_BH mapInputModelToModel(MPayment_BH entity) {
...
//		}
		...
		if (entity.getTenderType() != null) {
			payment.setTenderType(entity.getTenderType());
		}
		...
		if (!StringUtil.isNullOrEmpty(entity.getBH_NHIF_Type())) {
			payment.setBH_NHIF_Type(entity.getBH_NHIF_Type());

			if (entity.getbh_nhif_relationship() != null) {
				payment.setbh_nhif_relationship(entity.getbh_nhif_relationship());
			}
	...
	public List<MPayment_BH> getServiceDebtPayments(String filterJson, String sort, Paging pagingInfo) {
		List<Object> parameters = new ArrayList<>();
		parameters.add("Y");
		...
		return get(filterJson, sort, pagingInfo, MPayment_BH.COLUMNNAME_BH_IsServiceDebt + "=?", parameters, join);
	}

	public Paging getServiceDebtPaymentsPagingInfo(String filterJson, String sort, Paging pagingInfo) {
		List<Object> parameters = new ArrayList<>();
		parameters.add("Y");
		...
		return getPagingInfo(filterJson, sort, pagingInfo, MPayment_BH.COLUMNNAME_BH_IsServiceDebt + "=?", parameters,
				join);
	}
